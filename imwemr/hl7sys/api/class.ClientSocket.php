...
class ClientSocket{
	 ...
	 * @var int
	 */
	public $iReadTimeOut =30;

	/**
	 * Write TimeOut (seconds)
	 * @var int
	 */
	private $iWriteTimeOut = 10;
	 ...
	 */
	public function __construct($ack_read_timeout=30,$family=AF_INET,$type=SOCK_STREAM ,$protocol=SOL_TCP){
		...
		$this->ip		= null;
		$this->host		= null;
		$this->iReadTimeOut = $ack_read_timeout;
	}
