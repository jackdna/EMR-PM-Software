...
$myInternalIP = "demo.myimw.com";
$myExternalIP = "demo.myimw.com";
$phpServerIP = "demo.myimw.com"; //88.88.88.88 //127.0.0.1
$phpServerPort = "";
$protocol = 'http://';
...
define("UPDOX_APP_PASSWORD", "yoursecretkey"); /*Updox Application ID*/
...
/*
Following are the user_type ids for different types of users in IMWERM. 
