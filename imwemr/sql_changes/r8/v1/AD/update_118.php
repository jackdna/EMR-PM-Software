...
$msg_info=array();
$qry="Select * from custom_reports WHERE report_type='clinical' AND template_name='Un Superbilled Encounters'";
$rs=imw_query($qry);
...
('Un Superbilled Encounters', '', 0, 1, 'clinical', '');";
...
if(count($msg_info)>0)
{
    $msg_info[] = '<br><br><b>Update 118 run FAILED!</b><br>';
    $color = "red";
}
else
{
    $msg_info[] = "<br><br><b>Update 118 run successfully!</b>";
    $color = "green";
}
?>
<html>
