...
DROP TABLE IF EXISTS ChartVisMasterId_ToDel;
CREATE TABLE ChartVisMasterId_ToDel(id INT auto_increment PRIMARY KEY, visid INT);

INSERT INTO ChartVisMasterId_ToDel(visid)
SELECT C.id
FROM chart_vis_master C 
INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id;


DELETE C.* FROM chart_acuity C INNER JOIN ChartVisMasterId_ToDel T ON C.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_ak C INNER JOIN ChartVisMasterId_ToDel T ON C.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_sca C INNER JOIN ChartVisMasterId_ToDel T ON C.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_exo C INNER JOIN ChartVisMasterId_ToDel T ON C.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_bat C INNER JOIN ChartVisMasterId_ToDel T ON C.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_pam C INNER JOIN ChartVisMasterId_ToDel T ON C.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_pc_mr_values C 
INNER JOIN chart_pc_mr P ON C.chart_pc_mr_id = P.id
INNER JOIN ChartVisMasterId_ToDel T ON P.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_pc_mr C INNER JOIN ChartVisMasterId_ToDel T ON C.id_chart_vis_master = T.visid ;
DELETE C.* FROM chart_ar_scan C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;

DELETE C.* FROM chart_ant_chamber C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_blood_vessels C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_conjunctiva C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_cornea C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_drawings C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_eom C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_iris C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_lac_sys C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_lesion C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_lid_pos C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_lids C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_macula C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_periphery C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_pupil C INNER JOIN ChartMasterId_ToDel T ON C.formId = T.form_id ;
DELETE C.* FROM chart_retinal_exam C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_vis_master C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
DELETE C.* FROM chart_vitreous C INNER JOIN ChartMasterId_ToDel T ON C.form_id = T.form_id ;
...
SET @RecordsToDelDate =  '2009-11-01 00:00:00';
...
/* Drop the table which are created for log deletion data purpose*/
DROP TABLE IF EXISTS ChartVisMasterId_ToDel;
