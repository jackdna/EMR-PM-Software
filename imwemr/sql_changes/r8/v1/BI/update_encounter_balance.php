...
$enc_pay_qry = imw_query("SELECT * FROM  `patient_charge_list` order by encounter_id desc limit $start_val , $end");
...
<br><br>
	...
	<form action="update_encounter_balance.php?start_val=<?php print $start_val + $end; ?>" method="post" name="submit_frm" id="submit_frm">
