...
set_time_limit(0);	
//$file_name = 'michiganeye_reprocess_log.txt';
$hl7_start_id = 1;
if(file_exists($file_name) && is_file($file_name)){
//	$hl7_start_id = file_get_contents($file_name);
}

$q2 	= "SELECT id, msg FROM `hl7_received` WHERE `msg` LIKE '%AIP|1||3874^St. Aubin^Daniel^%' AND parse_result LIKE '%Provider does not exists%' AND saved_on <= '2018-12-04 00:00;00' ORDER BY id LIMIT 0,5000";
$hl_res	= imw_query($q2);
