...
$sql[] = "CREATE TABLE `fmh_api_call_log` (
...
$sql[] = "CREATE TABLE `fmh_api_token_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$sql[] = "CREATE TABLE `fmh_api_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$problemId = "CREATE TABLE `fmh_med_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
if( $respProblemId )
{
	$problems = "INSERT INTO `fmh_med_fields` (`id`, `name`, `type`, `sec_id`, `field_key`) VALUES
					(1, 'Cataracts', 1, 1, 5),
					(2, 'Dry Eyes', 1, 1, 1),
					(3, 'Glaucoma', 1, 1, 3),
