...
$sql[]="CREATE TABLE IF NOT EXISTS `hl7_interface_connection` (
  ...
  `parsing_script` varchar(50) NOT NULL COMMENT 'for inbound conneciton',
...
$sql[]="CREATE TABLE IF NOT EXISTS `hl7_interface_message_segments` (
...
$sql[]="CREATE TABLE IF NOT EXISTS `hl7_interface_segment_customizations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `interface_id` smallint(6) NOT NULL,
  `segment` varchar(5) NOT NULL,
  `sequence` smallint(6) NOT NULL,
  `val_type` varchar(100) NOT NULL,
  `val` varchar(250) NOT NULL COMMENT 'STATIC or MASK or ELSE',
...
$sql[] = "ALTER TABLE `hl7_interface_segment_customizations` CHANGE `val` `val` VARCHAR(500) NOT NULL COMMENT 'STATIC or MASK or ELSE'";
$sql[] = "ALTER TABLE `hl7_interface_connection`  ADD `msg_encryption` VARCHAR(25) NOT NULL COMMENT 'if in or out msg is encrypted' AFTER `parsing_script`";
$sql[] = "ALTER TABLE `hl7_interface_connection`  ADD `send_with_connection` INT NOT NULL DEFAULT '0' COMMENT 'other connection id' AFTER `msg_type`";
$sql[] = "ALTER TABLE `hl7_interface_connection`  ADD `static_ack_text` VARCHAR(100) NOT NULL COMMENT 'Dynamic normal ACK generated if empty' AFTER `msg_encryption`";
