...
$webroot='../..';
$recreate_cache = 0;
$cache_js_file = $webroot."/cache/cache_scheduler_js.js";
$arr_includeFiles = array();

$arr_includeFiles[] = $webroot.'/library/js/jquery.min.1.12.4.js';
$arr_includeFiles[] = $webroot.'/library/js/jquery-ui.min.1.11.2.js';
...
$arr_includeFiles[] = $webroot.'/library/js/grid_color/spectrum.js';
$arr_includeFiles[] = $webroot.'/library/js/sc_script.js';
$arr_includeFiles[] = $webroot.'/library/js/common.js';

/*if(constant('HASH_METHOD') == "MD5"){
	$arr_includeFiles[] = $webroot.'/library/js/md5.js';
}else{
	$arr_includeFiles[] = $webroot.'/library/js/js_crypto_sha256.js';
}*/
