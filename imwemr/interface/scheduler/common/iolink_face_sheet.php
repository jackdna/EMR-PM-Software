...
ob_start();
$upDirFacesheet	= substr(data_path(), 0, -1);
$srcDirFacesheet= substr(data_path(1), 0, -1);
$strQryGetPatientDemographicData="SELECT pd.*,date_format(pd.date,'%m-%d-%Y') as createdDate,
...
if($p_imagename<>""){
	...
	@copy($dir_real_path,data_path().'tmp/'.$img_name);
	...
	if(file_exists($dir_real_path)){
		...
		if($fileSize[0]>80 || $fileSize[0]>90){
			$imageWidth2 = 100;
			$patientImage = '<img style="cursor:pointer" src="'.$img_name.'" alt="patient Image" width="'.$imageWidth2.'">';
		}
		else{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr> 
		<td style="width:200px;"><b><h1>FACE SHEET</h1></b></td>
		<td style="width:175px;"><b><?php echo $patientDetails['title'].' '.$patientName; ?></b></td>
		<td style="width:125px;">ID :<b><?php echo $patientDetails['id']; ?></b></td>
		<td style="width:200px;" align="center"><b><?php echo $groupDetails['name']; ?></b></td>
	</tr>
	<tr>
		<td align="left">DOB: <b><?php echo $date_of_birth." ($age)"; ?></b></td>
		<td></td>			
		<td rowspan="6" align="center"><?php echo $patientImage; ?></td>
...
<table cellpadding='0' cellspacing='0' border='0' width='100%'>
	<tr>
		<td bgcolor="#c0c0c0" align="left" colspan="4" style="width:750px;"><b><?php echo strtoupper('Patient Demographics'); ?></b></td>
	</tr>
...
?>
<table width="100%" rules="none" cellpadding="0" cellspacing="0" border="0">
	<tr valign="middle" height="25px" class="text_10" bgcolor="#c0c0c0">
		<td align="left" colspan="3" bgcolor="#c0c0c0" style="width:750px;" ><b><?php echo strtoupper('Emergency Contact Information'); ?></b></td>
	</tr>
	<tr align="left" valign="top">
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" rules="none">
	<tr valign="middle" height="25px" class="text_10" bgcolor="#c0c0c0">
		<td align="left" colspan="4" bgcolor="#c0c0c0" style="width:750px;" ><b><?php echo strtoupper('Responsibility Party -'.($i+1)); ?></b></td>
	</tr>
	<?php
	//--- Check That All Fields Are Not Blank -------
	...
	?>
	<tr align="left">
		<td class="text_10b"><b><?php if(trim($res_party_detail[$r]['ss'])!==''){ echo ucwords(substr_replace($res_party_detail[$r]['ss'],'XXX-XX',0,6)); } ?></b></td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" rules="none">
	<tr valign="middle" height="25px" class="text_10" bgcolor="#c0c0c0">
		<td align="left" colspan="3"><b><?php echo strtoupper('Patient Occupation'); ?></b></td>
	</tr>
	<?php
	//--- Check That All Fields Are Not Blank -------
...
if($patientDetails['ethnoracial'] != '' || $patientDetails['interpretter'] != '' || $patientDetails['migrantseasonal'] != '' || $patientDetails['family_size'] != '' || $patientDetails['monthly_income'] != '' || $patientDetails['homeless'] != '' || $patientDetails['financial_reiview'] != ''){ 
?>
<table style="width:750px;" cellpadding="0" cellspacing="0" border="0" rules="none">
	<tr valign="middle" height="25px" class="text_10" bgcolor="#c0c0c0">
		<td align="left" colspan="4"><b><?php echo strtoupper('Miscellaneous'); ?></b></td>
	</tr>
	<tr align="left">
		...
		if($numRowInsDataQry > 0){
			...
			<table style="width:750px;"  cellpadding="0" cellspacing="0" border="0" rules="none">
				...
				<tr valign="middle" height="25px" bgcolor="#c0c0c0">
					<td class="text_10" colspan="4" style="width:750px" bgcolor="#c0c0c0"><b>Insurance</b></td>
				</tr>
				<tr><td height="7"></td></tr>
				<tr> 	
				...
				?>
				<tr valign="middle" height="25px" bgcolor="#c0c0c0">
					<td class="text_10" colspan="4" bgcolor="#c0c0c0" style="width:750px;" ><b><?php echo strtoupper($priInsHeading.' '.$scan_card); ?></b></td>
				</tr>
				<tr><td height="7"></td></tr>
				<?php
					$provider = $insPriDetails['provider'];
					$insCompQry = "select name from insurance_companies where id = '".$provider."' ";
				...
				<tr align="left"> 	
					...
					<td class="text_10b"><b><?php if(trim($insPriDetails['subscriber_ss'])!==''){ echo ucwords(substr_replace($insPriDetails['subscriber_ss'],'XXX-XX',0,6)); } ?></b></td>
				</tr>
				<tr>
...
if(count($scan_card_arr)>0){
	...
	foreach($scan_card_arr as $key => $ins_scan_arr){
		foreach($ins_scan_arr as $scan_key => $scan_val){
			$img_real_path = $upDirFacesheet.$scan_val;
...
if(count($scan_card_arr)>0){
	foreach($scan_card_arr as $key => $ins_scan_arr){
		...
		<tr valign="middle" height="25px" class="text_10" bgcolor="#c0c0c0">
				<td class="text_10" bgcolor="#c0c0c0" style="width:750px;"><b><?php echo strtoupper($key.' scan document'); ?></b></td>
			</tr>
		</table>
		<?php			
			foreach($ins_scan_arr as $scan_key => $scan_val){	
				...
				if(file_exists($img_real_path) != '' && is_dir($img_real_path) == ''){
					...
					//echo '<pre>';
					//print_r($priImageSize);
					$newSize = '';
					if($priImageSize[1]>840){
						$newHeight = 840;
						$newSize = 500;
						$image_view = '<img src="'.$img_real_path.'" height="'.$newHeight.'" width="'.$newSize.'">';
						$priImageSize[1] = 840;
					}
					else{
						$image_view = '<img src="'.$img_real_path.'">';
					}					
					?>						
					<table width="100%" cellpadding="0" cellspacing="0" border="<?php echo $border; ?>">
                        ...
                        <tr>
							<td colspan="2" align="center" style="height:30px;">&nbsp;</td>
						</tr>
					</table>
					<?php
...
ob_end_clean();
$rand=rand(0,500);
$htmlFlName = 'iolink_facesheet_print'.$_SESSION['authId'].'_'.$rand;
$fp = fopen(data_path().'iOLink/'.$htmlFlName.'.html','w');
$putData = fputs($fp,$patientPrintData);
fclose($fp);
$patientPrintData="";
...
//$myHTTPAddress = $httpPro.'//'.'192.168.10.50'.'/'.$web_RootDirectoryName.'/interface/common/html2pdf/iolinkMakePdf.php';
