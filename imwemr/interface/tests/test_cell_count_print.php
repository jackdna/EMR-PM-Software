...
<?php
/*
File: test_cell_count_print.php
Purpose: This file provides print version of Cell count.
	...
	$testCSS = '
		...
		<page_header>
			<table border="0" cellpadding="0" cellspacing="0">				
					<tr>
						<td colspan="3" align="center" style="width:1080px" class="text_b"><b>Cell Count TEST'.$finalize.'</b>
						</td>
					</tr>
					<tr>
            ...
            <table style="width:100%" >
                <tr style="height:20px">
                    <td style="width:55%" >
                            ...
                            <?php echo ($elem_cellcntEye == "OU") ? $yes : $no ;?>&nbsp;&nbsp;
                            <span class="blue_color">OD</span>
                            <?php echo ($elem_cellcntEye == "OD") ? $yes : $no ;?>&nbsp;&nbsp;
                            <span class="green_color ">OS</span>
                            <?php echo ($elem_cellcntEye == "OS") ? $yes : $no ;?>
                    </td>
                </tr>
                <tr>
            ...
            <table cellpadding="0" cellspacing="0" >
                ...
                <tr>
                    <td class="alignLeft valignTop" style="border:1px solid #000000;" >
                         <table cellpadding="0" cellspacing="0" >
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px; width:50px;"><strong>Num</strong></td>
                                <td style="width:300px"><?php echo $elem_numOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>CD</strong></td>
                                <td><?php echo $elem_cdOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>AVG</strong></td>
                                <td><?php echo $elem_avgOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>SD</strong></td>
                                <td><?php echo $elem_sdOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>CV</strong></td>
                                <td><?php echo $elem_cvOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>Max</strong></td>
                                <td><?php echo $elem_mxOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>Min</strong></td>
                                <td><?php echo $elem_mnOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>6A</strong></td>
                                <td><?php echo $elem_6aOd; ?></td>
                            </tr>
                            <tr >
                                <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>CCT</strong></td>
                                <td><?php echo $elem_cctOd; ?></td>
                            </tr>
                            <tr >
                              <td class="valignTop" colspan="2" style="height:<?php echo $trHeight;?>px;"><strong>Pleomorphism Present</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <?php echo ($elem_ppOd == "Y") ? $yes : $no;?>
                              </td>
                            </tr>
                            <tr >
                              <td class="valignTop" colspan="2" style="height:<?php echo $trHeight;?>px;">
	                              <div style="width:450px"><strong>Comments</strong>&nbsp;:&nbsp;<?php echo $elem_descOd; ?></div>
                              </td>
                            </tr>

                        </table>
            </td>
                    <td class="alignLeft valignTop" style="border:1px solid #000000;"><table cellpadding="0" cellspacing="0" >
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px; width:5px;">&nbsp;</td>
                        <td style="width:300px"><?php echo $elem_numOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_cdOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_avgOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_sdOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_cvOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_mxOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_mnOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_6aOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;">&nbsp;</td>
                        <td><?php echo $elem_cctOs; ?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" colspan="2" style="height:<?php echo $trHeight;?>px;"><?php echo ($elem_ppOs == "Y") ? $yes : $no;?></td>
                      </tr>
                      <tr >
                        <td class="valignTop" colspan="2" style="height:<?php echo $trHeight;?>px;"><div style="width:450px"><?php echo $elem_descOs; ?></div></td>
                      </tr>
                    </table></td>
                </tr>
            </table>
    ...
    <tr>
        <td colspan="2">
            <table class="table_collapse" >
                ...
                <tr>
                    <td colspan="5" class="alignLeft nowrap" style="width:150px; "><strong>Informed Pt result next visit</strong><?php echo ($elem_informedPtNv == "1") ? $yes : $no;?></td>
                </tr>
           </table> 
        </td>
    </tr>       
