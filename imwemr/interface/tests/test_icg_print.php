...
<?php
/*
File: test_icg_print.php
Purpose: This is print version of ICG test.
	...
	$testCSS = '
		...
		<page_header>
			<table border="0" cellpadding="0" cellspacing="0">				
					<tr>
						<td colspan="3" align="center" style="width:1080px" class="text_b"><b>ICG TEST'.$finalize.'</b>
						</td>
					</tr>
					<tr>
        ...
        <td colspan="2" class="txt_11b alignLeft">
            <table style="width:100%" >
                <tr style="height:20px">
                    <td style="width:55%" ><strong>ICG</strong>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="drak_purple_color">OU</span>
                            <?php echo ($elem_icg_od == "1") ? $yes : $no ;?>&nbsp;&nbsp;
                            <span class="blue_color">OD</span>
                            <?php echo ($elem_icg_od == "2") ? $yes : $no ;?>&nbsp;&nbsp;
                            <span class="green_color ">OS</span>
                            <?php echo ($elem_icg_od == "3") ? $yes : $no ;?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span>Early and late shots</span>
                            <?php echo ($elem_icg_early == "1") ? $yes : $no ;?>&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="2" style="height:20px;"  class="alignLeft" >
                      <div style="width:900px;"><strong>Technician Comments</strong>&nbsp;:&nbsp;<?php echo $elem_comments_icg; ?></div>
                    </td>
				</tr>                	
            </table>
        </td>
...
<tr class="alignMiddle">
                                        ...
                                        <tr >
                                            <td class="valignTop" style="padding-left:2px; height:<?php echo $trHeight;?>px;"></td>
                                            <td>Feeder  Vessel<?php if($Feeder_Vessel_OD==1) echo $yes; else echo $no; ?></td>
                                            <td colspan="3" >Central<?php echo ($Central_OD == "1") ? $yes : $no; ?></td>
                                            <td colspan="2" >Nasal<?php echo ($Nasal_OD == "1") ? $yes : $no; ?></td>
                                        </tr>
                                        <tr >
                                            <td class="valignTop" style="padding-left:2px; height:<?php echo $trHeight;?>px;"></td>
                                            <td>Temporal<?php if($Temporal_OD==1) echo $yes; else echo $no; ?></td>
                                            <td colspan="3" >Inferior<?php echo ($Inferior_OD == "1") ? $yes : $no; ?></td>
                                            <td colspan="2" >Superior<?php echo ($Superior_OD == "1") ? $yes : $no; ?></td>
                                        </tr>
                                        <tr >
                                            <td class="valignTop" style="padding-left:2px; height:<?php echo $trHeight;?>px;"></td>
                                            <td colspan="6">Hot Spot<?php if($Hot_Spot_OD==1) echo $yes; else echo $no; ?>
                                            &nbsp;&nbsp;&nbsp;<?php echo ($Hot_Spot_Val_OD);?>
                                            </td>
                                        </tr>
                    ...
                    <td class="alignLeft valignTop" style="border:1px solid #000000;"><table cellpadding="0" cellspacing="0" style="width:100%;" >
                      ...
                      <tr >
                        <td class="valignTop" style="padding-left:2px; height:<?php echo $trHeight;?>px;"></td>
                        <td>Notch<?php if($Notch_OS==1) echo $yes; else echo $no; ?></td>
                      ...
                      <tr class="alignMiddle">
                        ...
                        <tr >
                            <td class="valignTop" style="padding-left:2px; height:<?php echo $trHeight;?>px;"></td>
                            <td>Feeder  Vessel<?php if($Feeder_Vessel_OS==1) echo $yes; else echo $no; ?></td>
                            <td colspan="3" >Central<?php echo ($Central_OS == "1") ? $yes : $no; ?></td>
                            <td colspan="2" >Nasal<?php echo ($Nasal_OS == "1") ? $yes : $no; ?></td>
                        </tr>
                        <tr >
                            <td class="valignTop" style="padding-left:2px; height:<?php echo $trHeight;?>px;"></td>
                            <td>Temporal<?php if($Temporal_OS==1) echo $yes; else echo $no; ?></td>
                            <td colspan="3" >Inferior<?php echo ($Inferior_OS == "1") ? $yes : $no; ?></td>
                            <td colspan="2" >Superior<?php echo ($Superior_OS == "1") ? $yes : $no; ?></td>
                        </tr>
                        <tr >
                            <td class="valignTop" style="padding-left:2px; height:<?php echo $trHeight;?>px;"></td>
                            <td colspan="6">Hot Spot<?php if($Hot_Spot_OS==1) echo $yes; else echo $no; ?>
                            &nbsp;&nbsp;&nbsp;<?php echo ($Hot_Spot_Val_OS);?>
                            </td>
                        </tr>
        ...
        <td colspan="2">
            <table class="table_collapse" >
                ...
                <tr>
                  ...
                  <td>F/U Retina<?php echo ($elem_FuRetina == "1") ? $yes : $no;?></td>
                  <td colspan="2"><div style="width:300px;"><?php if($elem_FuRetina == "1") { echo $elem_FuRetinaComments; } ?></div></td>
                </tr>
           </table> 
        </td>
    </tr>       
