...
$test_table_name		= 'iol_master_tbl';
...
if($callFromInterface != 'admin'){
	...
	$html_file_name = $test_name.'/'.$date_f.'/iol_master_test_print_'.$_SESSION['authId']."_".$rand;
...
if($callFromInterface != 'admin'){
	...
	if(!empty($form_id) && (!isset($tId) || empty($tId))){
		//Get based on Form id patient id
		$getSurgicalRecordSavedStr = "SELECT * FROM iol_master_tbl
	...
	//FOR COMPARE
		...
		//IF PREVIOUS EXISTS
			...
			/*
			$getCompareStr = "SELECT * FROM iol_master_tbl
								WHERE patient_id = '$patient_id'
								ORDER BY form_id DESC limit 0, 2";
			*/
			$getCompareStr = "SELECT * FROM iol_master_tbl
								WHERE patient_id = '$patient_id'
								ORDER BY iol_master_id DESC limit 0, 2";
		...
		if($flgGetMRVals==0&&$flgGetKVals==0){
				$getSurgicalRecordStr = "SELECT * FROM iol_master_tbl
										WHERE patient_id = '$patient_id'
										ORDER BY examDate DESC, form_id DESC, iol_master_id DESC limit 0, 1";
...
if($callFromInterface != 'admin'){
	...
	//Super bill init() --
	$superLen = "1";
	$sb_testName = 'iOLMaster';
	
	//Cpt Code Desc
	$thisCptDescSym = "IOL Master";
}

if($callFromInterface != 'admin'){
	if($iol_master_id && $iol_master_id > 0){
		$test_edid = $surgical_id = $iol_master_id;
	}else{
		$test_edid = $surgical_id = 0;	
	}
}
?>
<!DOCTYPE html>
...
<?php }?>
<style>.form-control-feedback{width:26px;height:26px;line-height:26px;pointer-events:auto;cursor:pointer;}</style>
...
<input type="hidden" name="elem_saveForm" id="elem_saveForm" value="IOL Master">
...
<div class=" container-fluid">
    <div class="mainarea">
        <div class="row">
            <div class="col-sm-<?php if($callFromInterface != 'admin' && $doNotShowRightSide!='yes'){echo '10';}else{echo '12';}?>">
                        ...
                        <div class="mrlft">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                        	<div class="form-group">
                                            	<label for="">S</label>
	                                            <input type="text" tabindex="2" class="form-control <?php if($rowsCount>0 && $vis_mr_od_sC==$vis_mr_od_s){echo "backgroundLightGray";}else{echo $classText;} ?>" name="mrSOD" id="mrSOD" value="<?php echo $vis_mr_od_s; ?>" onBlur="changeMRBgColor(this, '<?php echo imw_real_escape_string($vis_mr_od_s); ?>');">
                                          	</div>
                                        </div>
                                        <div class="col-sm-4">
                                        	<div class="form-group">
                                                <label for="">C</label>
                                                <input type="text" tabindex="3" class="form-control <?php  if($rowsCount>0 && $vis_mr_od_cC==$vis_mr_od_c){echo "backgroundLightGray";}else{echo $classText;}?>" name="mrCOD" id="mrCOD" value="<?php echo $vis_mr_od_c; ?>" onBlur="changeMRBgColor(this, '<?php echo imw_real_escape_string($vis_mr_od_c); ?>');">
                                          	</div>
                                        </div>
                                        <div class="col-sm-4">
                                        	<div class="form-group">
                                            	<label for="">A</label>
                                            	<input type="text" tabindex="4" class="form-control <?php if($rowsCount>0 && $vis_mr_od_aC==$vis_mr_od_a){echo "backgroundLightGray";}else{echo $classText;}?>" name="mrAOD" id="mrAOD" value="<?php echo $vis_mr_od_a; ?>" onBlur="changeMRBgColor(this, '<?php echo imw_real_escape_string($vis_mr_od_a); ?>');">
                                          	</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6"><input tabindex="5" type="text" class="form-control <?php if($rowsCount>0 && $visionODC==$visionOD){echo "backgroundLightGray";}else{echo $classText;}?>" name="visionOD" id="visionOD" value="<?php echo $visionOD; ?>" onBlur="return chkFormat('visionOD', '<?php echo imw_real_escape_string($visionOD); ?>');"> Vision</div>
                                        <div class="col-sm-6"><input tabindex="6" type="text" class="form-control <?php if($rowsCount>0 && $glareODC==$glareOD){echo "backgroundLightGray";}else{echo $classText;}?>" name="glareOD" id="glareOD" value="<?php echo $glareOD; ?>" onBlur="return chkFormat('glareOD', '<?php echo imw_real_escape_string($glareOD); ?>');"> Glare</div>
                                    </div>
                                </div>
                            </div>
                    	...
                    	<div class="testsctbx">
                                ...
                                <div class="row">
                                    <div class="col-sm-12  tstflt text-right form-inline">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select tabindex="7" class="form-control minimal <?php if($rowsCount>0 && $authUserId==$authUserIdC){echo "text backgroundLightGray";}else{echo $classText;}?>"name="performedByOD" id="performedByOD">
                                                <option value=""></option>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input tabindex="8" id="dateOD" name="dateOD" type="text" value="<?php echo get_date_format($today,'mm-dd-yyyy'); ?>" onBlur="checkdate(this);" maxlength=10 class="form-control datePicker <?php if($rowsCount>0 && $dateODC!='' && $dateOD==$dateODC){echo "backgroundLightGray";}else{echo $classText;}?>">
                            ...
                            <div class="testsctbxpd">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3"><select tabindex="9" class="form-control minimal <?php if($rowsCount>0 && $autoSelectODC==$autoSelectOD){echo "backgroundLightGray";}else{echo $classText;}?>" id="menuMain4Text" name="autoSelectOD">
                                    ...
                                    <div class="col-sm-3"><select tabindex="17" class="form-control minimal <?php if($rowsCount>0 && trim($iolMasterSelectOD)==trim($iolMasterSelectODC)){echo "backgroundLightGray";}else{echo $classText;}?>" name="iolMasterSelectOD" id="iolMasterSelectOD">
									  <?php foreach($kReadingArr as $k=>$v){
                                    ...
                                    <div class="col-sm-3"><select tabindex="25" class="form-control minimal <?php if($rowsCount>0 && trim($iolMasterSelectOD)==trim($iolMasterSelectODC)){echo "backgroundLightGray";}else{echo $classText;}?>" name="topographerSelectOD">
									  <?php foreach($kReadingArr as $k=>$v){
                                    ...
                                    <div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                            <input type="text" tabindex="12" class="form-control <?php if($rowsCount>0 && $k2Auto1OD==$k2Auto1ODC){echo "backgroundLightGray";}?>" name="k2Auto1OD" id="k2Auto1OD" value="<?php if($vis_ak_od_slash!=0){ echo $vis_ak_od_slash; } ?>" onBlur="return calCulate('k1Auto1OD', 'k1Auto2OD', 'k2Auto1OD', 'k2Auto2OD', 'cylAuto1OD', 'cylAuto2OD', 'aveAutoOD');">
                                            <img src="<?php echo $library_path; ?>/images/close_small.png" alt=""/>
                                            <input type="text" tabindex="13" class="form-control <?php if($rowsCount>0 && $k2Auto2OD==$k2Auto2ODC){echo "backgroundLightGray";}?>" name="k2Auto2OD" id="k2Auto2OD" value="<?php if($k2Auto2OD!='') echo $k2Auto2OD; else echo $vis_ak_od_x; ?>" onBlur="return calCulate('k1Auto1OD', 'k1Auto2OD', 'k2Auto1OD', 'k2Auto2OD', 'cylAuto1OD', 'cylAuto2OD', 'aveAutoOD');">
                                        </div>
                                    </div>
                        
                                    <div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                            <input tabindex="20" class="form-control <?php if($rowsCount>0 && $k2IolMaster1OD==$k2IolMaster1ODC){echo "backgroundLightGray";}?>" name="k2IolMaster1OD" id="k2IolMaster1OD" value="<?php if($k2IolMaster1OD!=0){ echo $k2IolMaster1OD; } ?>" onBlur="return calCulate('k1IolMaster1OD', 'k1IolMaster2OD', 'k2IolMaster1OD', 'k2IolMaster2OD', 'cylIolMaster1OD', 'cylIolMaster2OD', 'aveIolMasterOD');">
                                            <img src="<?php echo $library_path; ?>/images/close_small.png" alt=""/>
                                            <input tabindex="21" type="text" class="form-control <?php if($rowsCount>0 && $k2IolMaster2OD==$k2IolMaster2ODC){echo "backgroundLightGray";}?>" name="k2IolMaster2OD" id="k2IolMaster2OD" value="<?php if($k2IolMaster2OD!=0){ echo $k2IolMaster2OD; } ?>" onBlur="return calCulate('k1IolMaster1OD', 'k1IolMaster2OD', 'k2IolMaster1OD', 'k2IolMaster2OD', 'cylIolMaster1OD', 'cylIolMaster2OD', 'aveIolMasterOD');">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                            <input readonly tabindex="14" type="text" class="form-control <?php if($rowsCount>0 && $cylAuto1OD==$cylAuto1ODC){echo "backgroundLightGray";}?>" name="cylAuto1OD" id="cylAuto1OD" value="<?php if($cyl1OD!=0){echo $cyl1OD;}?>">
                                            ...
                                            <input readonly tabindex="15" type="text" class="form-control <?php if($rowsCount>0 && $cylAuto2OD==$cylAuto2ODC){echo "backgroundLightGray";}?>" name="cylAuto2OD" id="cylAuto2OD" value="<?php if($cylAuto2OD!=0){echo $cylAuto2OD;}?>">
                                    ...
                                    <div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                            <input readonly tabindex="22" type="text" class="form-control <?php if($rowsCount>0 && $cylIolMaster1OD==$cylIolMaster1ODC){echo "backgroundLightGray";}?>" name="cylIolMaster1OD" id="cylIolMaster1OD" value="<?php if($cylIolMaster1OD!=0){echo $cylIolMaster1OD;}?>">
                                            <input type="hidden" name="cylIolMaster1ODH" id="cylIolMaster1ODH" value="<?php if($cylIolMaster1OD!=0){echo $cylIolMaster1OD;}?>">
                                            <img src="<?php echo $library_path; ?>/images/atsign.png" alt=""/>
                                            <input readonly tabindex="23" type="text" class="form-control <?php if($rowsCount>0 && $cylIolMaster2OD==$cylIolMaster2ODC){echo "backgroundLightGray";}?>" name="cylIolMaster2OD" id="cylIolMaster2OD" value="<?php if($cylIolMaster2OD!=0){echo $cylIolMaster2OD;}?>">
                                    ...
                                    <div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                            <input readonly tabindex="30" type="text" class="form-control <?php if($rowsCount>0 && $cylTopographer1OD==$cylTopographer1ODC){echo "backgroundLightGray";}?>" name="cylTopographer1OD" id="cylTopographer1OD" value="<?php if($cylTopographer1OD!=0){echo $cylTopographer1OD;}?>">
                                            <input type="hidden" name="cylTopographer1ODH" id="cylTopographer1ODH" value="<?php if($cylTopographer1OD!=0){echo $cylTopographer1OD;}?>">
                                            <img src="<?php echo $library_path; ?>/images/atsign.png" alt=""/>
                                            <input readonly tabindex="31" type="text" class="form-control <?php if($rowsCount>0 && $cylTopographer2OD==$cylTopographer2ODC){echo "backgroundLightGray";}?>" name="cylTopographer2OD" id="cylTopographer2OD" value="<?php if($cylTopographer2OD!=0){echo $cylTopographer2OD;}?>">
                                    ...
                                    <div class="col-sm-3 text-right">
                                        ...
                                        <div class="col-sm-3 form-inline kloption">
                                            <div class="form-group">
                                                <input type="text" tabindex="16" class="form-control <?php if($rowsCount>0 && $aveAutoOD==$aveAutoODC){echo "backgroundLightGray";}?>" name="aveAutoOD" id="aveAutoOD" value="<?php if($aveOD1!=0){echo $aveOD1;}?>">
                                    ...
                                    <tr>
                                        <td>Length</td>
                                        <td><input type="text" tabindex="33" class="form-control <?php if($rowsCount>0 && $contactLengthOD==$contactLengthODC){echo "backgroundLightGray";}?>" name="contactLengthOD" id="contactLengthOD" value="<?php echo $contactLengthOD; ?>"></td>
                                        <td><input type="text" tabindex="34" class="form-control <?php if($rowsCount>0 && $immersionLengthOD==$immersionLengthODC){echo "backgroundLightGray";}?>" name="immersionLengthOD" id="immersionLengthOD" value="<?php echo $immersionLengthOD; ?>"></td>
                                        <td><input type="text" tabindex="35" class="form-control <?php if($rowsCount>0 && $iolMasterLengthOD==$iolMasterLengthODC){echo "backgroundLightGray";}?>" name="iolMasterLengthOD" id="iolMasterLengthOD" value="<?php echo $iolMasterLengthOD; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Notes</td>
                                        <td><textarea tabindex="36" name="contactNotesOD" id="contactNotesOD" rows="1" cols="20" class="form-control"><?php echo $contactNotesOD; ?></textarea></td>
                                        <td><textarea tabindex="37" name="immersionNotesOD" id="immersionNotesOD" rows="1" cols="20" class="form-control"><?php echo $immersionNotesOD; ?></textarea></td>
                                        <td><textarea tabindex="38" name="iolMasterNotesOD" id="iolMasterNotesOD" rows="1" cols="20" class="form-control"><?php echo $iolMasterNotesOD; ?></textarea></td>
                                    </tr>
                                    </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="mrrht">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="row">
                                        <div class="col-sm-4">
                                        	<div class="form-group">
                                            	<label for="">S</label>
	                                            <input tabindex="84" type="text" class="form-control <?php if($rowsCount>0 && $vis_mr_os_sC==$vis_mr_os_s){echo "backgroundLightGray";}else{echo $classText;}?>" name="mrSOS" id="mrSOS" value="<?php echo $vis_mr_os_s; ?>">
                                        	</div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="">C</label>
                                                <input tabindex="85" type="text" class="form-control <?php if($rowsCount>0 && $vis_mr_os_cC==$vis_mr_os_c){echo "backgroundLightGray";}else{echo $classText;}?>" name="mrCOS" id="mrCOS" value="<?php echo $vis_mr_os_c; ?>">
                                         	</div>
                                         </div>
                                         <div class="col-sm-4">
                                         	<div class="form-group">
                                                <label for="">A</label>
                                                <input tabindex="86" type="text" class="form-control <?php if($rowsCount>0 && $vis_mr_os_aC==$vis_mr_os_a){echo "backgroundLightGray";}else{echo $classText;}?>" name="mrAOS" id="mrAOS" value="<?php echo $vis_mr_os_a; ?>">
                                         	</div>
                                         </div>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                	<label for="">VISION</label>
                                    <div class="row">
                                        <div class="col-sm-6"><input tabindex="87" type="text" class="form-control <?php if($rowsCount>0 && $visionOSC==$visionOS){echo "backgroundLightGray";}else{echo $classText;}?>" name="visionOS" id="visionOS" value="<?php echo $visionOS;?>" onBlur="return chkFormat('visionOS', '<?php echo imw_real_escape_string($visionOS); ?>');"> Vision</div>
                                        <div class="col-sm-6"><input tabindex="88" type="text" class="form-control <?php if($rowsCount>0 && $glareOSC==$glareOS){echo "text backgroundLightGray";}else{echo $classText;}?>" name="glareOS" id="glareOS" value="<?php echo $glareOS; ?>" onBlur="return chkFormat('glareOS', '<?php echo imw_real_escape_string($glareOS); ?>');"> Glare</div>
                                    </div>
                                </div>
                            </div>
                			<div class="clearfix"></div>
                    	...
                    	<div class="testsctbx">
                            <div class="tstthead">
                                <div class="row">
                                    <div class="col-sm-12 tstflt text-right form-inline">
                                        ...
                                        <div class="form-group">
                                            <label for="">Performed By:</label>
                                            <select tabindex="89" name="phyTechListOS" id="phyTechListOS" class="form-control minimal <?php if($rowsCount>0 && $performedByOSC==$performedByOS){echo "backgroundLightGray";}?>">
                                            <option value=""></option>
                                            <?php
                                            foreach($phyTechArray as $phyTechId => $phyTechName){
                                                ?>
                                        ...
                                        <div class="form-group">
                                        	<label for="">Date</label>
                                            <div class="input-group">
                                            	<input tabindex="90" id="dateOS" type="text" name="dateOS" onBlur="checkdate(this);" maxlength="10" class="form-control datePicker <?php if($rowsCount>0 && $dateOSC==$dateOS){echo "backgroundLightGray";}?>" value="<?php if(!$dateOS){echo get_date_format($today,'mm-dd-yyyy');}else{echo get_date_format($dateOS,'mm-dd-yyyy');}?>">
                            ...
                            <div class="testsctbxpd">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">&nbsp;</div>
                                    <div class="col-sm-3">
                                    	<select tabindex="91" class="form-control minimal <?php if($rowsCount>0 && $autoSelectOS==$autoSelectOSC){echo "backgroundLightGray";}else{echo $classText;}?>" id="menuMain4Text" name="autoSelectOS">
										  <?php foreach($kReadingArr as $k=>$v){
                                              $sel_autoSelectOS = '';
                                    ...
                                    <div class="col-sm-3"><select tabindex="99" class="form-control minimal <?php if($rowsCount>0 && $iolMasterSelectOS==$iolMasterSelectOSC){echo "backgroundLightGray";}else{echo $classText;}?>" name="iolMasterSelectOS" id="iolMasterSelectOS">
									  <?php foreach($kReadingArr as $k=>$v){
                                    ...
                                    <div class="col-sm-3"><select tabindex="107" class="form-control minimal <?php if($rowsCount>0 && $topographerSelectOS==$topographerSelectOSC){echo "backgroundLightGray";}else{echo $classText;}?>" name="topographerSelectOS" id="topographerSelectOS">
									  <?php foreach($kReadingArr as $k=>$v){
                                    ...
                                    <div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                        	<input readonly tabindex="96" type="text" class="form-control <?php if($rowsCount>0 && $cylAuto1OS==$cylAuto1OSC){echo "backgroundLightGray";}?>" name="cylAuto1OS" id="cylAuto1OS" value="<?php if($cyl1OS!=0){ echo $cyl1OS; } ?>">
                                            <input type="hidden" name="cylAuto1OSH" id="cylAuto1OSH" value="<?php if($cyl1OS!=0){echo $cyl1OS;}?>">
											<img src="<?php echo $library_path; ?>/images/atsign.png" alt=""/>
                                        	<input readonly tabindex="97" type="text" class="form-control <?php if($rowsCount>0 && $cylAuto2OS==$cylAuto2OSC){echo "backgroundLightGray";}?>" name="cylAuto2OS" id="cylAuto2OS" value="<?php if($cylAuto2OS!=0){echo $cylAuto2OS;}?>">
                                            <input type="hidden" name="cylAuto2OSH" id="cylAuto2OSH" value="<?php if($cylAuto2OS!=0){echo $cylAuto2OS;}?>">
                                        </div>
                                    </div>
                                	<div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                            <input readonly tabindex="104" type="text" class="form-control <?php if($rowsCount>0 && $cylIolMaster1OS==$cylIolMaster1OSC){echo "backgroundLightGray";}?>" name="cylIolMaster1OS" id="cylIolMaster1OS" value="<?php if($cylIolMaster1OS!=0){echo $cylIolMaster1OS; } ?>">
                                            <input type="hidden" name="cylIolMaster1OSH" id="cylIolMaster1OSH" value="<?php if($cylIolMaster1OS!=0){echo $cylIolMaster1OS;}?>">
                                            <img src="<?php echo $library_path; ?>/images/atsign.png" alt=""/>
                                            <input readonly tabindex="105" type="text" class="form-control <?php if($rowsCount>0 && $cylIolMaster2OS==$cylIolMaster2OSC){echo "backgroundLightGray";}?>" name="cylIolMaster2OS" id="cylIolMaster2OS" value="<?php if($cylIolMaster2OS!=0){echo $cylIolMaster2OS;}?>">
                                            <input  type="hidden" name="cylIolMaster2OSH" id="cylIolMaster2OSH" value="<?php if($cylIolMaster2OS!=0){echo $cylIolMaster2OS;}?>">
                                        </div>
                                    </div>
                                	<div class="col-sm-3 form-inline kloption">
                                        <div class="form-group">
                                        	<input readonly tabindex="112" type="text" class="form-control <?php if($rowsCount>0 && $cylTopographer1OS==$cylTopographer1OSC){echo "backgroundLightGray";}?>" name="cylTopographer1OS" id="cylTopographer1OS" value="<?php if($cylTopographer1OS!=0){ echo $cylTopographer1OS;}?>">
                                            <input type="hidden"  name="cylTopographer1OSH" id="cylTopographer1OSH" value="<?php if($cylTopographer1OS!=0){echo $cylTopographer1OS;}?>">
                                          	<img src="<?php echo $library_path; ?>/images/atsign.png" alt=""/>
                                        	<input readonly tabindex="113" type="text" class="form-control <?php if($rowsCount>0 && $cylTopographer2OS==$cylTopographer2OSC){echo "backgroundLightGray";}?>" name="cylTopographer2OS" id="cylTopographer2OS" value="<?php if($cylTopographer2OS!=0){ echo $cylTopographer2OS;}?>">
                                ...
                                <div class="table-responsive tsttbl ">
                                    ...
                                    <tr>
                                        <td>Length</td>
                                        <td><input type="text" tabindex="115" class="form-control <?php if($rowsCount<=0){ echo 'text_9'; }else{ if($contactLengthOS==$contactLengthOSC) echo "text backgroundLightGray"; else echo $classText; } ?>" size="10" name="contactLengthOS" id="contactLengthOS" value="<?php echo $contactLengthOS; ?>"></td>
										<td><input type="text" tabindex="116" class="form-control <?php if($rowsCount<=0){ echo 'text_9'; }else{ if($immersionLengthOS==$immersionLengthOSC) echo "text backgroundLightGray"; else echo $classText; } ?>" size="10" name="immersionLengthOS" id="immersionLengthOS" value="<?php echo $immersionLengthOS; ?>"></td>
										<td><input type="text" tabindex="117" class="form-control <?php if($rowsCount<=0){ echo 'text_9'; }else{ if($iolMasterLengthOS==$iolMasterLengthOSC) echo "text backgroundLightGray"; else echo $classText; } ?>" size="10" name="iolMasterLengthOS" id="iolMasterLengthOS" value="<?php echo $iolMasterLengthOS; ?>"></td>
                                    </tr>
                                    <tr>
                                      	<td>Notes</td>
                                      	<td><textarea tabindex="118" name="contactNotesOS" id="contactNotesOS" rows="1" cols="20" class="form-control"><?php echo $contactNotesOS; ?></textarea></td>
									  	<td><textarea tabindex="119" name="immersionNotesOS" id="immersionNotesOS" rows="1" cols="20" class="form-control"><?php echo $immersionNotesOS; ?></textarea></td>
										<td><textarea tabindex="120" name="iolMasterNotesOS" id="iolMasterNotesOS" rows="1" cols="20" class="form-control"><?php echo $iolMasterNotesOS; ?></textarea></td>
                                    </tr>
                                    </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="testsctbx">
                            <div class="tstthead">
                                <div class="row">
                                    <div class="col-sm-12 tstflt text-right form-inline">
                                        ...
                                        <div class="form-group">
                                            <label for="">Performed By:</label>
                                            <select tabindex="39" class="form-control minimal <?php if($rowsCount>0 && ($provider_idOD==$provider_idODC || empty($provider_idOD)==empty($provider_idODC))){echo "backgroundLightGray";}?>" id="performedByPhyOD" name="performedByPhyOD" onChange="return getFormulaValues('performedByPhyOD', 'OD', '<? echo $patient_id; ?>', '<?php echo $form_id; ?>');">
                                                <option value=""></option>
                            ...
                            <div class="testsctbxpd performedBy">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="40" class="form-control minimal <?php if($rowsCount>0 && $powerIolOD==$powerIolODC){echo "backgroundLightGray";}else{echo $classText;}?>" name="powerIolOD" id="powerIolOD">
                                          <?php
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="41" class="form-control minimal <?php if($rowsCount>0 && $holladayOD==$holladayODC){echo "backgroundLightGray";}else{echo $classText;}?>" name="holladayOD" id="holladayOD">
                                          <?php
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="42" class="form-control minimal <?php if($rowsCount>0 && $srk_tOD==$srk_tODC){echo "backgroundLightGray";}else{echo $classText;}?>" name="srk_tOD" id="srk_tOD">
                                          <?php
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="43" class="form-control minimal <?php if($rowsCount>0 && ($hofferOD==$hofferODC||$hofferOD = getFormulaHeadName($hofferODC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="hofferOD" id="hofferOD">
                                          <?php
                                ...
                                <div class="row" id="iolOD1">
                                	<!--OD1-->
                                    <div class="col-sm-2">
                                        <select tabindex="44" class="form-control minimal <?php if($rowsCount>0 && (($iol1OD==$iol1ODC) || ($providerLensesArrOD[0]==$iol1ODC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="iol1OD" id="iol1OD" onChange="return listLenses('1', 'iol1OD');"><option value=""></option>
                                          <?php
                                    ...
                                    <div class="col-sm-2"><input tabindex="45" type="text" class="form-control <?php if($rowsCount>0 && $iol1PowerOD==$iol1PowerODC){echo "backgroundLightGray";}?>" name="iol1PowerOD" id="iol1PowerOD" value="<?php echo $iol1PowerOD; ?>" onKeyDown="return checkIolVal('iol1OD');"></div>
                                    <div class="col-sm-2"><input tabindex="46" type="text" class="form-control <?php if($rowsCount>0 && $iol1HolladayOD==$iol1HolladayODC){echo "backgroundLightGray";}?>" name="iol1HolladayOD" id="iol1HolladayOD" value="<?php echo $iol1HolladayOD; ?>" onKeyDown="return checkIolVal('iol1OD');"></div>
                                    <div class="col-sm-2"><input tabindex="47" type="text" class="form-control <?php if($rowsCount>0 && $iol1srk_tOD==$iol1srk_tODC){echo "backgroundLightGray";}?>" name="iol1srk_tOD" id="iol1srk_tOD" value="<?php echo $iol1srk_tOD; ?>" onKeyDown="return checkIolVal('iol1OD');"></div>
                                    <div class="col-sm-2"><input tabindex="48" type="text" class="form-control <?php if($rowsCount>0 && $iol1HofferOD==$iol1HofferODC){echo "backgroundLightGray";}?>" name="iol1HofferOD" id="iol1HofferOD" value="<?php echo $iol1HofferOD; ?>" onKeyDown="return checkIolVal('iol1OD');"></div>
                                	<!--OD1-->
                                </div>
                                <div class="row" id="iolOD2">
                                    <!--OD2-->
                                    <div class="col-sm-2">
                                        <select tabindex="49" class="form-control minimal <?php if($rowsCount>0 && (($iol2OD==$iol2ODC) || ($providerLensesArrOD[1]==$iol2ODC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="iol2OD" id="iol2OD" onChange="return listLenses('2', 'iol2OD');"><option value=""></option>
                                          <?php
                                          foreach($lensesArray as $k=>$v){
                                              $sel_lensesArray = '';
                                    ...
                                    <div class="col-sm-2"><input tabindex="50" type="text" class="form-control <?php if($rowsCount>0 && $iol2PowerOD==$iol2PowerODC){echo "backgroundLightGray";}?>" name="iol2PowerOD" id="iol2PowerOD" value="<?php echo $iol2PowerOD; ?>" onKeyDown="return checkIolVal('iol2OD');"></div>
                                    <div class="col-sm-2"><input tabindex="51" type="text" class="form-control <?php if($rowsCount>0 && $iol2HolladayOD==$iol2HolladayODC){echo "backgroundLightGray";}?>" name="iol2HolladayOD" id="iol2HolladayOD" value="<?php echo $iol2HolladayOD; ?>" onKeyDown="return checkIolVal('iol2OD');"></div>
                                    <div class="col-sm-2"><input tabindex="52" type="text" class="form-control <?php if($rowsCount>0 && $iol2srk_tOD==$iol2srk_tODC){echo "backgroundLightGray";}?>" name="iol2srk_tOD" id="iol2srk_tOD" value="<?php echo $iol2srk_tOD; ?>" onKeyDown="return checkIolVal('iol2OD');"></div>
                                    <div class="col-sm-2"><input tabindex="53" type="text" class="form-control <?php if($rowsCount>0 && $iol2HofferOD==$iol2HofferODC){echo "backgroundLightGray";}?>" name="iol2HofferOD" id="iol2HofferOD" value="<?php echo $iol2HofferOD; ?>" onKeyDown="return checkIolVal('iol2OD');"></div>
                                    <!--OD2-->
    							</div>
                                <div class="row" id="iolOD3">
                                    <!--OD3-->
                                    <div class="col-sm-2">
                                        <select tabindex="54" class="form-control minimal <?php if($rowsCount>0 && (($iol3OD==$iol3ODC) || ($providerLensesArrOD[2]==$iol3ODC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="iol3OD"  id="iol3OD" onChange="return listLenses('3', 'iol3OD');"><option value=""></option>
                                          <?php
                                          foreach($lensesArray as $k=>$v){
                                              $sel_lensesArray = '';
                                    ...
                                    <div class="col-sm-2"><input tabindex="55" type="text" class="form-control <?php if($rowsCount>0 && $iol3PowerOD==$iol3PowerODC){echo "backgroundLightGray";}?>" name="iol3PowerOD" id="iol3PowerOD" value="<?php echo $iol3PowerOD; ?>" onKeyDown="return checkIolVal('iol3OD');"></div>
                                    <div class="col-sm-2"><input tabindex="56" type="text" class="form-control <?php if($rowsCount>0 && $iol3HolladayOD==$iol3HolladayODC){echo "backgroundLightGray";}?>" name="iol3HolladayOD" id="iol3HolladayOD" value="<?php echo $iol3HolladayOD; ?>" onKeyDown="return checkIolVal('iol3OD');"></div>
                                    <div class="col-sm-2"><input tabindex="57" type="text" class="form-control <?php if($rowsCount>0 && $iol3srk_tOD==$iol3srk_tODC){echo "backgroundLightGray";}?>" name="iol3srk_tOD" id="iol3srk_tOD" value="<?php echo $iol3srk_tOD; ?>" onKeyDown="return checkIolVal('iol3OD');"></div>
                                    <div class="col-sm-2"><input tabindex="58" type="text" class="form-control <?php if($rowsCount>0 && $iol3HofferOD==$iol3HofferODC){echo "backgroundLightGray";}?>" name="iol3HofferOD" id="iol3HofferOD" value="<?php echo $iol3HofferOD; ?>" onKeyDown="return checkIolVal('iol3OD');"></div>
                                    <!--OD3-->
        						</div>
                                <div class="row" id="iolOD4">
                                    <!--OD4-->
                                    <div class="col-sm-2">
                                        <select tabindex="59" class="form-control minimal <?php if($rowsCount>0 && (($iol4OD==$iol4ODC) || ($providerLensesArrOD[3]==$iol4ODC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="iol4OD" id="iol4OD" onChange="return listLenses('4', 'iol4OD');"><option value=""></option>
                                          <?php
                                          foreach($lensesArray as $k=>$v){
                                              $sel_lensesArray = '';
                                    ...
                                    <div class="col-sm-2"><input tabindex="60" type="text" class="form-control <?php if($rowsCount>0 && $iol4PowerOD==$iol4PowerODC){echo "backgroundLightGray";}?>" name="iol4PowerOD" id="iol4PowerOD" value="<?php echo $iol4PowerOD; ?>" onKeyDown="return checkIolVal('iol4OD');"></div>
                                    <div class="col-sm-2"><input tabindex="61" type="text" class="form-control <?php if($rowsCount>0 && $iol4HolladayOD==$iol4HolladayODC){echo "backgroundLightGray";}?>" name="iol4HolladayOD" id="iol4HolladayOD" value="<?php echo $iol4HolladayOD; ?>" onKeyDown="return checkIolVal('iol4OD');"></div>
                                    <div class="col-sm-2"><input tabindex="62" type="text" class="form-control <?php if($rowsCount>0 && $iol4srk_tOD==$iol4srk_tODC){echo "backgroundLightGray";}?>" name="iol4srk_tOD" id="iol4srk_tOD" value="<?php echo $iol4srk_tOD; ?>" onKeyDown="return checkIolVal('iol4OD');"></div>
                                    <div class="col-sm-2"><input tabindex="63" type="text" class="form-control <?php if($rowsCount>0 && $iol4HofferOD==$iol4HofferODC){echo "backgroundLightGray";}?>" name="iol4HofferOD" id="iol4HofferOD" value="<?php echo $iol4HofferOD; ?>" onKeyDown="return checkIolVal('iol4OD');"></div>
                                    <!--OD4-->
                            	</div>
	                            <div class="clearfix"></div>
                                ...
                                <div class="performedBy">
                                    <div class="row">
                                        <div class="col-sm-2"><label>Cell Count</label> <input tabindex="64" type="text" class="form-control <?php if($rowsCount>0 && $cellCountOD==$cellCountODC){echo "backgroundLightGray";}?>" name="cellCountOD" id="cellCountOD" value="<?php echo $cellCountOD;?>"></div>
                                        <div class="col-sm-2">
                                            <label>Pachymetry</label> 
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input tabindex="65" type="text" class="form-control <?php if($rowsCount>0 && $pachymetryValOD==$pachymetryValODC){echo "backgroundLightGray";}?>" name="pachymetryValOD" id="pachymetryValOD" value="<?php echo $pachymetryValOD; ?>" onChange="calCorrectionVal(this.value,'OD');"></div>
                                                <div class="col-sm-6">
                                                    <input tabindex="66" type="text" class="form-control <?php if($rowsCount>0 && $pachymetryCorrecOD==$pachymetryCorrecODC){echo "backgroundLightGray";}?>" name="pachymetryCorrecOD" id="pachymetryCorrecOD" value="<?php echo $pachymetryCorrecOD; ?>"></div>
                                            </div>
                                        </div>
                                        <div class="col-sm-2"><label>Corneal Diam</label> <input tabindex="67" type="text" class="form-control <?php if($rowsCount>0 && $cornealDiamOD==$cornealDiamODC){echo "backgroundLightGray";}?>" name="cornealDiamOD" id="cornealDiamOD" value="<?php echo $cornealDiamOD; ?>"></div>
                                        <div class="col-sm-2"><label>Dominant Eye</label> <input tabindex="68" type="text" class="form-control <?php if($rowsCount>0 && $dominantEyeOD==$dominantEyeODC){echo "backgroundLightGray";}?>" name="dominantEyeOD" id="dominantEyeOD" value="<?php echo $dominantEyeOD; ?>"></div>
                                        <div class="col-sm-2"><label>ACD Eye</label> <input tabindex="69" type="text" class="form-control <?php if($rowsCount>0 && $acdOD==$acdODC){echo "backgroundLightGray";}?>" name="acdOD" id="acdOD" value="<?php echo $acdOD; ?>"></div>
                                        <div class="col-sm-2"><label>White to White</label> <input tabindex="70" type="text" class="form-control <?php if($rowsCount && $w2wOD==$w2wODC){echo "backgroundLightGray";}?>" name="w2wOD" id="w2wOD" value="<?php echo $w2wOD; ?>"></div>
                                        <div class="col-sm-4">
                                            <label>Pupil Size</label>
                                            <div class="row">
                                                <div class="col-sm-6"><input tabindex="71" type="text" class="form-control <?php if($rowsCount>0 && $pupilSize1OD==$pupilSize1ODC){echo "backgroundLightGray";}?>" name="pupilSize1OD" id="pupilSize1OD" value="<?php echo $pupilSize1OD;?>"><small>Un-Dilated</small></div>
                                                <div class="col-sm-1">/</div>
                                                <div class="col-sm-5"><input tabindex="72" type="text" class="form-control <?php if($rowsCount>0 && $pupilSize2OD==$pupilSize2ODC){echo "backgroundLightGray";} ?>" name="pupilSize2OD" id="pupilSize2OD" value="<?php echo $pupilSize2OD; ?>"><small>Dilated</small></div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="col-sm-12"><label>Notes</label> <textarea tabindex="73" rows="3" name="notesOD" id="notesOD" class="form-control" onClick="return makeEmpty(this)" placeholder="Notes..."><?php echo $notesOD; ?></textarea></div>
                                    </div>
                                </div>
                            	<div class="clearfix"></div>
                                ...
                                <tr>
                                    ...
                                    <div class="form-group" style="width:38%;">
                                        <select style="width:90%;" tabindex="74" class="form-control minimal" name="selecedIOLsOD" id="selecedIOLsOD" onChange="return doSelectOD(this)">
                                            <option value=""></option>
                                            <?php
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input tabindex="75" id="sur_dateOD" type="text"  name="sur_dateOD" value="<?php echo $sur_dateOD;?>"  onBlur="checkdate(this);" maxlength=10 class="form-control datePicker">
                                      </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="tstrstopt">
                                        ...
                                        <div class="col-sm-4"><input tabindex="76" type="text" id="elem_visc_od_other" name="elem_visc_od_other" value="<?php echo $elem_visc_od_other ; ?>" onFocus="if(this.value=='Other')this.value='';" class="form-control"></div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="tstrstopt">
                                        ...
                                        <div class="col-sm-4"><input tabindex="77" type="text" id="elem_opts_od_other" class="form-control" name="elem_opts_od_other" value="<?php echo $elem_opts_od_other;?>" onfocus="if(this.value=='Other')this.value='';"></div>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                                ...
                                <textarea tabindex="78" class="form-control" name="notesAssesmentPlansOD" id="notesAssesmentPlansOD" rows="3" onClick="return makeEmpty(this)"><?php if($notesAssesmentPlansOD!='') echo $notesAssesmentPlansOD; else echo "Notes..."; ?></textarea>
                                
                                <div class="row" id="lriODTr" <?php if($lriOD!=1){ echo "style=\"display:none;\"";  }?>>
                                    <div class="col-sm-1 text-right">Cuts:</div>
                                    <div class="col-sm-2">
                                        <select tabindex="79" name="cutsOD" id="cutsOD" class="form-control minimal" onChange="return showCutsChk('cutsValueODTr', 'cutsOD');">
                                            <option value=""></option>
                                    ...
                                    <div class="col-sm-2"><input tabindex="80" type="text" class="form-control" name="lengthCutsOD" value="<?php echo $lengthOD;?>"></div>
                                    <div class="col-sm-2">
                                        <select tabindex="81" name="lengthSelectOD" id="lengthSelectOD" class="form-control minimal">
                                    ...
                                    <div class="col-sm-1"><input tabindex="82" type="text" name="axisOD" class="form-control" value="<?php echo $axisOD; ?>"></div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 mt5">
                                    	<select tabindex="83" class="form-control minimal" name="physicianSelected" id="physicianSelected">
                                            <option value=""></option>
                                            <?php $tmp = $signedById;
                        ...
                        <div class="testsctbx">
                            <div class="tstthead">
                                <div class="row">
                                    <div class="col-sm-12 tstflt text-right form-inline">
                                        ...
                                        <div class="form-group">
                                            <label for="">Performed By:</label>
                                            <select tabindex="121" class="form-control minimal <?php if($rowsCount>0 && $performedIolOS==$performedIolOSC){echo "backgroundLightGray";}?>" id="performedByOS" name="performedByOS" onChange="return getFormulaValues('performedByPhyOS', 'OS', '<? echo $patient_id; ?>', '<?php echo $form_id; ?>');">
                                                <option value=""></option>
                                                <?php foreach($phyArray as $phyId => $phyName){?>
                            ...
                            <div class="testsctbxpd performedBy">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="122" class="form-control minimal <?php if($rowsCount>0 && ($powerIolOS==$powerIolOSC||$powerIolOS==getFormulaHeadName($powerIolOSC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="powerIolOS" id="powerIolOS">
                                          <?php
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="123" class="form-control minimal <?php if($rowsCount>0 && ($holladayOS==$holladayOSC||$holladayOS==getFormulaHeadName($holladayOSC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="holladayOS" id="holladayOS">
                                          <?php
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="124" class="form-control minimal <?php if($rowsCount>0 && ($srk_tOS==$srk_tOSC||$srk_tOS==getFormulaHeadName($srk_tOSC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="srk_tOS" id="srk_tOS">
                                          <?php
                                    ...
                                    <div class="col-sm-2">
                                        <select tabindex="125" class="form-control minimal <?php if($rowsCount>0 && ($hofferOS==$hofferOSC||$hofferOS = getFormulaHeadName($hofferOSC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="hofferOS" id="hofferOS">
                                          <?php
                                ...
                                <div class="row" id="iolOS1">
                                	<!--OS1-->
                                    <div class="col-sm-2">
                                        <select tabindex="126" class="form-control minimal <?php if($rowsCount>0 && (($iol1OS==$iol1OSC) || ($providerLensesArrOS[0]==$iol1OSC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="iol1OS" id="iol1OS" onChange="return listLenses1('1', 'iol1OS');"><option value=""></option>
                                          <?php
                                          foreach($lensesArray as $k=>$v){
                                              $sel_lensesArray = '';
                                    ...
                                    <div class="col-sm-2"><input tabindex="127" type="text" class="form-control <?php if($rowsCount>0 && $iol1PowerOS==$iol1PowerOSC){echo "backgroundLightGray";}?>" name="iol1PowerOS" id="iol1PowerOS" value="<?php echo $iol1PowerOS; ?>" onKeyDown="return checkIolVal('iol1OS');"></div>
                                    <div class="col-sm-2"><input tabindex="128" type="text" class="form-control <?php if($rowsCount>0 && $iol1HolladayOS==$iol1HolladayOSC){echo "backgroundLightGray";}?>" name="iol1HolladayOS" id="iol1HolladayOS" value="<?php echo $iol1HolladayOS; ?>" onKeyDown="return checkIolVal('iol1OS');"></div>
                                    <div class="col-sm-2"><input tabindex="129" type="text" class="form-control <?php if($rowsCount>0 && $iol1srk_tOS==$iol1srk_tOSC){echo "backgroundLightGray";}?>" name="iol1srk_tOS" id="iol1srk_tOS" value="<?php echo $iol1srk_tOS; ?>" onKeyDown="return checkIolVal('iol1OS');"></div>
                                    <div class="col-sm-2"><input tabindex="130" type="text" class="form-control <?php if($rowsCount>0 && $iol1HofferOS==$iol1HofferOSC){echo "backgroundLightGray";}?>" name="iol1HofferOS" id="iol1HofferOS" value="<?php echo $iol1HofferOS; ?>" onKeyDown="return checkIolVal('iol1OS');"></div>
                                	<!--OS1-->
                                </div>
                                <div class="row" id="iolOS2">
                                    <!--OS2-->
                                    <div class="col-sm-2">
                                        <select tabindex="131" class="form-control minimal <?php if($rowsCount>0 && (($iol2OS==$iol2OSC) || ($providerLensesArrOS[1]==$iol2OSC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="iol2OS" id="iol2OS" onChange="return listLenses1('2', 'iol2OS');"><option value=""></option>
                                          <?php
                                          foreach($lensesArray as $k=>$v){
                                              $sel_lensesArray = '';
                                    ...
                                    <div class="col-sm-2"><input tabindex="132" type="text" class="form-control <?php if($rowsCount>0 && $iol2PowerOS==$iol2PowerOSC){echo "backgroundLightGray";}?>" name="iol2PowerOS" id="iol2PowerOS" value="<?php echo $iol2PowerOS; ?>" onKeyDown="return checkIolVal('iol2OS');"></div>
                                    <div class="col-sm-2"><input tabindex="133" type="text" class="form-control <?php if($rowsCount>0 && $iol2HolladayOS==$iol2HolladayOSC){echo "backgroundLightGray";}?>" name="iol2HolladayOS" id="iol2HolladayOS" value="<?php echo $iol2HolladayOS; ?>" onKeyDown="return checkIolVal('iol2OS');"></div>
                                    <div class="col-sm-2"><input tabindex="134" type="text" class="form-control <?php if($rowsCount>0 && $iol2srk_tOS==$iol2srk_tOSC){echo "backgroundLightGray";}?>" name="iol2srk_tOS" id="iol2srk_tOS" value="<?php echo $iol2srk_tOS; ?>" onKeyDown="return checkIolVal('iol2OS');"></div>
                                    <div class="col-sm-2"><input tabindex="135" type="text" class="form-control <?php if($rowsCount>0 && $iol2HofferOS==$iol2HofferOSC){echo "backgroundLightGray";}?>" name="iol2HofferOS" id="iol2HofferOS" value="<?php echo $iol2HofferOS; ?>" onKeyDown="return checkIolVal('iol2OS');"></div>
                                    <!--OS2-->
    							</div>
                                <div class="row" id="iolOS3">
                                    <!--OS3-->
                                    <div class="col-sm-2">
                                        <select tabindex="136" class="form-control minimal <?php if($rowsCount>0 && (($iol3OS==$iol3OSC) || ($providerLensesArrOS[2]==$iol3OSC))){echo "backgroundLightGray";}?>" name="iol3OS" id="iol3OS" onChange="return listLenses1('3', 'iol3OS');"><option value=""></option>
                                          <?php
                                          foreach($lensesArray as $k=>$v){
                                              $sel_lensesArray = '';
                                    ...
                                    <div class="col-sm-2"><input tabindex="137" type="text" class="form-control <?php if($rowsCount>0 && $iol3PowerOS==$iol3PowerOSC){echo "backgroundLightGray";}?>" name="iol3PowerOS" id="iol3PowerOS" value="<?php echo $iol3PowerOS; ?>" onKeyDown="return checkIolVal('iol3OS');"></div>
                                    <div class="col-sm-2"><input tabindex="138" type="text" class="form-control <?php if($rowsCount>0 && $iol3HolladayOS==$iol3HolladayOSC){echo "backgroundLightGray";}?>" name="iol3HolladayOS" id="iol3HolladayOS" value="<?php echo $iol3HolladayOS; ?>" onKeyDown="return checkIolVal('iol3OS');"></div>
                                    <div class="col-sm-2"><input tabindex="139" type="text" class="form-control <?php if($rowsCount>0 && $iol3srk_tOS==$iol3srk_tOSC){echo "backgroundLightGray";}?>" name="iol3srk_tOS" id="iol3srk_tOS" value="<?php echo $iol3srk_tOS; ?>" onKeyDown="return checkIolVal('iol3OS');"></div>
                                    <div class="col-sm-2"><input tabindex="140" type="text" class="form-control <?php if($rowsCount>0 && $iol3HofferOS==$iol3HofferOSC){echo "backgroundLightGray";}?>" name="iol3HofferOS" id="iol3HofferOS" value="<?php echo $iol3HofferOS; ?>" onKeyDown="return checkIolVal('iol3OS');"></div>
                                    <!--OS3-->
        						</div>
                                <div class="row" id="iolOS4">
                                    <!--OS4-->
                                    <div class="col-sm-2">
                                        <select tabindex="141" class="form-control minimal <?php if($rowsCount>0 && (($iol4OS==$iol4OSC) || ($providerLensesArrOS[3]==$iol4OSC))){echo "backgroundLightGray";}else{echo $classText;}?>" name="iol4OS" id="iol4OS" onChange="return listLenses1('4', 'iol4OS');"><option value=""></option>
                                          <?php
                                          foreach($lensesArray as $k=>$v){
                                              $sel_lensesArray = '';
                                    ...
                                    <div class="col-sm-2"><input tabindex="142" type="text" class="form-control <?php if($rowsCount>0 && $iol4PowerOS==$iol4PowerOSC){echo "backgroundLightGray";}?>" name="iol4PowerOS" id="iol4PowerOS" value="<?php echo $iol4PowerOS; ?>" onKeyDown="return checkIolVal('iol4OS');"></div>
                                    <div class="col-sm-2"><input tabindex="143" type="text" class="form-control <?php if($rowsCount>0 && $iol4HolladayOS==$iol4HolladayOSC){echo "backgroundLightGray";}?>" name="iol4HolladayOS" id="iol4HolladayOS" value="<?php echo $iol4HolladayOS; ?>" onKeyDown="return checkIolVal('iol4OS');"></div>
                                    <div class="col-sm-2"><input tabindex="144" type="text" class="form-control <?php if($rowsCount>0 && $iol4srk_tOS==$iol4srk_tOSC){echo "backgroundLightGray";}?>" name="iol4srk_tOS"  id="iol4srk_tOS" value="<?php echo $iol4srk_tOS; ?>" onKeyDown="return checkIolVal('iol4OS');"></div>
                                    <div class="col-sm-2"><input tabindex="145" type="text" class="form-control <?php if($rowsCount>0 && $iol4HofferOS==$iol4HofferOSC){echo "backgroundLightGray";}?>" name="iol4HofferOS" id="iol4HofferOS" value="<?php echo $iol4HofferOS; ?>" onKeyDown="return checkIolVal('iol4OS');"></div>
                                    <!--OS4-->
                            	</div>
	                            <div class="clearfix"></div>
                                ...
                                <div class="performedBy">
                                    <div class="row">
                                        <div class="col-sm-2"><label>Cell Count</label> <input tabindex="146" type="text" class="form-control <?php if($rowsCount>0 && $cellCountOS==$cellCountOSC){echo "backgroundLightGray";}?>" name="cellCountOS" id="cellCountOS" value="<?php echo $cellCountOS; ?>"></div>
                                        <div class="col-sm-2">
                                            <label>Pachymetry</label> 
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input tabindex="147" type="text" class="form-control <?php if($rowsCount>0 && $pachymetryValOS==$pachymetryValOSC){echo "backgroundLightGray";}?>" name="pachymetryValOS" id="pachymetryValOS" value="<?php echo $pachymetryValOS; ?>" onChange="calCorrectionVal(this.value,'OS');"></div>
                                                <div class="col-sm-6">
                                                    <input tabindex="148" type="text" class="form-control <?php if($rowsCount>0 && $pachymetryCorrecOS==$pachymetryCorrecOSC){echo "backgroundLightGray";}?>" name="pachymetryCorrecOS" id="pachymetryCorrecOS" value="<?php echo $pachymetryCorrecOS; ?>"></div>
                                            </div>
                                        </div>
                                        <div class="col-sm-2"><label>Corneal Diam</label> <input tabindex="149" type="text" class="form-control <?php if($rowsCount>0 && $cornealDiamOS==$cornealDiamOSC){echo "backgroundLightGray";}?>" name="cornealDiamOS" id="cornealDiamOS" value="<?php echo $cornealDiamOS; ?>"></div>
                                        <div class="col-sm-2"><label>Dominant Eye</label> <input tabindex="150" type="text" class="form-control <?php if($rowsCount>0 && $dominantEyeOS==$dominantEyeOSC){echo "backgroundLightGray";}?>" name="dominantEyeOS" id="dominantEyeOS" value="<?php echo $dominantEyeOS; ?>"></div>
                                        <div class="col-sm-2"><label>ACD Eye</label> <input tabindex="151" type="text" class="form-control <?php if($rowsCount>0 && $acdOS==$acdOSC){echo "backgroundLightGray";}?>" name="acdOS" id="acdOS" value="<?php echo $acdOS; ?>"></div>
                                        <div class="col-sm-2"><label>White to White</label> <input tabindex="152" type="text" class="form-control <?php if($rowsCount && $w2wOS==$w2wOSC){echo "backgroundLightGray";}?>" name="w2wOS" id="w2wOS" value="<?php echo $w2wOS; ?>"></div>
                                        <div class="col-sm-4">
                                            <label>Pupil Size</label>
                                            <div class="row">
                                                <div class="col-sm-6"><input tabindex="153" type="text" class="form-control <?php if($rowsCount>0 && $pupilSize1OS==$pupilSize1OSC){echo "backgroundLightGray";} ?>" name="pupilSize1OS" id="pupilSize1OS" value="<?php echo $pupilSize1OS; ?>"><small>Un-Dilated</small></div>
                                                <div class="col-sm-1">/</div>
                                                <div class="col-sm-5"><input tabindex="154" type="text" class="form-control <?php if($rowsCount>0 && $pupilSize2OS==$pupilSize2OSC){echo "backgroundLightGray";}?>" name="pupilSize2OS" id="pupilSize2OS" value="<?php echo $pupilSize2OS; ?>"><small>Dilated</small></div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="col-sm-12"><label>Notes</label> <textarea tabindex="155" rows="3" name="notesOS" id="notesOS" class="form-control" onClick="return makeEmpty(this)" placeholder="Notes..."><?php echo $notesOS;?></textarea></div>
                                    </div>
                                </div>
                            	<div class="clearfix"></div>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="form-inline">
                                    <div class="form-group" style="width:38%;">
                                        <select tabindex="156" style="width:90%;" class="form-control minimal" name="selecedIOLsOS" id="selecedIOLsOS" onChange="return doSelectOS(this)">
                                            <option value=""></option>
                                    ...
                                    <div class="form-group">
                                        <label for="">Date of Surgery</label>
                                        <input tabindex="157" id="sur_dateOS" type="text"  name="sur_dateOS" value="<?php echo $sur_dateOS;?>"  onBlur="checkdate(this);" maxlength=10 class="form-control datePicker">
                                    </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="tstrstopt">
                                        ...
                                        <div class="col-sm-4"><input tabindex="158" type="text" id="elem_visc_os_other" name="elem_visc_os_other" value="<?php echo $elem_visc_os_other ; ?>" onFocus="if(this.value=='Other')this.value='';" class="form-control"></div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="tstrstopt">
                                       ...
                                       <?php if(empty($elem_opts_os_other)){$elem_opts_os_other = "Other";}
                                        ...
                                        <div class="col-sm-4"><input tabindex="159" type="text" id="elem_opts_os_other" class="form-control" name="elem_opts_os_other" value="<?php echo $elem_opts_os_other;?>" onfocus="if(this.value=='Other')this.value='';"></div>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                                ...
                                <textarea tabindex="160" class="form-control" name="notesAssesmentPlansOS" id="notesAssesmentPlansOS" rows="3" onClick="return makeEmpty(this)"><?php if($notesAssesmentPlansOS!='') echo $notesAssesmentPlansOS; else echo "Notes..."; ?></textarea>
                                
                                <div class="row" id="lriOSTr" <?php if($lriOS!=1){ echo "style=\"display:none;\"";  }?>>
                                    <div class="col-sm-1 text-right">Cuts:</div>
                                    <div class="col-sm-2">
                                        <select tabindex="161" name="cutsOS" id="cutsOS" class="form-control minimal" onChange="return showCutsChk('cutsValueOSTr', 'cutsOS');">
                                            <option value=""></option>
                                    ...
                                    <div class="col-sm-1 text-right">Length:</div>
                                    <div class="col-sm-2"><input tabindex="162" type="text" class="form-control" name="lengthCutsOS" id="lengthCutsOS" value="<?php echo $lengthOS; ?>"></div>
                                    <div class="col-sm-2">
                                        <select tabindex="163" name="lengthOSSelect" id="lengthOSSelect" class="form-control minimal">
                                    ...
                                    <div class="col-sm-1 text-right">Axis:</div>
                                    <div class="col-sm-1"><input tabindex="164" type="text" name="axisOS" id="axisOS" class="form-control" value="<?php echo $axisOS; ?>"></div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 mt5">
                                    	<select tabindex="165" class="form-control minimal" name="physicianSelectedOS" id="physicianSelectedOS">
                                            <option value=""></option>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 supperbill">
                        ...
                        <!-- Superbill -->
                        <div class="clearfix"></div>
                        <?php echo $objTests->get_zeiss_forum_button('IOL-MASTER',$test_edid,$patient_id);?>
                    </div>
                    <?php }?>
            ...
            <?php 
                            $testprint_name = "IOL_Master";
                            $testprint_id = $iol_master_id;
...
$(document).ready(function(e) {
	...
	$("#powerIolOD, #holladayOD, #srk_tOD, #hofferOD, #powerIolOS, #holladayOS, #srk_tOS, #hofferOS").bind("change", function(){ if(this.value==""){
			var n = this.id; var m = n+"_more";  if($("#"+m).length<=0){
				var h = "<div id=\""+m+"\" class=\"form-group has-feedback hidden\">"+
						"<input type=\"text\" class=\"form-control\" id=\""+n+"_other\" name=\""+n+"_other\">"+
						"<span class=\"glyphicon glyphicon-remove form-control-feedback\"></span>"+
						"</div>";
				$(this).parent().append(h); 
				$(".form-control-feedback").bind("click", function(){ $(this).parent().find("input").val(""); $(this).parent().addClass("hidden"); $(this).parent().parent().find("select").removeClass("hidden");  });	
				}
			$(this).addClass("hidden"); $("#"+m+"").removeClass("hidden");  
			}  });	
});
<?php if($callFromInterface != 'admin'){?>
