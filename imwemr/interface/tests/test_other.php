...
if($callFromInterface != 'admin'){
	...
	$html_file_name = $test_name.'/'.$date_f.'/other_test_print_'. $_SESSION['patient']."_".$_SESSION['authId']."_".$rand;
	...
	//Super bill init() --
	$superLen = "1";
	$sb_testName = 'TestOther';
	
	//Cpt Code Desc
	$thisCptDescSym = "TestOther";
...
<?php if($callFromInterface != 'admin'){?>
	...
	function getPrevTestDt(ctid,cdt,ctm,dir){
		getPrevTestDtExe(ctid,cdt,ctm,dir,"OTHER");
	}
		...
		if((f.elem_testOtherName.value == "") || (f.elem_testOtherName.value == "Test Name"))
		{
			m += "&bull; Test Name<br>";
			err = true;
		}
...
<?php if($callFromInterface != 'admin'){?>
    <input type="hidden" name="elem_saveForm" id="elem_saveForm" value="TestOther">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $arrDigOpts = $objTests->getDiagOpts('1','other',$test_master_id);
