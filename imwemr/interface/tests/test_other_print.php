...
<?php
/*
File: test_other_print.php
Purpose: This file provides print version of Other Test.
	...
	$testCSS = '
		...
		<page_header>
			<table border="0" cellpadding="0" cellspacing="0">				
					<tr>
						<td colspan="3" align="center" style="width:1080px" class="text_b"><b>'.$this_test_screen_name.' TEST'.$finalize.'</b>
						</td>
					</tr>
					<tr>
                ...
                <tr>
                    <td class="alignLeft valignTop" style="border:1px solid #000000;" >
                         <table cellpadding="0" cellspacing="0" style="width:100%;" >
                                        ...
                                        <tr >
                                          <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><span class="txt_11b"><strong>Interpretation</strong></span>&nbsp;:&nbsp;</td>
                                          <td><div style="width:400px"><?php echo $elem_inter_pret_od; ?></div></td>
                                        </tr>
                                    </table>
            </td>
                    <td class="alignLeft valignTop" style="border:1px solid #000000;"><table cellpadding="0" cellspacing="0" style="width:100%;" >
                      <tr >
                        ...
                        <td><div style="width:440px"><?php echo $elem_descOs; ?></div></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;"></td>
                        <td><div style="width:440px"><?php echo $elem_inter_pret_os; ?></div></td>
                      </tr>
                    </table></td>
                </tr>
            </table>
