...
if($callFromInterface != 'admin'){
	...
	$html_file_name = $test_name.'/'.$date_f.'/ivfa_test_print_'. $_SESSION['patient']."_".$_SESSION['authId']."_".$rand;
	...
	$rand=rand(0,500);
	$test_name="chart_tests";
	$html_file_name = $test_name.'/'.$date_f.'/ivfa_test_print_'.$_SESSION['authId']."_".$rand;
	...
	//Previous Test --
	$oChartTestPrev = new ChartTestPrev($patient_id,"IVFA");
	...
	if($row != false){
		...
		$elem_examDate= ($ivfa_mode != "new") ? get_date_format($row["exam_date"]) : $elem_examDate;
		$elem_examTime = ($ivfa_mode != "new") ? $row["examTime"] : $elem_examTime ;
		$elem_ivfa=$row["ivfa"];
		$elem_ivfa_od=$row["ivfa_od"];
		$elem_ivfa_early=$row["ivfa_early"];
		$elem_ivfa_extra=$row["ivfa_extra"];
		$elem_comments_ivfa=stripslashes($row["comments_ivfa"]);
		$elem_performedBy= ($ivfa_mode != "new") ? $row["performed_by"] : "" ;
		...
		$elem_ivfa_signature=$row["ivfa_signature"];
		$elem_physician= ( $ivfa_mode == "update" ) ? $row["phy"] : "" ;
		...
		$ivfaComments=stripslashes($row["ivfaComments"]);
	...
	$tstPrevId = $oChartTestPrev->getPrevId($tmp,$ivfa_pkid);//getPervId
	$tstNxtId = $oChartTestPrev->getNxtId($tmp,$ivfa_pkid);//getNextId
}
...
<?php if($callFromInterface != 'admin'){?>
	...
	function getPrevTestDt(ctid,cdt,ctm,dir){
		getPrevTestDtExe(ctid,cdt,ctm,dir,"IVFA");
	}
	...
	function saveIvfa(){
		...
		var err = false;
		/*
		if((f.elem_ivfa_signature.value == "0-0-0:;") || (f.elem_ivfa_signature.value == "")){
			m += "  -Signature\n";
			err = true;
		}
		*/ //elem_physician
...
<?php if($callFromInterface != 'admin'){?>
    <input type="hidden" name="elem_saveForm" id="elem_saveForm" value="IVFA">
    ...
    <input type="hidden" id="elem_edMode" name="hd_ivfa_mode" value="<?php echo $ivfa_mode;?>">
    <input type="hidden" id="elem_testId" name="elem_ivfaId" value="<?php echo $test_edid;?>">
        ...
        <div class="row">
                ...
                <div class="tstopt">
                    <div class="row">
                        <div class="col-sm-6 sitetab tstrstopt">
                            <ul>
                                <li><label><input type="checkbox" name="elem_ivfa_early" value="1" <?php echo ($elem_ivfa_early == "1") ?  "checked" : "" ;?>><span class="label_txt">Early and late shots</span></label></li>
                                <li><label><input type="checkbox" name="elem_ivfa_extra" value="1" <?php echo ($elem_ivfa_extra == "1") ?  "checked" : "" ;?>><span class="label_txt">Extra Copy</span></label></li>
                            </ul>
                        </div>
                            ...
                            <div class="tstopt">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 testopt">
                                        <ul>
                                            <li class="ouc"><label><input type="radio" name="elem_ivfa_od" value="1" onClick="setReli_Test('OU')" <?php echo (!$elem_ivfa_od || $elem_ivfa_od == "1") ?  "checked" : "" ;?>><span class="label_txt">OU</span></label></li>
                                            <li class="odc"><label><input type="radio" name="elem_ivfa_od" value="2" onClick="setReli_Test('OD')" <?php echo ($elem_ivfa_od == "2") ?  "checked" : "" ;?>><span class="label_txt"><span>OD</span><strong>&gt;</strong><span>OS</span></span></label></li>
                                        	<li class="osc"><label><input type="radio" name="elem_ivfa_od" value="3" onClick="setReli_Test('OS')" <?php echo ($elem_ivfa_od == "3") ?  "checked" : "" ;?>><span class="label_txt"><span>OS</span><strong>&gt;</strong><span>OD</span></span></label></li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        <?php
                                            ...
                                            if($callFromInterface != 'admin' && constant("ZEISS_FORUM") == "YES"){
                                                $procedure_opts = $objTests->zeissProcOpts(8);
                                            ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group pdlft10">
                                <textarea class="form-control" rows="2" style="width:100%; height:55px !important;" name="elem_comments_ivfa" id="techComment" placeholder="Technician Comments"><?php echo $elem_comments_ivfa;?></textarea>
                            </div>
                        </div>	
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="pd5 tstbx">
                                <div class="row tstrstopt">
                                    <div class="col-sm-4"><label><input type="checkbox" id="Sharp_Pink_OD" name="Sharp_Pink_OD" <?php if($Sharp_Pink_OD==1) echo 'CHECKED'; ?> value="1"><span class="label_txt">Sharp &amp; Pink</span></label></div>
                                    ...
                                    <div class="col-sm-2"><label><input type="checkbox" id="Sloping_OD" name="Sloping_OD" <?php if($Sloping_OD==1) echo 'CHECKED'; ?> value="1"><span class="label_txt">Sloping</span></label></div>
                                    <div class="cleafix"></div>
                                    <div class="col-sm-4"><label><input type="checkbox" id="Notch_OD" name="Notch_OD" <?php if($Notch_OD==1) echo 'CHECKED'; ?> value="1"><span class="label_txt">Notch</span></label></div>
                            ...
                            <td class="pd5 tstbx">
                                <div class="row tstrstopt">
                                    <div class="col-sm-4"><label><input type="checkbox" id="Sharp_Pink_OS" name="Sharp_Pink_OS" <?php if($Sharp_Pink_OS==1) echo 'CHECKED'; ?> value="1"><span class="label_txt">Sharp &amp; Pink</span></label></div>
                                    ...
                                    <div class="col-sm-2"><label><input type="checkbox" id="Sloping_OS" name="Sloping_OS" <?php if($Sloping_OS==1) echo 'CHECKED'; ?> value="1"><span class="label_txt">Sloping</span></label></div>
                                    <div class="cleafix"></div>
                                    <div class="col-sm-4"><label><input type="checkbox" id="Notch_OS" name="Notch_OS" <?php if($Notch_OS==1) echo 'CHECKED'; ?> value="1"><span class="label_txt">Notch</span></label></div>
                        ...
                        <div class="col-sm-12">
                            <div class="whitebox">
                                ...
                                <div>
                                    <h2>Comments</h2>
                                    <div class="clearfix"></div>
                                    <textarea cols="23" rows="2"  id="ivfaComments" name="ivfaComments" class="form-control" style="width:100%; height:50px;"><?php echo $ivfaComments; ?></textarea>
                                </div>
                                <div class="clearfix"></div>
                                
                                <?php if($callFromInterface != 'admin'){
									$sigFolderName = 'test_ivfa';
                            ...
                            <div class="col-sm-12 supperbill">
                                ...
                                <!-- Superbill -->
                                <div class="clearfix"></div>
                				<?php echo $objTests->get_zeiss_forum_button('IVFA',$test_edid,$patient_id);?>
                            </div>
                        	<?php }?>
                        </div>
                    </div>
            ...
            <?php if($callFromInterface != 'admin' && $doNotShowRightSide != 'yes'){
				...
				<?php if(($elem_per_vo != "1" && $doNotShowRightSide == 'yes') || $_REQUEST['pop']==1){?>
						...
						<?php }else{?>
							<input type="button" class="btn btn-success<?php echo $btnHide;?>" id="btn_done" value="Done"  onClick="saveIvfa()" />
						<?php }?>
						<?php }?>
						...
						<?php if($elem_per_vo != "1"){ ?>
							...
							<input type="button"  class="btn btn-success<?php echo $btnHide;?>" value="Order" id="save" onClick="saveIvfa()" />
...
<?php if($callFromInterface != 'admin'){?>
	...
	<?php if(($elem_ivfa_od == "2") || ($elem_ivfa_od == "3")){$tmp = (($elem_ivfa_od == "3")) ? "OS" : "OD";echo "setReli_Test(\"".$tmp."\");";}?>
<?php }?>
</script>
<?php
if($callFromInterface != 'admin'){
