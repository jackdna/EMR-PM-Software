...
<?php
/*
File: test_gdx_print.php
Purpose: This is print version of GDX test.
	...
	$testCSS = '
		...
		<page_header>
			<table border="0" cellpadding="0" cellspacing="0">				
					<tr>
						<td colspan="3" align="center" class="text_b"><b>GDX TEST'.$finalize.'</b>
						</td>
					</tr>
					<tr>
        ...
        <td colspan="2" class="txt_11b alignLeft">
            ...
            <table style="width:100%" >
                <tr style="height:20px">
                    <td style="width:55%" ><strong>GDX</strong>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <td style="height:20px;" colspan="2" class="txt_11b alignLeft">
            <table cellpadding="0" cellspacing="0" >
                <tr>
                    ...
                    <td style="width:10px;" rowspan="2" class="drak_purple_color alignCenter alignMiddle">BL</td>
                    ...
                    <td class="alignLeft valignTop" style="border:1px solid #000000;" >
                         ...
                         <table cellpadding="0" cellspacing="0" style="width:100%;" >
                                        <tr >
                                            ...
                                            <td colspan="5" class="valignTop alignLeft">
					    <?php if(strpos($normal_OD, "Normal")!==false) echo $yes; else echo $no; ?> &nbsp;&nbsp;
					    <strong>Poor Study</strong><?php echo (strpos($normal_OD, "Poor Study")!==false) ? $yes : $no; ?>
				    </td>
                                        </tr>
					
                                        <tr >
                                          <td class="valignTop alignLeft" style="width:110px;" ><strong>Nerve Fiber Thickness Map</strong></td>
                                          <td colspan="5">
					Normal Appearing Nerve Fiber Layer <?php if(strpos($nf_Thick_OD, "Normal Appearing Nerve Fiber Layer")!==false) echo $yes; else echo $no; ?><br/>
					Suspicious Nerve Fiber Layer Thinning <?php if(strpos($nf_Thick_OD, "Suspicious Nerve Fiber Layer Thinning")!==false) echo $yes; else echo $no; ?><br/>
					Definite Nerve Fiber Layer Thinning <?php if(strpos($nf_Thick_OD, "Definite Nerve Fiber Layer Thinning")!==false) echo $yes; else echo $no; ?>  
				  </td>	  
                                        </tr>
					
                                        <tr>
                                        <td class="txt_11b valignTop" ><strong>Quadrant Deviation Map Outside Normal</strong></td>
				<td colspan="5">
					Superior Quardrant <?php if(strpos($quad_devi_OD, "Superior Quardrant")!==false) echo $yes; else echo $no; ?> <br/>
					Nasal Quadrant <?php if(strpos($quad_devi_OD, "Nasal Quadrant")!==false) echo $yes; else echo $no; ?> <br/>
					Temporal Quadrant <?php if(strpos($quad_devi_OD, "Temporal Quadrant")!==false) echo $yes; else echo $no; ?><br/>
					Inferior Quadrant <?php if(strpos($quad_devi_OD, "Inferior Quadrant")!==false) echo $yes; else echo $no; ?>
				</td>
                                        </tr>
				<tr>	
				 <td class="txt_11b valignTop" ><strong>Nerve Fiber Indicator</strong></td>
				<td colspan="5">
					0-30 Normal (Low risk of Glaucoma) <?php if(strpos($nf_Indic_OD, "0-30 Normal (Low risk of Glaucoma)")!==false) echo $yes; else echo $no; ?><br/>
					31-50 Borderline <?php if(strpos($nf_Indic_OD, "31-50 Borderline")!==false) echo $yes; else echo $no; ?><br/>
					51+ (Abnormal risk of Glaucoma) <?php if(strpos($nf_Indic_OD, "51+ (Abnormal risk of Glaucoma)")!==false) echo $yes; else echo $no; ?>
				</td>
                                        </tr>	                                        
                                        <tr>
                    ...
                    <td class="alignLeft valignTop" style="border:1px solid #000000;">
                        ...
                        <table cellpadding="0" cellspacing="0"  >
                            <tr>
                                <td colspan="5" class="valignTop alignLeft" style="height:<?php echo $trHeight;?>px;">
				<?php if(strpos($normal_OS, "Normal")!==false) echo $yes; else echo $no; ?> &nbsp;&nbsp;
				<strong>Poor Study</strong><?php echo (strpos($normal_OS, "Poor Study")!==false) ? $yes : $no; ?>
			  </td>
                            </tr>
                            <tr>
                                <td colspan="5">
				Normal Appearing Nerve Fiber Layer <?php if(strpos($nf_Thick_OS, "Normal Appearing Nerve Fiber Layer")!==false) echo $yes; else echo $no; ?><br/>
				Suspicious Nerve Fiber Layer Thinning <?php if(strpos($nf_Thick_OS, "Suspicious Nerve Fiber Layer Thinning")!==false) echo $yes; else echo $no; ?><br/>
				Definite Nerve Fiber Layer Thinning <?php if(strpos($nf_Thick_OS, "Definite Nerve Fiber Layer Thinning")!==false) echo $yes; else echo $no; ?>
			  </td>
                            </tr>
                            <tr>
                                <td colspan="5">
				Superior Quardrant <?php if(strpos($quad_devi_OS, "Superior Quardrant")!==false) echo $yes; else echo $no; ?><br/>
				Nasal Quadrant <?php if(strpos($quad_devi_OS, "Nasal Quadrant")!==false) echo $yes; else echo $no; ?><br/>
				Temporal Quadrant  <?php if(strpos($quad_devi_OS, "Temporal Quadrant")!==false) echo $yes; else echo $no; ?> <br/>
				Inferior Quadrant <?php if(strpos($quad_devi_OS, "Inferior Quadrant")!==false) echo $yes; else echo $no;?>	
			  </td>
                            </tr>
		         <tr>
                                <td colspan="5">
				0-30 Normal (Low risk of Glaucoma) <?php if(strpos($nf_Indic_OS, "0-30 Normal (Low risk of Glaucoma)")!==false) echo $yes; else echo $no; ?><br/>
				31-50 Borderline <?php if(strpos($nf_Indic_OS, "31-50 Borderline")!==false) echo $yes; else echo $no; ?><br/>
				51+ (Abnormal risk of Glaucoma) <?php if(strpos($nf_Indic_OS, "51+ (Abnormal risk of Glaucoma)")!==false) echo $yes; else echo $no; ?>
			  </td>
                            </tr>
                            <tr>
        ...
        <td colspan="2">
            ...
            <table class="table_collapse" >
                <tr>
                    ...
                    <td class="alignLeft nowrap" ><strong>Informed Pt result next visit</strong><?php echo ($elem_informedPtNv == "1") ? $yes : $no;?> </td>
                </tr>
                <tr>
                    <td style="height:<?php echo $trHeight;?>;"><strong>F/U&nbsp;APA</strong><?php echo ($elem_fuApa == "1") ? $yes : $no;?></td>
                    <td colspan="4">
			<strong>Pt&nbsp;informed&nbsp;of&nbsp;results</strong><?php echo ($elem_ptInformed == "1") ? $yes : $no;?></td>
                </tr>
           </table> 
