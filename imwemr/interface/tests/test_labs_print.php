	...
	$testCSS = '
		...
		<page_header>
			<table border="0" cellpadding="0" cellspacing="0">				
					<tr>
						<td colspan="3" align="center" style="width:1080px" class="text_b"><b>Laboratories TEST'.$finalize.'</b>
						</td>
					</tr>
					<tr>
        ...
        <td colspan="2" class="txt_11b alignLeft">
            <table style="width:100%" >
                <tr style="height:20px">
                    <td style="width:55%" >
                            <strong><?php echo $elem_testLabsName;?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td class="alignLeft valignTop" style="border:1px solid #000000;" >
                         <table cellpadding="0" cellspacing="0" style="width:100%;" >
                                        ...
                                        <tr >
                                          <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>Interpretation</strong>&nbsp;:&nbsp;</td>
                    ...
                    <td class="alignLeft valignTop" style="border:1px solid #000000;"><table cellpadding="0" cellspacing="0" style="width:100%;" >
                      <tr >
                        ...
                        <td><div style="width:430px"><?php echo $elem_descOs; ?></div></td>
                      </tr>
                      <tr >
                        <td class="valignTop" style="height:<?php echo $trHeight;?>px;"></td>
                        <td><div style="width:430px"><?php echo $elem_inter_pret_os; ?></div></td>
                      </tr>
                    </table></td>
                </tr>
            </table>
