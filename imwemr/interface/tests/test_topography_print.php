...
<?php
/*
File: test_topography_print.php
Purpose: This file provides Topography test's print version.
	...
	$testCSS = '
		...
		<page_header>
			<table border="0" cellpadding="0" cellspacing="0">				
					<tr>
						<td colspan="3" align="center" style="width:1080px" class="text_b"><b>Topography TEST'.$finalize.'</b>
						</td>
					</tr>
					<tr>
                ...
                <tr>
                    <td class="alignLeft valignTop" style="border:1px solid #000000;" >
                         <table cellpadding="0" cellspacing="0" style="width:100%;" >
                                        <tr >
                                            <td class="valignTop" style="height:<?php echo $trHeight;?>px;"><strong>Description</strong>&nbsp;:&nbsp;</td>
                                            <td><div style="width:430px"><?php echo $elem_descOd; ?></div></td>
                                        </tr>
                                    </table>
              </td>
    ...
    <tr>
        <td colspan="2">
            <table class="table_collapse" >
                <tr>
                  <td style="width:150px; height:<?php echo $trHeight;?>;"><strong>Treatment</strong></td>
                  <td colspan="2" class="alignLeft nowrap" style="width:150px; "><?php echo ($elem_treat=='Other') ? $elem_treatOther : $elem_treat; ?> </td>
                  <td class="alignLeft nowrap" style="width:150px">Tech to inform Pt.<?php echo ($elem_tech2InformPt == "1") ? $yes : $no;?></td>
                  <td class="alignLeft nowrap" style="width:150px">Pt&nbsp;informed&nbsp;of&nbsp;results<?php echo ($elem_ptInformed == "1") ? $yes : $no;?></td>
                </tr>
                <tr>
                    <td style="width:150px; height:<?php echo $trHeight;?>;"><strong>Prognosis</strong></td>
                    <td class="alignLeft nowrap" style="width:150px; ">Stable<?php if(in_array("Stable",$arrTmp)){ echo $yes; }else{ echo $no;}?></td>
                    <td class="alignLeft nowrap" style="width:150px">Progressive<?php if(in_array("Progressive",$arrTmp)){ echo $yes; }else{ echo $no;}?></td>
                    <td class="alignLeft nowrap" style="width:150px">Repeat Scan<?php if(in_array("Repeat Scan",$arrTmp)){ echo $yes; }else{ echo $no;}?></td>
                    <td class="alignLeft nowrap" style="width:150px">Informed Pt result next visit<?php echo ($elem_informedPtNv == "1") ? $yes : $no;?></td>
                </tr>
           </table> 
        </td>
    </tr>       
