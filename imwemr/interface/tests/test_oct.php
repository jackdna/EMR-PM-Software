...
if($callFromInterface != 'admin'){
	...
	$html_file_name = $test_name.'/'.$date_f.'/oct_test_print_'. $_SESSION['patient']."_".$_SESSION['authId']."_".$rand;
	...
	$rand=rand(0,500);
	$test_name="chart_tests";
	$html_file_name = $test_name.'/'.$date_f.'/oct_test_print_'.$_SESSION['authId']."_".$rand;
	...
	//Previous Test --
	$oChartTestPrev = new ChartTestPrev($patient_id,"OCT");
	...
	if($row != false){
		...
		$elem_monitor_finding = $row["mon_finding"];
		...
		$elem_foveaThick_OD = $row["fovea_thick_OD"];
		$elem_foveaThick_OS = $row["fovea_thick_OS"];
		...
		$elem_avg_nfl_Thick_OD=$row["avg_nfl_Thick_OD"];
		$elem_avg_nfl_Thick_OS=$row["avg_nfl_Thick_OS"];
		$purged=$row["purged"];
	...
	//Cpt Code Desc
	if($elem_scanLaserOct=="3"){
		$thisCptDescSym = "OCT-Anterior Segment";
	}else if($elem_scanLaserOct=="2"){
		$thisCptDescSym = "OCT-Retina";
	}else{
		$thisCptDescSym = "OCT";
	}

	$arrTestCpts = array(
			1=>array($GLOBALS['arrExamCpt']["HRT/OCT/GDX"],$objCPT->checkTest4CptDesc_v2("OCT")),
			2=>array($GLOBALS['arrExamCpt']["HRT/OCT/GDX-Retina"],$objCPT->checkTest4CptDesc_v2("OCT-Retina")),
			3=>array($GLOBALS['arrExamCpt']["HRT/OCT/GDX-Anterior Segment"],$objCPT->checkTest4CptDesc_v2("OCT-Anterior Segment")));
...
<?php if($callFromInterface != 'admin'){?>
	...
	{	
		...
		if(f_Phts == 0){
			m += "&bull; OCT (Anterior Segment/Optic Nerve/Retina)<br>";
			err = true;
		}
	...
	function getPrevTestDt(ctid,cdt,ctm,dir){
		getPrevTestDtExe(ctid,cdt,ctm,dir,"OCT");
	}
...
function setDiagOpts(){
	...
	var arr = <?php echo $objTests->getDiagOpts("JS",'oct',$test_master_id);?>;
	//Adde
	var arr2 = arr[chk-1];
	ln = arr2.length;
...
function selectOs(){
	...
	document.getElementById('elem_foveaThick_OS').value = document.getElementById('elem_foveaThick_OD').value;
	document.getElementById('elem_avg_nfl_Thick_OS').value = document.getElementById('elem_avg_nfl_Thick_OD').value;
...
function setReli_Test(wh){
	...
	var arrTestOd = new Array( "Normal_OD_T","elem_normal_poorStudy_od","BorderLineDefect_OD_T",
					 "BorderLineDefect_OD_1","BorderLineDefect_OD_2","BorderLineDefect_OD_3",
					 "BorderLineDefect_OD_4","Abnorma_OD_T","Abnorma_OD_1","Abnorma_OD_2",
					 "Abnorma_OD_3","Abnorma_OD_4","elem_noSigChange_OD","elem_improved_OD",
					 "elem_incAbn_OD","elem_targetIop_OD","Others_OD",
					 "testRes_OD_CME","testRes_OD_IRF","testRes_OD_ERM",
					 "testRes_OD_Drusen","testRes_OD_VMT","testRes_OD_SRetF",
					 "testRes_OD_SRF","testRes_OD_CNV","testRes_OD_RPEDetach",
					 "testRes_OD_RPERip");
...
<?php if($callFromInterface != 'admin'){?>
    <input type="hidden" name="elem_saveForm" id="elem_saveForm" value="OCT">
                ...
                <div class="tstopt">
                    <div class="row">
                        <div class="col-sm-6 sitetab tstrstopt">
	                        <?php
								if($elem_scanLaserOct=="1")$opNrve="checked";
								if($elem_scanLaserOct=="2")$opRetina="checked";
								if($elem_scanLaserOct=="3")$opAnt="checked";
							?>
                            <ul>
                                <li><label><input type="radio" name="elem_scanLaserOct" value="3" onClick="setDiagOpts();" <?php echo $opAnt;?>><span class="label_txt">Anterior&nbsp;Segment</span></label></li>
                                <li><label><input type="radio" name="elem_scanLaserOct" value="1" onClick="setDiagOpts();" <?php echo $opNrve;?> ><span class="label_txt">Optic&nbsp;Nerve</span></label></li>
                                <li><label><input type="radio" name="elem_scanLaserOct" value="2" onClick="setDiagOpts();" <?php echo $opRetina;?> ><span class="label_txt">Retina</span></label></li>
                                <?php if($test_edid=="0"){?>
                                <li style="margin-left:20px;"><label><input type="checkbox" onClick="loadTest('oct_rnfl');"><span class="label_txt">RNFL</span></label></li>
                            	<?php }?>
                            </ul>
                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <?php
                                            ...
                                            if($callFromInterface != 'admin' && constant("ZEISS_FORUM") == "YES"){
                                                $procedure_opts = $objTests->zeissProcOpts(9);
                                            ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control minimal" id="elem_diagnosis" name="elem_diagnosis" onChange="checkDiagnosis(this.value)" style="display:<?php echo ($elem_diagnosis == "Other") ? "none" : "block" ;?>;">
                                            ...
                                            <?php
                                            $arrDigOpts = $objTests->getDiagOpts($elem_scanLaserOct,'oct',$test_master_id); //getDiagOpts($elem_scanLaserOct);
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <ul>
                                    ...
                                    <li>
                                    <div class="tstrstopt">
	                                    <label><input type="radio" name="elem_ptUndersatnding" value="Good" <?php echo (!$elem_ptUndersatnding || $elem_ptUndersatnding == "Good") ? "checked" : "";?>><span class="label_txt">Good</span></label>
    	                                <label><input type="radio" name="elem_ptUndersatnding" value="Fair" <?php echo ($elem_ptUndersatnding == "Fair") ? "checked" : "";?>><span class="label_txt">Fair</span></label>
        	                            <label><input type="radio" name="elem_ptUndersatnding" value="Poor" <?php echo ($elem_ptUndersatnding == "Poor") ? "checked" : "";?>><span class="label_txt">Poor</span></label>
                                    </div>
                                    </li>  
                                </ul>
                            </div>
                ...
                <div>
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td rowspan="8" align="center" valign="middle" class="bltra"><a href="javascript:selectOs();">BL</a></td>
                            <td class="osstrip">
                                <div class="row">
                        ...
                        <tr>
                          ...
                          <td class="tstrstopt">
                            ...
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OD_CME" name="testRes_OD_CME" <?php if(in_array("CME",$testRes_OD)) echo 'CHECKED'; ?> value="CME"><span class="label_txt">CME</span></label></div>
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OD_IRF" name="testRes_OD_IRF" <?php if(in_array("Intra Retinal Fluid",$testRes_OD)) echo 'CHECKED'; ?> value="Intra Retinal Fluid"><span class="label_txt">Intra Retinal Fluid</span></label></div>
                                <div class="col-sm-2"><label><input type="checkbox" id="testRes_OD_ERM" name="testRes_OD_ERM" <?php if(in_array("ERM",$testRes_OD)) echo 'CHECKED'; ?> value="ERM"><span class="label_txt">ERM</span></label></div>                              
                            </div>
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OD_Drusen" name="testRes_OD_Drusen" <?php if(in_array("Drusen",$testRes_OD)) echo 'CHECKED'; ?> value="Drusen"><span class="label_txt">Drusen</span></label></div>
                                <div class="col-sm-7"><label><input type="checkbox" id="testRes_OD_VMT" name="testRes_OD_VMT" <?php if(in_array("Vitreous Macula Traction",$testRes_OD)) echo 'CHECKED'; ?> value="Vitreous Macula Traction"><span class="label_txt">Vitreous Macula Traction</span></label></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OD_SRetF" name="testRes_OD_SRetF" <?php if(in_array("Sub Retinal Fluid",$testRes_OD)) echo 'CHECKED'; ?> value="Sub Retinal Fluid"><span class="label_txt">Sub Retinal Fluid</span></label></div>
                                <div class="col-sm-6"><label><input type="checkbox" id="testRes_OD_SRF" name="testRes_OD_SRF" <?php if(in_array("Sub RPE Fovial",$testRes_OD)||in_array("Sub RPE Foveal",$testRes_OD)) echo 'CHECKED'; ?> value="Sub RPE Foveal"><span class="label_txt">Sub RPE Foveal</span></label></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OD_CNV" name="testRes_OD_CNV" <?php if(in_array("CNV",$testRes_OD)) echo 'CHECKED';?> value="CNV"><span class="label_txt">CNV</span></label></div>
                                <div class="col-sm-4"><label><input type="checkbox" id="testRes_OD_RPEDetach" name="testRes_OD_RPEDetach" <?php if(in_array("RPE Detach",$testRes_OD)) echo 'CHECKED';?> value="RPE Detach"><span class="label_txt">RPE Detach</span></label></div>
                                <div class="col-sm-3"><label><input type="checkbox" id="testRes_OD_RPERip"  name="testRes_OD_RPERip" <?php if(in_array("RPE Rip",$testRes_OD)) echo 'CHECKED';?> value="RPE Rip"><span class="label_txt">RPE Rip</span></label></div>
                            </div>
                            <div class="row">
                          ...
                          <td class="tstrstopt">
                            ...
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OS_CME" name="testRes_OS_CME" <?php if(in_array("CME",$testRes_OS)) echo 'CHECKED'; ?> value="CME"><span class="label_txt">CME</span></label></div>
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OS_IRF" name="testRes_OS_IRF" <?php if(in_array("Intra Retinal Fluid",$testRes_OS)) echo 'CHECKED'; ?> value="Intra Retinal Fluid"><span class="label_txt">Intra Retinal Fluid</span></label></div>
                                <div class="col-sm-2"><label><input type="checkbox" id="testRes_OS_ERM" name="testRes_OS_ERM" <?php if(in_array("ERM",$testRes_OS)) echo 'CHECKED'; ?> value="ERM"><span class="label_txt">ERM</span></label></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OS_Drusen" name="testRes_OS_Drusen" <?php if(in_array("Drusen",$testRes_OS)) echo 'CHECKED'; ?> value="Drusen"><span class="label_txt">Drusen</span></label></div>
                                <div class="col-sm-7"><label><input type="checkbox" id="testRes_OS_VMT" name="testRes_OS_VMT"  <?php if(in_array("Vitreous Macula Traction",$testRes_OS)) echo 'CHECKED'; ?>  value="Vitreous Macula Traction"><span class="label_txt">Vitreous Macula Traction</span></label></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OS_SRetF" name="testRes_OS_SRetF" <?php if(in_array("Sub Retinal Fluid",$testRes_OS)) echo 'CHECKED'; ?>  value="Sub Retinal Fluid"><span class="label_txt">Sub Retinal Fluid</span></label></div>
                                <div class="col-sm-6"><label><input type="checkbox" id="testRes_OS_SRF" name="testRes_OS_SRF"  <?php if(in_array("Sub RPE Fovial",$testRes_OS)||in_array("Sub RPE Foveal",$testRes_OS)) echo 'CHECKED'; ?>  value="Sub RPE Foveal"><span class="label_txt">Sub RPE Foveal</span></label></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-5"><label><input type="checkbox" id="testRes_OS_CNV" name="testRes_OS_CNV" <?php if(in_array("CNV",$testRes_OS)) echo 'CHECKED'; ?> value="CNV"><span class="label_txt">CNV</span></label></div>
                                <div class="col-sm-4"><label><input type="checkbox" id="testRes_OS_RPEDetach" name="testRes_OS_RPEDetach"  <?php if(in_array("RPE Detach",$testRes_OS)) echo 'CHECKED'; ?> value="RPE Detach"><span class="label_txt">RPE Detach</span></label></div>
                                <div class="col-sm-3"><label><input type="checkbox" id="testRes_OS_RPERip" name="testRes_OS_RPERip"  <?php if(in_array("RPE Rip",$testRes_OS)) echo 'CHECKED'; ?>  value="RPE Rip"><span class="label_txt">RPE Rip</span></label></div>
                            </div>
                            <div class="row">
                        ...
                        <tr>
                          <td class="tdlftpan"><strong>Foveal Thickness</strong></td>
                          <td class="tstrstopt">
                            <div class="row">
                                <div class="col-sm-6"><input type="text" id="elem_foveaThick_OD" name="elem_foveaThick_OD" value="<?php echo ($elem_foveaThick_OD);?>" class="form-control"></div>
                            </div>
                          </td>
                          <td class="tstrstopt">
                            <div class="row">
                                <div class="col-sm-6"><input type="text" id="elem_foveaThick_OS" name="elem_foveaThick_OS" value="<?php echo ($elem_foveaThick_OS);?>" class="form-control"></div>
                            </div
                          ></td>
                      </tr>
                        <tr>
                          <td class="tdlftpan"><strong>AVG NFL Thickness</strong></td>
                          <td class="tstrstopt">
                            <div class="row">
                                <div class="col-sm-6"><input type="text" id="elem_avg_nfl_Thick_OD" name="elem_avg_nfl_Thick_OD" value="<?php echo ($elem_avg_nfl_Thick_OD);?>" class="form-control"></div>
                            </div>
                          </td>
                          <td class="tstrstopt">
                            <div class="row">
                                <div class="col-sm-6"><input type="text" id="elem_avg_nfl_Thick_OS" name="elem_avg_nfl_Thick_OS" value="<?php echo ($elem_avg_nfl_Thick_OS);?>" class="form-control"></div>
                            </div
                          ></td>
                      </tr>
                        <tr>
                          ...
                          <td class="tstrstopt">
                            <div class="row">
                                <div class="col-sm-6"><input type="text" id="elem_targetIop_OD" name="elem_targetIop_OD" value="<?php echo ($elem_targetIop_OD);?>" class="form-control"></div>
                            </div>
                          </td>
                          <td class="tstrstopt">
                            <div class="row">
                                <div class="col-sm-6"><input type="text" id="elem_targetIop_OS" name="elem_targetIop_OS" value="<?php echo ($elem_targetIop_OS);?>" class="form-control"></div>
                            </div
                          ></td>
                      </tr>
                      <tr>
                        ...
                        <div class="col-sm-12">
                            <div class="whitebox">
                                ...
                                <div class="tstrstopt">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4"><label><input type="checkbox" name="elem_monitor_finding" value="1" <?php echo ($elem_monitor_finding == "1") ? "checked" : "" ;?>><span class="label_txt">Monitor&nbsp;findings</span></label></div>
                            ...
                            <div class="col-sm-12 supperbill">
                                ...
                                <!-- Superbill -->
                                <div class="clearfix"></div>
                				<?php echo $objTests->get_zeiss_forum_button('OCT',$test_edid,$patient_id);?>
                            </div>
                        	<?php }?>
                        </div>
                    </div>
