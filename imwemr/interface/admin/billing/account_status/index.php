...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_account_status.js"></script>	
<body>
    <input type="hidden" name="ord_by_field" id="ord_by_field" value="status_name">
			...
			<table class="table table-bordered table-hover adminnw">
				<thead>
					<tr>
						...
						<th onClick="LoadResultSet('','','','status_name',this);">Account Status Name<span></span></th>
						<th onClick="LoadResultSet('','','','status_type',this);">Status Type<span></span></th>
					</tr>
				</thead>
				...
				<form name="add_edit_frm" id="add_edit_frm" onSubmit="saveFormData();return false;">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="status_name">Name of Account Status</label>
							<input type="text" name="status_name" id="status_name" class="form-control" />
						</div>
						<div class="form-group">
							<label for="status_type">Status Type</label>
							<select type="text" name="status_type" id="status_type" class="form-control minimal" /></select>
						</div>
					</div>	
