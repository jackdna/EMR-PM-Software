...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_diag_categories.js"></script>
<body>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th onClick="LoadResultSet('','','','title',this);">Categories<span></span></th>
					</tr>
				</thead>
