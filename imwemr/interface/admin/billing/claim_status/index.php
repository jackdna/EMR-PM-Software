...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_claim_status.js"></script>	
<body>
			...
			<table class="table table-bordered table-hover adminnw">
				<thead>
					<tr>
						...
						<th onClick="LoadResultSet('','','','status_name',this);">Name<span></span></th>
					</tr>
				</thead>
				...
				<form name="add_edit_frm" id="add_edit_frm" onSubmit="saveFormData();return false;">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="status_name">Name of Claim Status</label>
