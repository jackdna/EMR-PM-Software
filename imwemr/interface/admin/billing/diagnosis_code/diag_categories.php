...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_diag_code_categories.js"></script>
<body>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th onClick="LoadResultSet('','','','category',this);">Category<span></span></th>
					</tr>
				</thead>
		...
		<div class="modal-dialog"> 
			<div class="modal-content">
				...
				<form name="add_edit_frm" id="add_edit_frm" onSubmit="saveFormData();return false;">
					<input type="hidden" name="diag_cat_id" id="diag_cat_id" value="">	
