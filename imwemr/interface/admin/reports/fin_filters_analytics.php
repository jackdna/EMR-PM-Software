    ...
    <div class="grpbox">
      ...
      <div class="tblBg">
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="checkbox checkbox-inline pointer">
              <input type="checkbox" name="grpby_procedure" id="grpby_procedure" value="1" <?php if ($filter_arr['grpby_procedure'] == '1') echo 'CHECKED'; ?>/>
              <label for="grpby_procedure">Procedure</label>
            </div>
          </div>
          <div class="col-sm-12">
            <div class="checkbox checkbox-inline pointer">
              <input type="checkbox" name="grpby_ins_groups" id="grpby_ins_groups" value="1" <?php if ($filter_arr['grpby_ins_groups'] == '1') echo 'CHECKED'; ?>/>
              <label for="grpby_ins_groups">Ins Groups</label>
            </div>
          </div>
       	</div>
      </div>
