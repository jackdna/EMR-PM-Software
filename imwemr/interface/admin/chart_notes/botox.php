...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_botox.js"></script>
<body>
    <input type="hidden" name="ord_by_field" id="ord_by_field" value="bdos">
			...
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th onClick="LoadResultSet('','','','bdos',this);" class="link_cursor">Botox<span></span></th>
					</tr>
				</thead>
			...
			<div class="modal-body">
				<div class="form-group">
					<div>
						...
						<input class="form-control" name="bdos" id="bdos" type="text">
					</div>
				</div>
			</div>
