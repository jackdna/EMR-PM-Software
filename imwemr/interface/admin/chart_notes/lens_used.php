...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_lens_used.js"></script>
<body>
			...
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th onClick="LoadResultSet('','','','name',this);" class="link_cursor">Lens Used<span></span></th>
				  </tr>
				</thead>
			...
			<div class="modal-body">
				<div class="form-group">
					<div>
						...
						<label for="name">Lens Used</label>
