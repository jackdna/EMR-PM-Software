...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_speciality.js"></script>
<body>
			...
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th onClick="LoadResultSet('','','','name',this);" class="link_cursor">Specialty<span></span></th>
				  </tr>
				</thead>
