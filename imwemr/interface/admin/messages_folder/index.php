...
?>
<script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/library/js/admin/admin_messages_folder.js"></script>
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="folder_name" id="folder_name" type="text" value="">
                        </div>
                        <div class="form-group">
