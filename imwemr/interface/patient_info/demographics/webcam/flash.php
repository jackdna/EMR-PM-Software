...
if(!empty($patient_id))
{
	...
	$ptDirPath = "PatientId_".$patient_id."/";
	$thumbpth = $upload_dir.$ptDirPath."PtImgThumb/1.jpg";
 ...
 <head>
	...
	<script language="javascript">
		...
		window.onload =function()
		{
			...
			document.getElementById('imw_camera').addEventListener("contextmenu", function(e){
				e.preventDefault();
			}, false);
		}
		...
		{			
			...
			if(image != "")
			{
				if(typeof(window.opener.fmain) != "undefined")
					window.opener.fmain.image_DIV(image,'ptImage');
				else 	
					window.opener.image_DIV(image,'ptImage');
			}
			window.close();
		}
	</script>
        	...
        	<div class="modal-dialog" style="width:100%; margin:0;">
				...
				<div class="modal-content">
					<div class="modal-header bg-primary">
						<h4 class="modal-title" id="modal_title">Patient Image</h4>
					</div>
