...
<page backtop="5mm" backbottom="5mm">
	<page_header>
		<table style="width:100%;" border="0" cellspacing="0"  cellpadding="0">
				<tr>
					...
					<td style="width:30%; text-align:right" class="tb_headingHeader">
						<?php if($flgDos=="1"){ ?> 
						Date of Service:&nbsp;<?php echo ''.$date_of_service;?>&nbsp;
						<?php } ?>
					</td>					
				</tr>
		</table>
	...
	<table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
		...
		<table style="width:100%;" border="0" cellspacing="0"  cellpadding="0">
				<tr>
					<td style="width:100%" class="tb_dataHeader"> <?php echo $page_title;  ?></td>
				</tr>
			</table>
