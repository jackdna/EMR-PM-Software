...
File: ascan_print.php
Purpose: Ascan Test print
Access Type : Include file
*/
 $testPrint =''; $testHeadFoot = '';
	...
	$testCSS = '
		...
		<page_header>
			<table border="0" cellpadding="0" cellspacing="0">				
					<tr>
						<td colspan="3" align="center" style="width:1080px" class="text_b"><strong>ASCAN TEST</strong></td>
					</tr>
					<tr>
						...
						<!-- <td class="text_b" align="right" style="width:200px">DOS:&nbsp;&nbsp;'.FormatDate_show($elem_examDate).'</td> -->
...
if($strPrint!='') {
	...
	$testPrint.= "</page>";
		...
		//$html_file_name = 'ascan_print_'.$_SESSION['authId'];
		//file_put_contents('../common/new_html2pdf/'.$html_file_name.'.html',$testPrint);
		$file_location = write_html($testPrint,$html_file_name.'.html');
?>