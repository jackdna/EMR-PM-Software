...
$ARRAY_NQF0564=$objMUR->getNQF0564();

$ARRAY_IPOP=$ARRAY_NQF0564["ipop"];
$ARRAY_DENOMINATOR=$ARRAY_NQF0564["denominator"];
$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0564["exclusion"];
if(count($ARRAY_DENOMINATOR_EXCLUSION)==0){
	$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0564["denominatorException"];	
}
$ARRAY_NUMERATOR=$ARRAY_NQF0564["numerator"];
//==================================IPOP===========================================//
...
$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2186-5'] = '7';

$measuresArr['IPP']['RACE_VALUE_COUNT']['2028-9'] = '1';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2106-3'] = '4';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2076-8'] = '1';
$measuresArr['IPP']['RACE_VALUE_COUNT']['1002-5'] = '2';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2131-1'] = '5';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2054-5'] = '0';
...
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2186-5'] = '7';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2028-9'] = '1';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2106-3'] = '4';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2076-8'] = '1';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['1002-5'] = '2';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2131-1'] = '5';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2054-5'] = '0';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['1'] = '3';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['2'] = '5';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['349'] = '5';

$measuresArr['DENOM_EXCLUSION']['GENDER_COUNT'] = '10';
$measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT']["F"] = '4';
$measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT']["M"] = '6';
$measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT']['2135-2'] = '4';
$measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT']['2186-5'] = '6';
$measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT']['1002-5'] = '1';
$measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT']['2076-8'] = '1';
$measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT']['2106-3'] = '4';
$measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT']['2131-1'] = '4';
$measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT']['1'] = '3';
$measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT']['2'] = '5';
$measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT']['349'] = '2';
...
$measuresArr['NUMER']['RACE_VALUE_COUNT']['1002-5'] = '1';
$measuresArr['NUMER']['PAYER_VALUE_COUNT']['2'] = '0';
$measuresArr['NUMER']['PAYER_VALUE_COUNT']['349'] = '1';
*/
...
<ClinicalDocument xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 xmlns:cda="urn:hl7-org:v3">
  ...
  <id root="27fb26e0-bbbd-0135-be89-0242ac120005" extension="CypressExtension"/>
...
-->
        ...
        <section>
          ...
          <entry>
            <organizer classCode="CLUSTER" moodCode="EVN">
              ...
              <id extension="40280382-5A66-EAB9-015A-866C5ADD0C0B"/>
  ...
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
       <id root="5E1A5995-EE9D-4413-B757-725D579B5B26"/>
...
<!--   MEASURE DATA REPORTING FOR    IPP  8A44DF19-F6AA-4FCA-AD98-53DF73C00902  -->
<observation classCode="OBS" moodCode="EVN">
...
foreach($measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT'] as $IPP_SUPPLE_VALUE_CODE => $IPP_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for IPP  8A44DF19-F6AA-4FCA-AD98-53DF73C00902      --> 
...
foreach($measuresArr['IPP']['ETHNICITY_VALUE_COUNT'] as $IPP_ETH_VALUE_CODE => $IPP_ETH_VALUE_COUNT) {
	...
	$xmlData .= '    
    <!--     ETHNICITY Supplemental Data Reporting  for IPP  8A44DF19-F6AA-4FCA-AD98-53DF73C00902     --> 
...
foreach($measuresArr['IPP']['RACE_VALUE_COUNT'] as $IPP_RAC_VALUE_CODE => $IPP_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for IPP  8A44DF19-F6AA-4FCA-AD98-53DF73C00902 --> 
...
foreach($measuresArr['IPP']['PAYER_VALUE_COUNT'] as $IPP_PAY_VALUE_CODE => $IPP_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for IPP  8A44DF19-F6AA-4FCA-AD98-53DF73C00902   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="8A44DF19-F6AA-4FCA-AD98-53DF73C00902"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    DENOM  AC68F187-68E3-499C-B6C4-0F65E4829ECB  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_SUPPLE_VALUE_CODE => $DENOM_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENOM  AC68F187-68E3-499C-B6C4-0F65E4829ECB      --> 
...
foreach($measuresArr['DENOM']['ETHNICITY_VALUE_COUNT'] as $DENOM_ETH_VALUE_CODE => $DENOM_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENOM  AC68F187-68E3-499C-B6C4-0F65E4829ECB     --> 
...
foreach($measuresArr['DENOM']['RACE_VALUE_COUNT'] as $DENOM_RAC_VALUE_CODE => $DENOM_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENOM  AC68F187-68E3-499C-B6C4-0F65E4829ECB --> 
...
foreach($measuresArr['DENOM']['PAYER_VALUE_COUNT'] as $DENOM_PAY_VALUE_CODE => $DENOM_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENOM  AC68F187-68E3-499C-B6C4-0F65E4829ECB   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="AC68F187-68E3-499C-B6C4-0F65E4829ECB"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    DENEX  C1205D08-24DB-412E-87A9-16B75CCD3ED0  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_EXCL_SUPPLE_VALUE_CODE => $DENOM_EXCL_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENEX  C1205D08-24DB-412E-87A9-16B75CCD3ED0      --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT'] as $DENOM_EXCL_ETH_VALUE_CODE => $DENOM_EXCL_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENEX  C1205D08-24DB-412E-87A9-16B75CCD3ED0     --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT'] as $DENOM_EXCL_RAC_VALUE_CODE => $DENOM_EXCL_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENEX  C1205D08-24DB-412E-87A9-16B75CCD3ED0 --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT'] as $DENOM_EXCL_PAY_VALUE_CODE => $DENOM_EXCL_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENEX  C1205D08-24DB-412E-87A9-16B75CCD3ED0   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= ' 
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="C1205D08-24DB-412E-87A9-16B75CCD3ED0"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    NUMER  5E1A5995-EE9D-4413-B757-725D579B5B26  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['NUMER']['SUPPLEMENT_GENDER_COUNT'] as $NUMER_SUPPLE_VALUE_CODE => $NUMER_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for NUMER  5E1A5995-EE9D-4413-B757-725D579B5B26      --> 
...
foreach($measuresArr['NUMER']['ETHNICITY_VALUE_COUNT'] as $NUMER_ETH_VALUE_CODE => $NUMER_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for NUMER  5E1A5995-EE9D-4413-B757-725D579B5B26     --> 
...
foreach($measuresArr['NUMER']['RACE_VALUE_COUNT'] as $NUMER_RAC_VALUE_CODE => $NUMER_RAC_VALUE_COUNT) {
   ...
   <!--      RACE Supplemental Data Reporting  for NUMER  5E1A5995-EE9D-4413-B757-725D579B5B26 --> 
...
foreach($measuresArr['NUMER']['PAYER_VALUE_COUNT'] as $NUMER_PAY_VALUE_CODE => $NUMER_PAY_VALUE_COUNT) {
 ...
 <!--         PAYER Supplemental Data Reporting   for NUMER  5E1A5995-EE9D-4413-B757-725D579B5B26   -->
   <!--                            Supplemental Data Template                                                  -->
