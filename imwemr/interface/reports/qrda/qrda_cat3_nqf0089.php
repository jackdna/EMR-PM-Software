...
$ARRAY_NQF0089=$objMUR->getNQF0089();
$ARRAY_IPOP=$ARRAY_NQF0089["ipop"];
$ARRAY_DENOMINATOR=$ARRAY_NQF0089["denominator"];
$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0089["exclusion"];
if(count($ARRAY_DENOMINATOR_EXCLUSION)==0){
	$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0089["denominatorException"];	
}
$ARRAY_NUMERATOR=$ARRAY_NQF0089["numerator"];
//==================================IPOP===========================================//
...
/*
$measuresArr = array();
$measuresArr['IPP']['GENDER_COUNT'] = '9';
...
$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2186-5'] = '4';

$measuresArr['IPP']['RACE_VALUE_COUNT']['2028-9'] = '1';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2106-3'] = '2';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2076-8'] = '2';
...
$measuresArr['IPP']['PAYER_VALUE_COUNT']['1'] = '1';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['2'] = '2';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['349'] = '6';


$measuresArr['DENOM']['GENDER_COUNT'] = '8';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["F"] = '1';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["M"] = '7';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2135-2'] = '4';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2186-5'] = '4';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2028-9'] = '1';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2106-3'] = '2';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2076-8'] = '2';
...
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['1'] = '1';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['2'] = '2';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['349'] = '5';

$measuresArr['DENOM_EXCLUSION']['GENDER_COUNT'] = '5';
...
<ClinicalDocument xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 xmlns:cda="urn:hl7-org:v3">
  ...
  <id root="de391d30-bbbc-0135-be88-0242ac120005" extension="CypressExtension"/>
...
-->
        ...
        <section>
          ...
          <entry>
            <organizer classCode="CLUSTER" moodCode="EVN">
              ...
              <id extension="40280382-5971-4EED-015A-04D538502DAE"/>
  ...
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
       <id root="61861F0F-2A1B-43F6-974A-507FA24163DB"/>
...
<!--   MEASURE DATA REPORTING FOR    IPP  71DEDD9A-65CD-436B-BD07-1FF38CC3EC42  -->
<observation classCode="OBS" moodCode="EVN">
...
foreach($measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT'] as $IPP_SUPPLE_VALUE_CODE => $IPP_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for IPP  71DEDD9A-65CD-436B-BD07-1FF38CC3EC42      --> 
...
foreach($measuresArr['IPP']['ETHNICITY_VALUE_COUNT'] as $IPP_ETH_VALUE_CODE => $IPP_ETH_VALUE_COUNT) {
	...
	$xmlData .= '    
    <!--     ETHNICITY Supplemental Data Reporting  for IPP  71DEDD9A-65CD-436B-BD07-1FF38CC3EC42     --> 
...
foreach($measuresArr['IPP']['RACE_VALUE_COUNT'] as $IPP_RAC_VALUE_CODE => $IPP_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for IPP  71DEDD9A-65CD-436B-BD07-1FF38CC3EC42 --> 
...
foreach($measuresArr['IPP']['PAYER_VALUE_COUNT'] as $IPP_PAY_VALUE_CODE => $IPP_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for IPP  71DEDD9A-65CD-436B-BD07-1FF38CC3EC42   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="71DEDD9A-65CD-436B-BD07-1FF38CC3EC42"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    DENOM  F6E6941D-EC07-4F87-9AD7-E9A4DE1C9D83  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_SUPPLE_VALUE_CODE => $DENOM_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENOM  F6E6941D-EC07-4F87-9AD7-E9A4DE1C9D83      --> 
...
foreach($measuresArr['DENOM']['ETHNICITY_VALUE_COUNT'] as $DENOM_ETH_VALUE_CODE => $DENOM_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENOM  F6E6941D-EC07-4F87-9AD7-E9A4DE1C9D83     --> 
...
foreach($measuresArr['DENOM']['RACE_VALUE_COUNT'] as $DENOM_RAC_VALUE_CODE => $DENOM_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENOM  F6E6941D-EC07-4F87-9AD7-E9A4DE1C9D83 --> 
...
foreach($measuresArr['DENOM']['PAYER_VALUE_COUNT'] as $DENOM_PAY_VALUE_CODE => $DENOM_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENOM  F6E6941D-EC07-4F87-9AD7-E9A4DE1C9D83   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="F6E6941D-EC07-4F87-9AD7-E9A4DE1C9D83"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    NUMER  61861F0F-2A1B-43F6-974A-507FA24163DB  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['NUMER']['SUPPLEMENT_GENDER_COUNT'] as $NUMER_SUPPLE_VALUE_CODE => $NUMER_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for NUMER  61861F0F-2A1B-43F6-974A-507FA24163DB      --> 
...
foreach($measuresArr['NUMER']['ETHNICITY_VALUE_COUNT'] as $NUMER_ETH_VALUE_CODE => $NUMER_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for NUMER  61861F0F-2A1B-43F6-974A-507FA24163DB     --> 
...
foreach($measuresArr['NUMER']['RACE_VALUE_COUNT'] as $NUMER_RAC_VALUE_CODE => $NUMER_RAC_VALUE_COUNT) {
   ...
   <!--      RACE Supplemental Data Reporting  for NUMER  61861F0F-2A1B-43F6-974A-507FA24163DB --> 
...
foreach($measuresArr['NUMER']['PAYER_VALUE_COUNT'] as $NUMER_PAY_VALUE_CODE => $NUMER_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for NUMER  61861F0F-2A1B-43F6-974A-507FA24163DB   -->
   <!--                            Supplemental Data Template                                                  -->
...
<!--   MEASURE DATA REPORTING FOR    DENEXCEP  18692AEE-C96C-454C-80C5-25A4986113B7  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_EXCL_SUPPLE_VALUE_CODE => $DENOM_EXCL_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENEXCEP  18692AEE-C96C-454C-80C5-25A4986113B7      --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT'] as $DENOM_EXCL_ETH_VALUE_CODE => $DENOM_EXCL_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENEXCEP  18692AEE-C96C-454C-80C5-25A4986113B7     --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT'] as $DENOM_EXCL_RAC_VALUE_CODE => $DENOM_EXCL_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENEXCEP  18692AEE-C96C-454C-80C5-25A4986113B7 --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT'] as $DENOM_EXCL_PAY_VALUE_CODE => $DENOM_EXCL_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENEXCEP  18692AEE-C96C-454C-80C5-25A4986113B7   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= ' 
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="18692AEE-C96C-454C-80C5-25A4986113B7"/>
     </externalObservation>
  </reference>
</observation>
              </component>
