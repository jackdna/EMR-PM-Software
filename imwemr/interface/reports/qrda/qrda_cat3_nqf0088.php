...
$ARRAY_NQF0088=$objMUR->getNQF0088();
$ARRAY_IPOP=$ARRAY_NQF0088["ipop"];
$ARRAY_DENOMINATOR=$ARRAY_NQF0088["denominator"];
$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0088["exclusion"];
if(count($ARRAY_DENOMINATOR_EXCLUSION)==0){
	$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0088["denominatorException"];	
}
$ARRAY_NUMERATOR=$ARRAY_NQF0088["numerator"];
//==================================IPOP===========================================//
...
/*
$measuresArr = array();
$measuresArr['IPP']['GENDER_COUNT'] = '10';
$measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT']["F"] = '1';
$measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT']["M"] = '9';

$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2135-2'] = '5';
$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2186-5'] = '5';
...
$measuresArr['IPP']['RACE_VALUE_COUNT']['2131-1'] = '1';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2054-5'] = '2';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['1'] = '2';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['2'] = '3';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['349'] = '5';


$measuresArr['DENOM']['GENDER_COUNT'] = '10';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["F"] = '1';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["M"] = '9';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2135-2'] = '5';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2186-5'] = '5';
...
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2131-1'] = '1';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2054-5'] = '2';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2076-8'] = '1';


$measuresArr['DENOM']['PAYER_VALUE_COUNT']['1'] = '2';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['2'] = '3';
...
$measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT']["M"] = '2';

$measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT']['2135-2'] = '1';
$measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT']['2186-5'] = '1';

$measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT']['2028-9'] = '1';
$measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT']['2131-1'] = '1';
...
<ClinicalDocument xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 xmlns:cda="urn:hl7-org:v3">
  ...
  <id root="ace83ba0-bbbc-0135-be89-0242ac120005" extension="CypressExtension"/>
...
-->
        ...
        <section>
          ...
          <entry>
            <organizer classCode="CLUSTER" moodCode="EVN">
              ...
              <id extension="40280382-5971-4EED-015A-04EEF5FE2DD3"/>
  ...
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
       <id root="B18CD2A0-6AFC-40E7-8C70-27243C5BAA6F"/>
...
<!--   MEASURE DATA REPORTING FOR    IPP  DD63C311-8349-4843-A7FC-14A7FBBC50A9  -->
<observation classCode="OBS" moodCode="EVN">
...
foreach($measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT'] as $IPP_SUPPLE_VALUE_CODE => $IPP_SUPPLE_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--    SEX Supplemental Data Reporting for IPP  DD63C311-8349-4843-A7FC-14A7FBBC50A9      --> 
...
foreach($measuresArr['IPP']['ETHNICITY_VALUE_COUNT'] as $IPP_ETH_VALUE_CODE => $IPP_ETH_VALUE_COUNT) {
	...
	$xmlData .= '    
    <!--     ETHNICITY Supplemental Data Reporting  for IPP  DD63C311-8349-4843-A7FC-14A7FBBC50A9     --> 
...
foreach($measuresArr['IPP']['RACE_VALUE_COUNT'] as $IPP_RAC_VALUE_CODE => $IPP_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for IPP  DD63C311-8349-4843-A7FC-14A7FBBC50A9 --> 
...
foreach($measuresArr['IPP']['PAYER_VALUE_COUNT'] as $IPP_PAY_VALUE_CODE => $IPP_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for IPP  DD63C311-8349-4843-A7FC-14A7FBBC50A9   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="DD63C311-8349-4843-A7FC-14A7FBBC50A9"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    DENOM  6FD337B1-7A8E-407B-A356-331BA1C55608  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_SUPPLE_VALUE_CODE => $DENOM_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENOM  6FD337B1-7A8E-407B-A356-331BA1C55608      --> 
...
foreach($measuresArr['DENOM']['ETHNICITY_VALUE_COUNT'] as $DENOM_ETH_VALUE_CODE => $DENOM_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENOM  6FD337B1-7A8E-407B-A356-331BA1C55608     --> 
...
foreach($measuresArr['DENOM']['RACE_VALUE_COUNT'] as $DENOM_RAC_VALUE_CODE => $DENOM_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENOM  6FD337B1-7A8E-407B-A356-331BA1C55608 --> 
...
foreach($measuresArr['DENOM']['PAYER_VALUE_COUNT'] as $DENOM_PAY_VALUE_CODE => $DENOM_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENOM  6FD337B1-7A8E-407B-A356-331BA1C55608   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="6FD337B1-7A8E-407B-A356-331BA1C55608"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    NUMER  B18CD2A0-6AFC-40E7-8C70-27243C5BAA6F  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['NUMER']['SUPPLEMENT_GENDER_COUNT'] as $NUMER_SUPPLE_VALUE_CODE => $NUMER_SUPPLE_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--    SEX Supplemental Data Reporting for NUMER  B18CD2A0-6AFC-40E7-8C70-27243C5BAA6F      --> 
...
foreach($measuresArr['NUMER']['ETHNICITY_VALUE_COUNT'] as $NUMER_ETH_VALUE_CODE => $NUMER_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for NUMER  B18CD2A0-6AFC-40E7-8C70-27243C5BAA6F     --> 
...
foreach($measuresArr['NUMER']['RACE_VALUE_COUNT'] as $NUMER_RAC_VALUE_CODE => $NUMER_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for NUMER  B18CD2A0-6AFC-40E7-8C70-27243C5BAA6F --> 
...
foreach($measuresArr['NUMER']['PAYER_VALUE_COUNT'] as $NUMER_PAY_VALUE_CODE => $NUMER_PAY_VALUE_COUNT) {
 ...
 <!--         PAYER Supplemental Data Reporting   for NUMER  B18CD2A0-6AFC-40E7-8C70-27243C5BAA6F   -->
   <!--                            Supplemental Data Template                                                  -->
...
<!--   MEASURE DATA REPORTING FOR    DENEXCEP  88CDFB9B-0391-4910-A078-ABCD863EF922  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_EXCL_SUPPLE_VALUE_CODE => $DENOM_EXCL_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENEXCEP  88CDFB9B-0391-4910-A078-ABCD863EF922      --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT'] as $DENOM_EXCL_ETH_VALUE_CODE => $DENOM_EXCL_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for DENEXCEP  88CDFB9B-0391-4910-A078-ABCD863EF922     --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT'] as $DENOM_EXCL_RAC_VALUE_CODE => $DENOM_EXCL_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENEXCEP  88CDFB9B-0391-4910-A078-ABCD863EF922 --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT'] as $DENOM_EXCL_PAY_VALUE_CODE => $DENOM_EXCL_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENEXCEP  88CDFB9B-0391-4910-A078-ABCD863EF922   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= ' 
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="88CDFB9B-0391-4910-A078-ABCD863EF922"/>
     </externalObservation>
  </reference>
</observation>
              </component>
