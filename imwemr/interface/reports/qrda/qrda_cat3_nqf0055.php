...
$ARRAY_NQF0055=$objMUR->getNQF0055();
$ARRAY_IPOP=$ARRAY_NQF0055["ipop"];
$ARRAY_DENOMINATOR=$ARRAY_NQF0055["denominator"];
$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0055["exclusion"];
if(count($ARRAY_DENOMINATOR_EXCLUSION)==0){
	$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0055["denominatorException"];	
}
$ARRAY_NUMERATOR=$ARRAY_NQF0055["numerator"];
//==================================IPOP===========================================//
...
/*
$measuresArr = array();
$measuresArr['IPP']['GENDER_COUNT'] = '23';
$measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT']["F"] = '11';
$measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT']["M"] = '12';

$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2135-2'] = '14';
$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2186-5'] = '9';

$measuresArr['IPP']['RACE_VALUE_COUNT']['2106-3'] = '9';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2076-8'] = '4';
$measuresArr['IPP']['RACE_VALUE_COUNT']['1002-5'] = '4';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2131-1'] = '2';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2054-5'] = '3';

$measuresArr['IPP']['PAYER_VALUE_COUNT']['1'] = '0';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['2'] = '9';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['349'] = '14';

$measuresArr['DENOM']['GENDER_COUNT'] = '23';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["F"] = '11';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["M"] = '12';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2135-2'] = '14';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2186-5'] = '9';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2028-9'] = '1';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2106-3'] = '9';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2076-8'] = '4';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['1002-5'] = '4';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2131-1'] = '2';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2054-5'] = '3';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['1'] = '0';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['2'] = '9';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['349'] = '14';

$measuresArr['DENOM_EXCLUSION']['GENDER_COUNT'] = '2';
$measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT']["F"] = '2';
$measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT']["M"] = '';
...
$measuresArr['NUMER']['SUPPLEMENT_GENDER_COUNT']["F"] = '2';
$measuresArr['NUMER']['SUPPLEMENT_GENDER_COUNT']["M"] = '';
$measuresArr['NUMER']['ETHNICITY_VALUE_COUNT']['2135-2'] = '2';
...
<ClinicalDocument xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3">
  ...
  <id root="5336a430-bbb0-0135-be89-0242ac120005" extension="CypressExtension"/>
...
-->
        ...
        <section>
          ...
          <entry>
            <organizer classCode="CLUSTER" moodCode="EVN">
              ...
              <id extension="40280382-5ABD-FA46-015B-49956E7C383A"/>
  ...
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
       <id root="C7D4A675-E578-45F2-B637-5C1FC90FCCFA"/>
...
<!--   MEASURE DATA REPORTING FOR    IPP  A14D91B3-CD7F-432D-8148-B9563BAA960D  -->
<observation classCode="OBS" moodCode="EVN">
...
foreach($measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT'] as $IPP_SUPPLE_VALUE_CODE => $IPP_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for IPP  A14D91B3-CD7F-432D-8148-B9563BAA960D      --> 
...
foreach($measuresArr['IPP']['ETHNICITY_VALUE_COUNT'] as $IPP_ETH_VALUE_CODE => $IPP_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for IPP  A14D91B3-CD7F-432D-8148-B9563BAA960D     --> 
...
foreach($measuresArr['IPP']['RACE_VALUE_COUNT'] as $IPP_RAC_VALUE_CODE => $IPP_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for IPP  A14D91B3-CD7F-432D-8148-B9563BAA960D --> 
...
foreach($measuresArr['IPP']['PAYER_VALUE_COUNT'] as $IPP_PAY_VALUE_CODE => $IPP_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for IPP  A14D91B3-CD7F-432D-8148-B9563BAA960D   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="A14D91B3-CD7F-432D-8148-B9563BAA960D"/>
     </externalObservation>
  </reference>
</observation>
</component>
...
<!--   MEASURE DATA REPORTING FOR    DENOM  FCA38355-BD5D-445A-895C-5B6E09C41B77  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_SUPPLE_VALUE_CODE => $DENOM_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENOM  FCA38355-BD5D-445A-895C-5B6E09C41B77      --> 
...
foreach($measuresArr['DENOM']['ETHNICITY_VALUE_COUNT'] as $DENOM_ETH_VALUE_CODE => $DENOM_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENOM  FCA38355-BD5D-445A-895C-5B6E09C41B77     --> 
...
foreach($measuresArr['DENOM']['RACE_VALUE_COUNT'] as $DENOM_RAC_VALUE_CODE => $DENOM_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENOM  FCA38355-BD5D-445A-895C-5B6E09C41B77 --> 
...
foreach($measuresArr['DENOM']['PAYER_VALUE_COUNT'] as $DENOM_PAY_VALUE_CODE => $DENOM_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENOM  FCA38355-BD5D-445A-895C-5B6E09C41B77   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="FCA38355-BD5D-445A-895C-5B6E09C41B77"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    DENEX  53F076FE-F9B6-45C0-963E-BF5E38716C11  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_EXCL_SUPPLE_VALUE_CODE => $DENOM_EXCL_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for DENEX  53F076FE-F9B6-45C0-963E-BF5E38716C11      --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT'] as $DENOM_EXCL_ETH_VALUE_CODE => $DENOM_EXCL_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for DENEX  53F076FE-F9B6-45C0-963E-BF5E38716C11     --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT'] as $DENOM_EXCL_RAC_VALUE_CODE => $DENOM_EXCL_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENEX  53F076FE-F9B6-45C0-963E-BF5E38716C11 --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT'] as $DENOM_EXCL_PAY_VALUE_CODE => $DENOM_EXCL_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENEX  53F076FE-F9B6-45C0-963E-BF5E38716C11   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= ' 
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="53F076FE-F9B6-45C0-963E-BF5E38716C11"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    NUMER  C7D4A675-E578-45F2-B637-5C1FC90FCCFA  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['NUMER']['SUPPLEMENT_GENDER_COUNT'] as $NUMER_SUPPLE_VALUE_CODE => $NUMER_SUPPLE_VALUE_COUNT) {
   ...
   <!--    SEX Supplemental Data Reporting for NUMER  C7D4A675-E578-45F2-B637-5C1FC90FCCFA      --> 
...
foreach($measuresArr['NUMER']['ETHNICITY_VALUE_COUNT'] as $NUMER_ETH_VALUE_CODE => $NUMER_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for NUMER  C7D4A675-E578-45F2-B637-5C1FC90FCCFA     --> 
...
foreach($measuresArr['NUMER']['RACE_VALUE_COUNT'] as $NUMER_RAC_VALUE_CODE => $NUMER_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for NUMER  C7D4A675-E578-45F2-B637-5C1FC90FCCFA --> 
...
foreach($measuresArr['NUMER']['PAYER_VALUE_COUNT'] as $NUMER_PAY_VALUE_CODE => $NUMER_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for NUMER  C7D4A675-E578-45F2-B637-5C1FC90FCCFA   -->
   <!--                            Supplemental Data Template                                                  -->
