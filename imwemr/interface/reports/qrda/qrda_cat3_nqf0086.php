...
$ARRAY_NQF0086=$objMUR->getNQF0086();
$ARRAY_IPOP=$ARRAY_NQF0086["ipop"];
$ARRAY_DENOMINATOR=$ARRAY_NQF0086["denominator"];
$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0086["exclusion"];
if(count($ARRAY_DENOMINATOR_EXCLUSION)==0){
	$ARRAY_DENOMINATOR_EXCLUSION=$ARRAY_NQF0086["denominatorException"];	
}
$ARRAY_NUMERATOR=$ARRAY_NQF0086["numerator"];
//==================================IPOP===========================================//
...
/*
$measuresArr = array();
$measuresArr['IPP']['GENDER_COUNT'] = '3';
$measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT']["F"] = '1';
$measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT']["M"] = '2';

$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2135-2'] = '2';
$measuresArr['IPP']['ETHNICITY_VALUE_COUNT']['2186-5'] = '1';

$measuresArr['IPP']['RACE_VALUE_COUNT']['2028-9'] = '0';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2106-3'] = '2';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2076-8'] = '0';
$measuresArr['IPP']['RACE_VALUE_COUNT']['1002-5'] = '1';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2131-1'] = '0';
$measuresArr['IPP']['RACE_VALUE_COUNT']['2054-5'] = '0';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['1'] = '0';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['2'] = '0';
$measuresArr['IPP']['PAYER_VALUE_COUNT']['349'] = '3';


$measuresArr['DENOM']['GENDER_COUNT'] = '3';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["F"] = '1';
$measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT']["M"] = '2';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2135-2'] = '2';
$measuresArr['DENOM']['ETHNICITY_VALUE_COUNT']['2186-5'] = '1';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2028-9'] = '0';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2106-3'] = '2';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2076-8'] = '0';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['1002-5'] = '1';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2131-1'] = '0';
$measuresArr['DENOM']['RACE_VALUE_COUNT']['2054-5'] = '0';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['1'] = '0';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['2'] = '0';
$measuresArr['DENOM']['PAYER_VALUE_COUNT']['349'] = '3';
...
<ClinicalDocument xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 xmlns:cda="urn:hl7-org:v3">
  ...
  <id root="27ae9440-bbbc-0135-be89-0242ac120005" extension="CypressExtension"/>
...
-->
        ...
        <section>
          ...
          <entry>
            <organizer classCode="CLUSTER" moodCode="EVN">
              ...
              <id extension="40280382-5971-4EED-015A-04E1EAE72DC3"/>
  ...
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
       <id root="57FD3EA0-553F-439E-AD81-AA3B5CF523D4"/>
...
<!--   MEASURE DATA REPORTING FOR    IPP  9C63D9DF-F1E0-49A8-94F5-DE8A237C6E52  -->
<observation classCode="OBS" moodCode="EVN">
...
foreach($measuresArr['IPP']['SUPPLEMENT_GENDER_COUNT'] as $IPP_SUPPLE_VALUE_CODE => $IPP_SUPPLE_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--    SEX Supplemental Data Reporting for IPP  9C63D9DF-F1E0-49A8-94F5-DE8A237C6E52      --> 
...
foreach($measuresArr['IPP']['ETHNICITY_VALUE_COUNT'] as $IPP_ETH_VALUE_CODE => $IPP_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for IPP  9C63D9DF-F1E0-49A8-94F5-DE8A237C6E52     --> 
...
foreach($measuresArr['IPP']['RACE_VALUE_COUNT'] as $IPP_RAC_VALUE_CODE => $IPP_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for IPP  9C63D9DF-F1E0-49A8-94F5-DE8A237C6E52 --> 
...
foreach($measuresArr['IPP']['PAYER_VALUE_COUNT'] as $IPP_PAY_VALUE_CODE => $IPP_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for IPP  9C63D9DF-F1E0-49A8-94F5-DE8A237C6E52   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="9C63D9DF-F1E0-49A8-94F5-DE8A237C6E52"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    DENOM  C9F4C6C2-D567-4118-BDD6-52B8422729F4  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_SUPPLE_VALUE_CODE => $DENOM_SUPPLE_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--    SEX Supplemental Data Reporting for DENOM  C9F4C6C2-D567-4118-BDD6-52B8422729F4      --> 
...
foreach($measuresArr['DENOM']['ETHNICITY_VALUE_COUNT'] as $DENOM_ETH_VALUE_CODE => $DENOM_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENOM  C9F4C6C2-D567-4118-BDD6-52B8422729F4     --> 
...
foreach($measuresArr['DENOM']['RACE_VALUE_COUNT'] as $DENOM_RAC_VALUE_CODE => $DENOM_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for DENOM  C9F4C6C2-D567-4118-BDD6-52B8422729F4 --> 
...
foreach($measuresArr['DENOM']['PAYER_VALUE_COUNT'] as $DENOM_PAY_VALUE_CODE => $DENOM_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for DENOM  C9F4C6C2-D567-4118-BDD6-52B8422729F4   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= '
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="C9F4C6C2-D567-4118-BDD6-52B8422729F4"/>
     </externalObservation>
  </reference>
</observation>
              </component>
...
<!--   MEASURE DATA REPORTING FOR    NUMER  57FD3EA0-553F-439E-AD81-AA3B5CF523D4  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['NUMER']['SUPPLEMENT_GENDER_COUNT'] as $NUMER_SUPPLE_VALUE_CODE => $NUMER_SUPPLE_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--    SEX Supplemental Data Reporting for NUMER  57FD3EA0-553F-439E-AD81-AA3B5CF523D4      --> 
...
foreach($measuresArr['NUMER']['ETHNICITY_VALUE_COUNT'] as $NUMER_ETH_VALUE_CODE => $NUMER_ETH_VALUE_COUNT) {
    ...
    <!--     ETHNICITY Supplemental Data Reporting  for NUMER  57FD3EA0-553F-439E-AD81-AA3B5CF523D4     --> 
...
foreach($measuresArr['NUMER']['RACE_VALUE_COUNT'] as $NUMER_RAC_VALUE_CODE => $NUMER_RAC_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--      RACE Supplemental Data Reporting  for NUMER  57FD3EA0-553F-439E-AD81-AA3B5CF523D4 --> 
...
foreach($measuresArr['NUMER']['PAYER_VALUE_COUNT'] as $NUMER_PAY_VALUE_CODE => $NUMER_PAY_VALUE_COUNT) {
	...
	$xmlData .= ' 
 <!--         PAYER Supplemental Data Reporting   for NUMER  57FD3EA0-553F-439E-AD81-AA3B5CF523D4   -->
   <!--                            Supplemental Data Template                                                  -->
...
<!--   MEASURE DATA REPORTING FOR    DENEXCEP  B4E0ABDD-DF7A-48DC-86E1-5EACB0461207  -->
<observation classCode="OBS" moodCode="EVN">
  <!-- Measure Data template -->
  <templateId root="2.16.840.1.113883.10.20.27.3.5" extension="2016-09-01"/>
  <code code="ASSERTION" 
...
foreach($measuresArr['DENOM_EXCLUSION']['SUPPLEMENT_GENDER_COUNT'] as $DENOM_EXCL_SUPPLE_VALUE_CODE => $DENOM_EXCL_SUPPLE_VALUE_COUNT) {
	...
	$xmlData .= ' 
   <!--    SEX Supplemental Data Reporting for DENEXCEP  B4E0ABDD-DF7A-48DC-86E1-5EACB0461207      --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['ETHNICITY_VALUE_COUNT'] as $DENOM_EXCL_ETH_VALUE_CODE => $DENOM_EXCL_ETH_VALUE_COUNT) {
	...
	$xmlData .= ' 
    <!--     ETHNICITY Supplemental Data Reporting  for DENEXCEP  B4E0ABDD-DF7A-48DC-86E1-5EACB0461207     --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['RACE_VALUE_COUNT'] as $DENOM_EXCL_RAC_VALUE_CODE => $DENOM_EXCL_RAC_VALUE_COUNT) {
   ...
   <!--      RACE Supplemental Data Reporting  for DENEXCEP  B4E0ABDD-DF7A-48DC-86E1-5EACB0461207 --> 
...
foreach($measuresArr['DENOM_EXCLUSION']['PAYER_VALUE_COUNT'] as $DENOM_EXCL_PAY_VALUE_CODE => $DENOM_EXCL_PAY_VALUE_COUNT) {
 ...
 <!--         PAYER Supplemental Data Reporting   for DENEXCEP  B4E0ABDD-DF7A-48DC-86E1-5EACB0461207   -->
   <!--                            Supplemental Data Template                                                  -->
...
$xmlData .= ' 
  <reference typeCode="REFR">
     <externalObservation classCode="OBS" moodCode="EVN">
        <id root="B4E0ABDD-DF7A-48DC-86E1-5EACB0461207"/>
     </externalObservation>
  </reference>
</observation>
              </component>
