...
$physicianName = $CLSCommonFunction->drop_down_providers(implode(',',$Physician));
...
//CSV NAME
$dbtemp_name = 'Point of Service Collections';
							...
							<div class="pd5 report-content">
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
                                        <?php
										if($_POST['form_submitted']) {
											include('point_of_service_collections_result.php');
										}else{
