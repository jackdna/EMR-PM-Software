...
//--- SET ALL PT DOCS TEMPLATE -----
$templ_qry = imw_query("select pt_docs_template_id,pt_docs_template_name from pt_docs_template where pt_docs_template_status = '0' and pt_docs_template_name!='' order by pt_docs_template_name");
$templ_data_arr = array();	
while ($templ_qry_res = imw_fetch_array($templ_qry)) {
	$sel='';
    $template_id = $templ_qry_res['pt_docs_template_id'];
    $templ_data_arr[$template_id] = $templ_qry_res['pt_docs_template_name'];
	$sel = $templ_qry_res['pt_docs_template_id'] == $_REQUEST['template_id'] ? 'selected' : '';
    $template_name .= '<option value="'.$templ_qry_res['pt_docs_template_id'].'" '.$sel.'>' . $templ_qry_res['pt_docs_template_name'] . '</option>';
}
$dbtemp_name = 'Patient Documents';
//CSV NAME
                                    ...
                                    <div class="pd5" id="searchcriteria">
										...
										<div class="row">
											<div class="col-sm-6">
                                                ...
                                                <select name="facility_name[]" id="facility_name" class="selectpicker" data-container="#select_drop" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
                                                    <?php echo $facilityName; ?>
                                                </select>
											</div>
											<div class="col-sm-6">
                                                <label>Provider</label>
												<select name="phyId[]" id="phyId" class="selectpicker" data-container="#select_drop" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
												<?php echo $physicianName; ?>
												</select>
                                            </div>
											<div class="col-sm-6">
                                                <label>Template</label>
												<select name="template_id" id="template_id" class="selectpicker" data-container="#select_drop" data-width="100%" data-size="10">
							...
							<div class="pd5 report-content">
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
                                        <?php
										if($_POST['form_submitted']) {
											include('pt_docs_report_result.php');
										}else{
