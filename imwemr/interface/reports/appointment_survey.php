...
$dbtemp_name = "Appointment Survey";
                                    ...
                                    <div class="pd5" id="searchcriteria">
										...
										<div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <select name="provider[]" id="provider" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#common_drop">
                                ...
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
										...
										if($_POST['form_submitted']) {
											include('appointment_survey_result.php');
										}else{
