...
if(count($_POST['selectpatient']) > 0 && $_POST['print_pdf']>0){
	...
	include_once "../billing/print_prev_ub_form.php";	
}
?> 
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="practbox">
                                    ...
                                    <div class="pd5" id="searchcriteria">
										...
										<div class="row">
                                            ...
                                            <div class="col-sm-4">	
                                                <label>UB04 Type</label>
                                                <select name="PrintCms_chk" id="PrintCms_chk" class="selectpicker" data-width="100%" data-size="10" data-actions-box="true">
                                                	<option value="PrintCms" <?php if($_REQUEST['PrintCms_chk']=="PrintCms"){echo "selected";}?>>Print UB-04</option>
                                                    <option value="PrintCms_white" <?php if($_REQUEST['PrintCms_chk']=="PrintCms_white"){echo "selected";}?>>W/O UB-04</option>
                                            	</select>
                                            </div>
                                            <div class="col-sm-12">
												<div class="">
										...
										<?php
                                            if(empty($_POST['form_submitted']) === false){
                                                ...
                                                $qry = "select patient_data.lname,patient_data.fname, patient_data.mname,patient_data.id,
                                                        previous_ub.previous_ub_id,previous_ub.enc_balance,
														date_format(previous_ub.created_date,'$getSqlDateFormat') as createdDate
                                                        from previous_ub 		
                                                        join patient_data on patient_data.id = previous_ub.patient_id
                                                        where previous_ub.ub_satus  = '0'";
                                                if($patientId>0 && $_POST['txt_patient_name']!=""){
                                                    $qry .= " and previous_ub.patient_id = '$patientId'";
                                                }else{
                                                    if($Start_date != '' && $End_date != ''){
                                                        $qry .= " and previous_ub.created_date between 
                                                                '$StartDate' and '$EndDate'";
                                                    }
                                                }
                                                $qry .= " order by previous_ub.created_date desc,
                                                        previous_ub.previous_ub_id desc,
                                                ...
                                                <table class="rpt_table rpt rpt_table-bordered table" style="width:100%">
                                                    <tr>
                                                        ...
                                                        <td class="text_b_w text-center">Total Charges</td>
                                                    ...
                                                    <tr bgcolor="<?php echo $row['BG_COLOR']; ?>">
                                                        <td class="text_10">
                                                        	<label class="checkbox checkbox-inline pointer">
                                                                <input style="cursor:pointer;" type="checkbox" name="selectpatient[]" id="selectpatient_<?php echo $row['previous_ub_id'];?>" value="<?php echo $row['previous_ub_id'];?>">
                                                                <label for="selectpatient_<?php echo $row['previous_ub_id'];?>"></label>
                                                            </label>
                                                        </td>
                                                        <td class="text_10">
...
<script type="text/javascript">
	...
	function generate_pdf() {
		...
		if(sel == false){
			...
			alert('Please select any patient to print UB04.');
			return false;
		}else{
			$('#print_pdf').val(1);
