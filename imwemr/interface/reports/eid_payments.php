                                    ...
                                    <div class="pd5" id="searchcriteria">
										...
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<select name="Physician[]" id="Physician" data-container="#common_drop" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
												<?php echo $physicianName; ?>
												</select>
                                            </div>
											<div class="col-sm-6">
												<label>Facility</label>
												<select name="facility_name[]" id="facility_name"  data-container="#common_drop" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#sel_contianer" >
                                            ...
                                            <div class="col-sm-12 mt5">
                                                ...
                                                <input type="radio" name="DateRangeFor" id="dos" value="date_of_service"  <?php if ($_POST['DateRangeFor'] == 'date_of_service' || $_POST['DateRangeFor']=='') echo 'CHECKED'; ?> <?php echo ($temp_id && !isset($filter_arr['dos']))?'disabled':''; ?> />
                                                    <label for="dos">DOS</label>
                                                </div>

                                              <div class="radio radio-inline pointer">
                                                <input type="radio" name="DateRangeFor" id="dot" value="transaction_date" <?php if ($_POST['DateRangeFor'] == 'transaction_date' || $default_date_range_for=='transaction_date') echo 'CHECKED'; ?> <?php echo ($temp_id && !isset($filter_arr['dot']))?'disabled':''; ?> /> 
							...
							<div class="pd5 report-content">
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
                                        <?php
										if($_POST['form_submitted']) {
											include('eid_payments_result.php');
										}else{
