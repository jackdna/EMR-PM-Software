...
$facilityName = $CLSReports->getFacilityName($sc_name,'1');

//CSV NAME
$dbtemp_name = 'Allowable Verify';
                                ...
                                <div class="practbox">
                                    ...
                                    <div class="pd5" id="searchcriteria">
										...
										<div class="row">
											<div class="col-sm-6">
												<label>Groups</label>
												<select name="grp_id[]" id="grp_id" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#sel_contianer">
												<?php echo $groupName; ?>
												</select>
											</div>
											<div class="col-sm-6">
											...
											<div class="col-sm-6">
											  ...
											  <select name="crediting_provider[]" id="crediting_provider" data-size="10"  data-container="#sel_contianer" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
												  <?php echo $creditPhysicinName; ?>
											  </select>
											</div>											
											<div class="col-sm-6">
												<label>Facility</label>
												<select name="sc_name[]" id="sc_name" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#sel_contianer" >
											...
											<div class="clearfix"></div>
											<div class="col-sm-4">
												<label>Allowable Amt.</label>
												<select name="allowType" id="allowType" class="selectpicker" data-width="100%" data-container="#sel_contianer">
														<option value="unmatched"  <?php if ($_POST['allowType'] == 'unmatched') echo 'selected="selected"'; ?>>Un-Matched</option>
														<option value="all"  <?php if ($_POST['allowType'] == 'all') echo 'selected="selected"'; ?>>All</option>
												</select>
											</div>
											<div class="col-sm-8">
                                                <label>Period</label>
