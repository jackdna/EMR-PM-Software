							...
							<div class="pd5" id="searchcriteria">
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<select name="sortBy" id="sortBy" class="selectpicker" data-width="100%">
											<option value="patientName" <?php if ($_POST['sortBy'] == 'patientName') echo 'selected="selected"'; ?>>Patient name</option>
											<option value="DOS" <?php if ($_POST['sortBy'] == 'DOS') echo 'selected="selected"'; ?>>Date of Service</option>
											<option value="paymentDate" <?php if ($_POST['sortBy'] == 'paymentDate') echo 'selected="selected"'; ?>>Transaction order</option>
										</select>
									</div>
						...
						<div class="rptbox">
							<div id="html_data_div" class="row">
								...
								if($_POST['form_submitted']) {
									include('fd_collection_result.php');
								}else{
