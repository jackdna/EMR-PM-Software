...
$startArr = range(2005,date('Y'));
foreach($startArr as $key => $val){
	$sel = ($val == $_REQUEST['Start_year']) ? 'selected' : '';
	$startVal .= '<option value="'.$val.'" '.$sel.'>' . $val. '</option>';
}

$endArr = range(2005,date('Y'));
$sel_year =date('Y');
foreach($endArr as $key => $val){
	$sel = "";
	$sel = ($val == $sel_year) ? 'selected' : '';
	if($_REQUEST['End_year']){
		$sel = ($val == $_REQUEST['End_year']) ? 'selected' : '';
	}else{
		$sel = ($val == $sel_year) ? 'selected' : '';
	}
	$endVal .= '<option value="'.$val.'" '.$sel.'>' . $val. '</option>';
}
                    ...
                    <div class="row" id="row-main">
                        <div class="col-md-3" id="sidebar">
                            <div class="reportlft" style="height:100%;">
                                <div class="practbox">
                                    <div class="anatreport"><h2>Practice Filters</h2></div>
                                    <div class="clearfix"></div>
                                    <div class="pd5" id="searchcriteria" >
                                        <div class="row">
											<div class="col-sm-6">
												<label>Group</label>
												<select name="grp_id[]" id="grp_id" class="selectpicker" data-container="#select_drop" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
												<?php echo $groupName; ?>
												</select>
											</div>
											<div class="col-sm-6">
												<label>Provider</label>
												<select name="Physician[]" id="Physician" class="selectpicker" data-container="#select_drop" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
											...
											<div class="col-sm-6">
												...
												<select name="sc_name[]" id="sc_name" class="selectpicker" data-container="#select_drop" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
											...
											<div class="col-sm-4">
												...
												<select name="date_range_for" id="date_range_for" class="selectpicker" data-width="100%" data-size="10" data-actions-box="true" >
													<option value="DOS" <?php if ($_POST['date_range_for'] == 'DOS') echo 'SELECTED'; ?>>Date of Service</option>
													<option value="DOP" <?php if ($_POST['date_range_for'] == 'DOP') echo 'SELECTED'; ?>>Date of Payment</option>
													<option value="DOT" <?php if ($_POST['date_range_for'] == 'DOT') echo 'SELECTED'; ?>>Date of Transaction</option>
												</select>
											</div>
											<div class="col-sm-4">
												<label>From</label>
												<select name="Start_year" id="Start_year" class="selectpicker" data-width="100%" data-size="10" data-actions-box="true">
													<?php echo $startVal; ?>
												</select>
											</div>
											<div class="col-sm-4">
												<label>To</label>
												<select name="End_year" id="End_year"  class="selectpicker" data-width="100%" data-size="10" data-actions-box="true" >
													<?php echo $endVal; ?>
												</select>
											</div>
                                ...
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
										...
										if($_POST['form_submitted']) {
											include('yearly_report_result.php');
                                        }else {
