...
$dbtemp_name = "Appointment Report";
										...
										<div class="row">
											...
											<div class="col-sm-12">
												<div class="checkbox checkbox-inline pointer">
													<input type="checkbox" name="active_insurance" id="active_insurance" value="1" <?php if ($_POST['active_insurance'] == '1') echo 'CHECKED'; ?>/> 
													<label for="active_insurance">Display having active insurance</label>
												</div>
											</div>
										</div>
                                    </div>
                                ...
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
										...
										if($_POST['form_submitted']) {
											include('report_appt_result.php');
										}else{
