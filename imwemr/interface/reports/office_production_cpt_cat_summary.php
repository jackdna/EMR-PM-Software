...
if(sizeof($mainResArr)>0)
{
    ...
    foreach($mainResArr as $firstGrpId => $firstGrpData){	
		$printFile=true;
        $firstGrpName = $arrAllCptCats[$firstGrpId];
        ...
        $grandTotalAmtArr["ins_paid"]+= $insPaidAmt;
        $grandTotalAmtArr["pat_paid"]+= $patPaidAmt;
        $grandTotalAmtArr["total_paid"]+= $totalPaidAmt;
        $grandTotalAmtArr["adj_amt"]+= $adj_amt;
        $grandTotalAmtArr["refund_amt"]+= $refund_amt;
    ...
    <tr>
        ...
        <td class="text_b_w" style="text-align:center; width:'.$colWidth.'">Ins. Payment</td>
        <td class="text_b_w" style="text-align:center; width:'.$colWidth.'">Pat. Payment</td>
