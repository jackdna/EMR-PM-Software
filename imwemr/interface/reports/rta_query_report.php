...
$facility_id = array_combine($comboFac, $comboFac);
...
//--- GET OPERATORS NAME ---
$strOperator = implode(',',$_REQUEST['comboOperator']);
$oprName = $CLSCommonFunction->drop_down_providers($strOperator,'','');
$allOprCount = sizeof(explode('</option>', $oprName)) - 1;


$dbtemp_name = "RTA Query";
                                    ...
                                    <div class="pd5" id="searchcriteria">
										...
										<div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <select name="comboProvider[]" id="comboProvider" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#common_drop">
                                                    <?php echo $physicianName; ?>
                                                </select>
                                            </div>
                                            <div class="col-sm-4">
                                                <label>Facility</label>
                                                <select name="comboFac[]" id="comboFac" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#common_drop">
                                                    <?php echo $facilityName; ?>
                                                </select>
                                            </div>
											<div class="col-sm-4">
                                                <label>Operator</label>
                                                <select name="comboOperator[]" id="comboOperator" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#common_drop">
                                                    <?php echo $oprName; ?>
                                                </select>
                                            </div>
											<div class="col-sm-12">
