...
$dbtemp_name = "Patient Visit Info";
                                    ...
                                    <div class="pd5" id="searchcriteria">
										...
										<div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <select name="phyId[]" id="phyId" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#common_drop">
                                ...
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
										...
										if($_POST['form_submitted']) {
											include('patient_visit_info_result.php');
										}else{
...
<script type="text/javascript">
	...
	var btncnt=0;
	if(hasData==1){
		mainBtnArr[0] = new Array("download_csv", "Download CSV", "top.fmain.download_csv();");
		btncnt++;
	}
