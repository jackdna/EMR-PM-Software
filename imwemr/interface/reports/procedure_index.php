                            ...
                            <div class="reportlft" style="height:100%;">
										...
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<select name="rep_type" id="rep_type" class="selectpicker" data-width="100%" data-size="10" data-actions-box="true" onChange="displayOption(this);">
													...
													<option <?php if ($_POST['rep_type'] == 'date_range') echo 'SELECTED'; ?> value="date_range" data-value="<?php echo $_REQUEST['date_range'] ?>">Date Range</option>	
												</select>
                                            </div>
											<div class="col-sm-6">
												<div id="dy" style="display:block">
													<label>Select Date</label>
													<input type="text" class="form-control date-pick" onblur="checkdate(this);" size="11" name="rep_date_dy" id="rep_date_dy" value="<?php echo $rep_date_dy; ?>" />
												</div>
												...
												<label>Period</label><br />
													<div class="col-sm-6">
														<div class="input-group">
															<input type="text" name="date_from" placeholder="From" style="font-size: 12px;" onblur="checkdate(this);" id="date_from" value="<?php echo $_REQUEST['date_from']; ?>" class="form-control date-pick">
															<label class="input-group-addon" for="date_from"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></label>
														</div>
													</div>	
													<div class="col-sm-6">	
														<div class="input-group">
															<input type="text" name="date_to" placeholder="To" style="font-size: 12px;" onblur="checkdate(this);" id="date_to" value="<?php echo $_REQUEST['date_to']; ?>" class="form-control date-pick">
															<label class="input-group-addon" for="date_to"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></label>
														</div>
													</div>
												</div>   
											...
											<div class="col-sm-6">
                                                <label>Procedure (Primary)</label>
												<select name="rep_proc[]" id="rep_proc" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#select_drop">
												<?php echo $allProc; ?>
												</select>
                                            </div>
											<div class="col-sm-6">
											...
											<div class="clearfix"></div>
												...
												<div class="col-sm-12">
													<label class="checkbox checkbox-inline pointer">
														<input style="cursor:pointer; margin-left:2px" type="checkbox" name="display_cancelled" id="display_cancelled" value="1" <?php if ($_POST['display_cancelled'] == '1') echo 'CHECKED'; ?>/>
														<label for="display_cancelled">Display Cancelled</label>
													</label>
												</div>
											</div>
										</div>
                              ...
                              <div class="grpara">
                                ...
                                <div class="pd5" id="searchcriteria">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="radio radio-inline pointer">
                                        <input type="radio" name="viewBy" id="grpby_facility" value="facility" <?php if ($_POST['viewBy'] == 'facility' || $_POST['viewBy'] == '') echo 'CHECKED'; ?>/> 
                                    ...
                                    <div class="col-sm-4">
                                        <div class="radio radio-inline pointer">
                                        <input type="radio" name="viewBy" id="grpby_physician" value="physician" <?php if ($_POST['viewBy'] == 'physician') echo 'CHECKED'; ?>/> 
							...
							<div class="pd5 report-content">
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
                                        <?php
										if($_POST['form_submitted']) {
											include('procedure_report_print.php');
										}else{
...
<script type="text/javascript">
	...
	var processReport='<?php echo $process; ?>';
