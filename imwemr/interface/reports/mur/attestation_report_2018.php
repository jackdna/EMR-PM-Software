...
$arr_RecvSummaryCareRec2				= $objMUR->format_values($objMUR->ReceiveSummaryCareRec($commaptIDs));
$arr_RecvSummaryCareRec2['points'] 		= $objMUR->pointsMeasureWise('SummaryCareRec2',$objMUR->int_percent);
...
$arr_PtGeneratedHD			 			= $objMUR->format_values($objMUR->getPatientGeneratedHealthData($commaptIDs),0);
$arr_PtGeneratedHD['points'] 			= $objMUR->pointsMeasureWise('PGHD',$objMUR->int_percent);	
...
<table style="width:1020px;" cellpadding="5" cellspacing="0" border="0">
	<tr>
		...
		<td height="30px" align="center" style="font-size:14px;"><big><b>Promoting Interoperability ACI 2018</b></big></td>
...
<table cellspacing="0" rules="rows" style="text-align:left;">
	  ...
	  <tr>
		<td class="text_value botborder" colspan="2" style="width:680px;">Base e-Prescribing (eRx)</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Base Performance - Send Summary of Care</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Base Performance - Request/Accept Summary of Care</td>
		<td class="text_value botborder">&nbsp;</td>
		<td class="text_value botborder">'.$arr_RecvSummaryCareRec2['numerator'].'</td>
		<td class="text_value botborder">'.$arr_RecvSummaryCareRec2['denominator'].'</td>				
		<td class="text_value botborder">'.$arr_RecvSummaryCareRec2['percent'].'</td>
	  </tr>
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Base Performance - Provide Patient Access</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Base Security Risk Analysis</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Patients View their Personal Health Information (VDT)</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Secure Messaging</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Patient Generated Health Data</td>
		<td class="text_value botborder">&nbsp;</td>
		<td class="text_value botborder">'.$arr_PtGeneratedHD['numerator'].'</td>
		<td class="text_value botborder">'.$arr_PtGeneratedHD['denominator'].'</td>
		<td class="text_value botborder">'.$arr_PtGeneratedHD['percent'].'</td>
	  </tr>
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Clinical Information Reconciliation</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Patient Specific Education</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Immunization Registry Reporting</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Bonus Syndromic Surveillance Reporting</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Bonus IRIS Reporting</td>
		<td class="text_value botborder">&nbsp;</td>
