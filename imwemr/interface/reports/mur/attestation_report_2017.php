...
<table style="width:1020px;" cellpadding="5" cellspacing="0" border="0">
	<tr>
		...
		<td height="30px" align="center" style="font-size:14px;"><big><b>Promoting Interoperability Transition 2018</b></big></td>
...
<table cellspacing="0" rules="rows" style="text-align:left;">
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Base Performance - Provide Summary of Care Record Electronically (HIE)</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Base Performance - Provide Patient Access to their PHI</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Medication Reconciliation</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Performance Patients View their Personal Health Information</td>
		<td class="text_value botborder">&nbsp;</td>
	  ...
	  <tr>
		<td align="left" class="text_value botborder" colspan="2">Bonus Report Improvement Activities That Utilized CEHRT</td>
		<td class="text_value botborder">&nbsp;</td>
		<td class="text_value botborder">'.$str_iatuc.'</td>
		<td class="text_value botborder">&nbsp;</td>				
		<td class="text_value botborder">&nbsp;</td>
	  </tr></table>
	  ';
...
//echo '<br><br>';
//echo $html_block3;
$strHTML = $styles.$html_block1;//.'<br><br><br><br><b>Physician</b><br><table cellspacing="0">';
foreach($arr_physician_details as $user_rs){
			$createdFor	= '<tr><td width="auto" nowrap>'.$user_rs['pro_title'].' '.$user_rs['fname'].' '.$user_rs['lname'].' '.$user_rs['pro_suffix'].'</td><td width="200">_____________________________</td></tr>';
		//	$strHTML .= $createdFor;
		}
//$strHTML .= '</table>';
