...
?>
<form name="frm_mur_report" id="frm_mur_report" action="mur/attestation_report_2020.php" method="post" target="_blank">
...
if($objMUR->taskNum==1 || $objMUR->taskNum==3 || $objMUR->taskNum==4){
	...
	$arr_SummaryCareRec2			= $objMUR->format_values($objMUR->SendSummaryCareRec2020($commaptIDs,'m2'),10,'nored');
	$arr_SummaryCareRec2['points'] 	= $objMUR->pointsMeasureWise('SummaryCareRec2',$objMUR->int_percent);

	$arr_MedReconcil			= $objMUR->format_values($objMUR->getMedReconcil2020($commaptIDs),50);
	$arr_MedReconcil['points'] = $objMUR->pointsMeasureWise('MedRecon',$objMUR->int_percent);

	$arr_TimelyPtElectHlthInfo	= $objMUR->format_values($objMUR->getTimelyPtElectHlthInfo2020($commaptIDs),50); //pt.electronic access, measure1
    ...
    <table class="table table-bordered table-hover text-center">
      ...
      <tbody>
<?php if($objMUR->taskNum==3){echo '<tr><th>MEASURE</th><th style="font-size:9px;">Actual/(Required)</th><th style="font-size:9px;" title="Percentage of ptients you require more to achieve the measure threshold">Actual/(Required)</th><th class="bg4">&nbsp;</th><th class="bg4" align="center" style="font-size:9px;" title="Number of patients you require more to achieve the measure threshold">Actual/(Required)</th><th class="bg4">&nbsp;</th></tr>';}?>
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name" title="# of Prescriptions">e-Prescribing</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name" title="# of Transitins of Care/Referrals">Support Electronic Referral Loops by Sending Health Information</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name" title="# of Encounters received with Summary of Care Records">Support Electronic Referral Loops by Receiving and Incorporating Health Information</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name" title="# of Unique patients">Provide Patients Electronic Access to their Health Information</td>
