...
?>
<form name="frm_mur_report" id="frm_mur_report" action="mur/attestation_report_2018.php" method="post" target="_blank">
...
//	$arr_EPrescribe 				= $objMUR->format_values($objMUR->getEPrescribe($commaptIDs),50);
//pre($objMUR->getEPrescribe($commaptIDs));
...
//pre($objMUR->getPatientSecureMessaging($commaptIDs));
...
<?php if($objMUR->taskNum==3){echo '<tr><th>MEASURE</th><th style="font-size:9px;">Actual/(Required)</th><th style="font-size:9px;" title="Percentage of ptients you require more to achieve the measure threshold">Actual/(Required)</th><th class="bg4">&nbsp;</th><th class="bg4" align="center" style="font-size:9px;" title="Number of ptients you require more to achieve the measure threshold">Actual/(Required)</th><th class="bg4">&nbsp;</th></tr>';}?>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name">Base  Performance - Send Summary of Care</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name">Base  Performance - Request/Accept Summary of Care</td>
        <td id="td_num_summofcare"><?php echo $arr_RecvSummaryCareRec2['numerator'];?></td>
        <td><?php echo $arr_RecvSummaryCareRec2['denominator'];?></td>
        <td><?php echo $arr_RecvSummaryCareRec2['percent'];?></td>
        <!--<td><?php echo $arr_RecvSummaryCareRec2['points'];?></td>-->
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name">Base  Performance – Provide Patient Access</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name">Performance  Patients View their Personal Health Information (VDT)</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name">Performance Patient Generated Health Data</td>
        <td id="td_num_pghd"><?php echo $arr_PtGeneratedHD['numerator'];?></td>
        <td><?php echo $arr_PtGeneratedHD['denominator'];?></td>
        <td><?php echo $arr_PtGeneratedHD['percent'];?></td>
        <!--<td><?php echo $arr_PtGeneratedHD['points']; $total_performance_points +=intval($arr_PtGeneratedHD['points']); ?></td>-->
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td class="text-left measure_name">Performance Clinical Information Reconciliation</td>
