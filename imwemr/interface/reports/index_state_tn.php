...
$dbtemp_name = 'TN State Report';
//CSV NAME
$dbtemp_name_CSV= strtolower(str_replace(" ", "_", $dbtemp_name)).".csv";

$report_file_name	= "ub_txt.php";	
if($_POST['form_submitted']) {
	$report_type		= $_REQUEST['report_type'];
	if($report_type == "ub") {
		$report_file_name	= "ub_txt.php";	
	}elseif($report_type == "hcfa") {
		$report_file_name	= "hcfa_txt.php";	
	}elseif($report_type == "electronic") {
		$report_file_name	= "electronic_txt.php";	
	} 
}
?>
<!DOCTYPE html>
								...
								<div class="grpara">
                                    ...
                                    <div class="pd5" id="searchcriteria">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio radio-inline pointer">
                                                    <input type="radio" name="report_type" id="report_type_electronic" value="electronic" <?php if ($_POST['report_type'] == 'electronic') echo 'CHECKED'; ?>/> 
                                                    <label for="report_type_electronic">Electronic & Paper</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
