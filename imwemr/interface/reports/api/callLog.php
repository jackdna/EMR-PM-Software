...
$physicianName = $CLSCommonFunction->drop_down_api_users($strSelPhysician);
 
// Template field value form database
$dbtemp_name = "API Call Log";
                            ...
                            <div class="reportlft" style="height:100%;">
                                <div class="practbox">
                                    ...
                                    <div class="pd5" id="searchcriteria" >
										<div class="row">
                                            <div class="col-sm-4">
                                                <label>API User(s)</label>
                                                <select name="apiUsers[]" id="apiUsers" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
										...
										<div class="row">
											<div class="col-sm-12">	
												<label>Token</label>
												<input type="text" name="APIToken" style="font-size: 12px;" id="APIToken" class="form-control">
												<br />
											</div>
										</div>
                                    </div>
...
<script type="text/javascript">
	...
	{
		var parameters = {reportType:'CallLog'};
		
		if( $('#apiUsers').val() !== null )
			parameters.apiUsers = $('#apiUsers').val();
		...
		parameters.APIToken = $('#APIToken').val();
		
		$.ajax({
			url: '<?php echo $GLOBALS['php_server']; ?>/interface/reports/api/ajax.php',
			method: 'POST',
			data: parameters,
			beforeSend: function()
			{
