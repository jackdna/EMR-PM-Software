...
while ($row = imw_fetch_array($insGroupQryRes)) {
    ...
    if (imw_num_rows($res) > 0) {
        ...
        if (in_array($grp_ins_ids, $insuranceGrp) === true) $selected = 'selected';
                                    ...
                                    <div class="pd5" id="searchcriteria">
                                        <div class="row">
											<div class="col-sm-6">
												...
												<select name="insuranceGrp[]" id="insuranceGrp" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All" data-container="#sel_contianer">
                                        ...
                                        <div class="row">
											<div class="col-sm-4">
                                                <div class="radio radio-inline pointer">
                                                    ...
                                                    <label for="output_pdf">View</label>
                                                </div>
                                            </div>                                                
											<div class="col-sm-4">
                                                <div class="radio radio-inline pointer">
							...
							<div class="pd5 report-content">
                                <div class="rptbox">
                                    <div id="html_data_div" class="row">
                                        <?php
										if($_POST['form_submitted']) {
											include('unbilled_claims_result.php');
										}else{
