<?php
	...
	$arrPhpVar['ajaxUrl'] = $GLOBALS['webroot'].'/interface/reports/cqm_import/ajax.php';
	$arrPhpVar['dateFormat'] = 'm-d-Y';
	$arrPhpVar['rootUrl'] = $GLOBALS['webroot'].'/interface/reports/cqm_import/';
...
<html>
	...
	<body>
		...
		<script src="<?php echo $library_path; ?>/js/cqm_import.js" type="text/javascript"></script>
	</body>
</html>