...
if(sizeof($mainResArr)>0)
{
    ...
    foreach($mainResArr as $firstGrpId => $firstGrpData){	
        ...
        foreach($firstGrpData as $cptId => $cptDataArr)
        {
            ...
            {	
                ...
                //ARRAY GRAND TOTAL 
                $grandTotalAmtArr["units"]+= $units;
                $grandTotalAmtArr["avg_units"]+= $avgUnitsPerDay;
                $grandTotalAmtArr["charges"]+= $charges;
                $grandTotalAmtArr["avg_charges"]+= $avgChargesPerDay;
