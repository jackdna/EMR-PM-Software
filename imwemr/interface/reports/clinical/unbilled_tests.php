...
//TEST NAMES
$qry = "select id,test_name from tests_name order by test_name";
$rs = imw_query($qry);
$testNames = "";
while ($res = imw_fetch_array($rs)) {
	$sel='';
	if($test_names[$res['test_name']])$sel='SELECTED';
    $testNames .= '<option value="'.$res['test_name'].'" '.$sel.'>' .addslashes($res['test_name']). '</option>';
}
$allTestCount = sizeof(explode('</option>', $testNames)) - 1;
                  	...
                  	<div class="reportlft">
                        ...
                        <div class="pd5" id="searchcriteria">
                            ...
                            <div class="col-sm-6">
                              ...
                              <select name="test_names[]" id="test_names" data-container="#select_drop" class="selectpicker" data-width="100%" data-size="10" multiple data-actions-box="true" data-title="Select All">
                                  <?php echo $testNames; ?>
                              </select>
                            </div>                            
                            ...
                            <div class="pd10 report-content">
                                <div class="rptbox">
                                    <div id="html_data_div" class="row" >
                                        <?php
                                        if($_POST['form_submitted']) {
											include('unbilled_tests_result.php');
										}else{
