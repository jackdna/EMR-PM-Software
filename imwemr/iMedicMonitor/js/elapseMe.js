...
var elapseMe = 	(function elapseTimer(settings)
	{
		...
		if(settings.show.match(/hhmmss/gi)){
			elapsedHours1 = (elapsedHours<10) ? '0'+elapsedHours : elapsedHours;
			elapsedMinutes1 = elapsedMinutes<10 ? '0'+elapsedMinutes : elapsedMinutes;
			elapsedSeconds1 = elapsedSeconds<10 ? '0'+elapsedSeconds : elapsedSeconds;
			resultOut = elapsedHours1+':'+elapsedMinutes1+':'+elapsedSeconds1;
		}
