...
scrollTH:		0, 10 height
percentCovered:	0, 25 percent
***/
jQuery.fn.dragToSelect = function (conf) {
	...
	var showSelectBox = function (e) {
		...
		//Passed event in the function below to access the clicked target element details
		config.onShow(e);
	};
	...
	parent
		.mousedown(function (e) {
			...
			if ((e.pageX + 20) > jQuery(document.body).width() || e.button==2) {
				return;
			}
