		...
		return {
			...
			insert: function()
			{
				...
				var rows = $('#redactor-table-rows').val(),
					...
					$table = $('<table id="table' + tableId + '" style="width: 100%; table-layout:fixed;"><tbody></tbody></table>'),
					i, $row, z, $column;
				...
				for (i = 0; i < rows; i++)
				{
					...
					for (z = 0; z < columns; z++)
					{
						$column = $('<td style="width:'+ Math.floor(620/columns) +'px; padding-left: 2px; vertical-align: top;"> ' + this.opts.invisibleSpace + '</td>');
																	//^ this 625 is the amount of pixels printed on a standard page.
