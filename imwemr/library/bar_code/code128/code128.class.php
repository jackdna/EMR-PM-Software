...
class phpCode128 {
	...
	function __construct($text = '', $height = 150, $font = false, $font_size = false) {
...
function generate_barcode($Barcode_Text,$img_name,$barCodeImgPath='')
{
	//if(!$barCodeImgPath) { $barCodeImgPath = '../../common/new_html2pdf/bar_code_images/'.$img_name.'.png'; }
	$barcode = new phpCode128($Barcode_Text, 120, '', '');
	...
	$barcode->setTextSpacing(0);
	$barcode->saveBarcode($barCodeImgPath);
}
?>