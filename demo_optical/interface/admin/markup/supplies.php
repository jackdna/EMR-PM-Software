...
/*Manufacturers List*/
$manufacturers = array();
$sql_manuf = 'SELECT `id`, `manufacturer_name` AS \'name\' FROM `in_manufacturer_details` WHERE `del_status`=0 AND `supplies_chk`=1 ORDER BY `manufacturer_name` ASC';
...
<div class="tab_container" style="float:left; width:100%;margin:10px 0 0 0;">
	<h3 class="listheading" style="margin-top:0;">Supplies Retail Price Markup</h3>
...
function saveFormula(resp){
	var formData = {action: 'saveData', updateItems: resp};
