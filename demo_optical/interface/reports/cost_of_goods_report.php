<?php
/*
File: cost_of_goods_report.php
Coded in PHP7
Purpose: Cost of Goods Report Searching Criteria
...
{
	var url = '<?php echo $GLOBALS['WEB_PATH'];?>/interface/reports/cost_of_goods_result.php?print=true';
	try 
	{
...
<body> 
    <div class="mt2" style="height:<?php echo $_SESSION['wn_height']-360;?>px;">
        ...
        <div id="searchPart" class="border_rounded" style="width:99.7%; height:auto;">
           <div class="listheading border_top_left border_top_left">Cost of Goods Report</div>
           <form name="searchForm" id="searchForm" method="post" action="" style="margin:0px;">
            <table class="table_collapse m2 rptDropDown">
                <tr style="height:43px">
				  ...
				  <td>
                      <select name="faclity" id="faclity" style="width:160px;">
							...
							<?php $fac_name_qry = imw_query("select id, loc_name from in_location where del_status='0' and loc_name!='' order by loc_name asc");
								  ...
								  ?>
							<option value="<?php echo $fac_name_row['id']; ?>"><?php echo $fac_name_row['loc_name']; ?></option>
							<?php } ?>
						</select>
                      <div class="label">Facility(From order generated)</div>
                  </td>
				  <td>
                      <select name="product_type" id="product_type" style="width:140px">
                        <option value="">- Select -</option>
                        <?php 
        ...
        <iframe src="cost_of_goods_result.php" name="frame_result" id="frame_result" style="width:99.7%; height:<?php echo $_SESSION['wn_height']-454;?>px; margin:0px; margin-top:3px; display:block; overflow-x:hidden; overflow-y:scroll; border:1px solid #BCBCBC" frameborder="0" framespacing=0 scrolling="yes"></iframe>
    </div>
</body>
</html>