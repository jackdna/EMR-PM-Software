<?php
/*
File: return_order.php
Coded in PHP7
Purpose: Return Order Report Searching Criteria
...
function submitForm(){
	...
	postFrmObj.status.value = $('#status').val();
...
{
	var url = '<?php echo $GLOBALS['WEB_PATH'];?>/interface/reports/return_order_result.php?print=true';
	try 
	{
...
<body> 
    <div class="mt2" style="height:<?php echo $_SESSION['wn_height']-360;?>px;">
        ...
        <div id="searchPart" class="border_rounded" style="width:99.7%; height:auto; height:75px;">
           <div class="listheading border_top_left border_top_left">Report - Return Order</div>
           <form name="stockForm" id="stockForm" method="post" action="" style="margin:0px;">
            <table class="table_collapse m2 rptDropDown">
                <tr>
					<td>
                      <select name="product_type" id="product_type" style="width:170px">
                  ...
                  <td>
                      <select name="faclity" id="facility" style="width:170px;">
				  ...
				  <td align="left">
				  	<select name="status" id="status" style="width:187px;">
        ...
        <iframe src="return_order_result.php" name="frame_stock" id="frame_stock" style="width:99.7%; height:<?php echo $_SESSION['wn_height']-440;?>px; margin:0px; margin-top:3px; display:block; overflow-x:hidden; overflow-y:scroll; border:1px solid #BCBCBC" frameborder="0" framespacing=0 scrolling="yes"></iframe>
    </div>
</body>
</html>