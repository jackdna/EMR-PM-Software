...
$(document).ready(function(){
	...
	$("#source").multiSelect({noneSelected:'Select All'});
...
function submitForm(){
	...
	postFrmObj.source.value = $('#source').selectedValuesString();
	postFrmObj.t_type.value = curFrmObj.t_type.value;
...
{
	var url = '<?php echo $GLOBALS['WEB_PATH'];?>/interface/reports/stock_ledger_result.php?print=true';
	try 
	{
...
<body> 
    <div class="mt2" style="height:<?php echo $_SESSION['wn_height']-360;?>px;">
        ...
        <div id="searchPart" class="border_rounded" style="width:99.7%; height:auto; height:120px;">
           <div class="listheading border_top_left border_top_left">Report - Stock Ledger</div>
           <form name="stockForm" id="stockForm" method="post" action="" style="margin:0px;">
            <table class="table_collapse m2 rptDropDown">
                <tr>
                  ...
                  <td>
                      <select name="operators" id="operators" style="width:140px">
                        <option value="">- Select -</option>
						<?php 
						  $userOptions=''; 
                ...
                <tr>
                  ...
                  <td>
                  <select name="source" id="source" style="width:155px">
				  ...
				  <td>
                  <select name="t_type" id="t_type" style="width:155px">
                    <option value="all">All</option>
                    <option value="minus">Only Reduction</option>
                    <option value="add">Only Addition</option>
                  </select>
        ...
        <iframe src="stock_ledger_result.php" name="frame_stock" id="frame_stock" style="width:99.7%; height:<?php echo $_SESSION['wn_height']-485;?>px; margin:0px; margin-top:3px; display:block; overflow-x:hidden; overflow-y:scroll; border:1px solid #BCBCBC" frameborder="0" framespacing=0 scrolling="yes"></iframe>
    </div>
</body>
</html>