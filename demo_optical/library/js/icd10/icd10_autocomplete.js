		...
		response: function( event, ui){
			...
			if(flg_LitSev){
				...
				if(rr!=""){		
					...
					if(typeof(js_icd_data_arr[final_dx_val])!="undefined"){
					...
					cn_typeahead();
					var SeverityArr =  ["Mild", "Moderate", "Severe", "Indeterminate", "Unspecified"];
						...
						if(fldid.indexOf("elem_assessment_dxcode")!=-1){							
							...
							for(var t1=0;t1<lentt;t1++){
								if(typeof(ar_tt_as_v_op[t1])!="undefined"&&ar_tt_as_v_op[t1]!=""){
									...
									if((ar_tt_as_v_op_last[0]=="Right" || ar_tt_as_v_op_last[0]=="Left" || ar_tt_as_v_op_last[0]=="Both") && typeof(ar_tt_as_v_op_last[1])=="undefined"){
