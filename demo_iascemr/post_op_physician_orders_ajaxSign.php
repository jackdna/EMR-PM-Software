...
include_once("common/commonFunctions.php");
	...
	//SAVE USER SIGNATURE
			...
			$signSurgeon1DateTimeFormatNew=$signNurse1DateTimeFormatNew=$signNurse2DateTimeFormatNew="";
			...
			$signNurse2DateTimeFormatNew = $objManageData->getFullDtTmFormat($signDateTime);
		//GET USER NAME
...
//END GET FIELD NAME ACCORDING TO USER IDENTITY			
			...
			//CODE TO REMOVE SIGNATURE
				if($delSign=="yes") {
					...
					$postSurgeonSignBckGroundColorAjax=$chngBckGroundColorAjax;//DEFINED IN  common/commonFunctions.php TO INDICATE MANDATORY FIELD
					$postNurseSignBckGroundColorAjax=$chngBckGroundColorAjax;//DEFINED IN  common/commonFunctions.php TO INDICATE MANDATORY FIELD
					$loggedInUserId="";
			...
			$SaveSignQry = "update `postopphysicianorders` set 
	...
	?>
			<a href="javascript:void(0);" class="sign_link" style="cursor:pointer;<?php echo $postSurgeonSignBckGroundColorAjax?>;" onClick="javascript:<?php echo $callJavaFunSurgeon;?>"> Surgeon Signature </a>
	<?php	
		}else {
	...
	?>
			<a href="javascript:void(0);" class="sign_link" style="cursor:pointer;<?php echo $postNurseSignBckGroundColorAjax?>;" onClick="javascript:<?php echo $callJavaFun;?>"> Nurse Signature </a>
	<?php	
		}else {
	...
	?>
            ...
            <span class="rob full_width"> <b> Signature Date</b> <span class="dynamic_sig_dt" data-field-name="signNurseDateTime" data-table-name="postopphysicianorders" data-id-value="<?=$_REQUEST["pConfId"]?>" data-id-name="patient_confirmation_id"> <?php echo $signNurse1DateTimeFormatNew;  echo' <span class="fa fa-edit"></span>'; ?> </span></span>
	<?php
		}
	}else if($userIdentity == "Nurse2") {
	
		if($delSign=="yes") {
			$callJavaFun = "document.frm_post_op_phys.hiddSignatureId.value='TDnurseSignatureId1'; return displaySignature('TDnurseNameId1','TDnurseSignatureId1','post_op_physician_orders_ajaxSign.php','$loginUserId','Nurse2');";
	?>
	...
	<?php	
			...
			$callJavaFunDel = "document.frm_post_op_phys.hiddSignatureId.value='TDnurseNameId1'; return displaySignature('TDnurseNameId1','TDnurseSignatureId1','post_op_physician_orders_ajaxSign.php','$loginUserId','Nurse2','delSign1');";
	?>
			<span class="rob full_width"><a href="javascript:void(0);" class="sign_link" style="cursor:pointer;" onClick="javascript:<?php echo $callJavaFunDel;?>"> <?php echo "<b>Nurse:</b>". " ". $loggedInUserName; ?> </a></span>	     
            <span class="rob full_width"> <b> Electronically Signed </b> <?php echo $signOnFileStatus;?></span>
            <span class="rob full_width"> <b> Signature Date</b> <span class="dynamic_sig_dt" data-field-name="signNurse1DateTime" data-table-name="postopphysicianorders" data-id-value="<?=$_REQUEST["pConfId"]?>" data-id-name="patient_confirmation_id"> <?php echo $signNurse2DateTimeFormatNew;  echo' <span class="fa fa-edit"></span>'; ?> </span></span>
	<?php
		}
	}
	?>
