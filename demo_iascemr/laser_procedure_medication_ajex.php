...
$objManageData = new manageData;
	...
	$preOpPhysicianOrdersIdQry=("select * from laser_procedure_patient_table where confirmation_id ='$pConfId'");
	$preOpPhysicianOrdersIdRes=imw_query($preOpPhysicianOrdersIdQry);
	$Id=imw_fetch_array($preOpPhysicianOrdersIdRes);
	$PreOpPhysicianOrdersId=$Id['laser_procedureRecordID'];
	...
	imw_query("INSERT INTO 
				laserprocedure_medication_tbl set	
				medicationName = '$preDefined',
				laserproOrderId='$PreOpPhysicianOrdersId',
				strength  = '$strength', 
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="460">
                                    ...
                                    <?php
											...
											<td width="203" align="left" class="text_10b">
												...
												<!-- <input type="text" size="8" name="startTimeVal[]" id="bp_temp2" onKeyUp="displayText2=this.value" onclick="getShowNewPos(250,350,'flag2');clearVal_c();" value="<?php  echo $medicationStartTimeVal; ?>" > -->
											</td>
