...
?>
<?php
	function getAppletImage($id,$tblName,$idFieldName,$pixelFieldName,$imgPath,$alt='Image Here')
	{
		//echo "imgGd.php?id=$id&tbl=$tblName&pixelField=$pixelFieldName&idField=$idFieldName&imgName=$imgPath";
		return "<img src=\"imgGdSC.php?id=$id&tbl=$tblName&pixelField=$pixelFieldName&idField=$idFieldName&imgName=$imgPath\" alt=\"$alt\">";
	}
	function createAppletImage($id,$tblName,$idFieldName,$pixelFieldName,$imgPath,$pathSave,$alt='Image Here')
	{
				include("imgGd.php");
