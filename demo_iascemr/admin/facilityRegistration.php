		...
		<tr >
			<td valign="top" align="center" >
                    ...
                    <div id="tdFrameUserRegistration" style="width:100%" class="row padding_o clear"> 
							<iframe id="userFrame" name="iFrameUserRegistration" width="100%" scrolling="no" frameborder="0" align="top" src="listFacility.php"></iframe>
				</div>
...
<form name="frmGetUserInfo" action="" method="post">
	<input type="hidden" name="elem_frmAction" value="Get Facility Info">
