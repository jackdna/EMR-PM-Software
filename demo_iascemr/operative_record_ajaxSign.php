...
//END GET FIELD NAME ACCORDING TO USER IDENTITY			
	...
	$SaveSignQry = "update `operativereport` set 
	...
	?>
            ...
            <span class="rob full_width"> <b> Signature Date</b> <span class="dynamic_sig_dt" data-field-name="signSurgeon1DateTime" data-table-name="operativereport" data-id-value="<?=$_REQUEST["pConfId"]?>" data-id-name="confirmation_id"> <?php echo $signSurgeon1DateTimeFormatNew;  echo' <span class="fa fa-edit fa-editsurg"></span>'; ?> </span></span></span>
	<?php
		}
	}
	?>
