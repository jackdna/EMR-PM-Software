...
var actb_prtDiv="";
function actb(obj,ca,sfw,fclr,objHidden,objHiddenVal,cptPOS,objHidden2,objHiddenVal2){
	/* ---- Public Variables ---- */
	...
	*/
	...
	function actb_generate(){
		...
		if(cptPOS!="pos"){			//	for set position in Billing - > CPT Codes
			//a.style.top = setTypeAheadTopPosition(actb_curr,a)+"px";alert(a.style.top);
		}
		//makeShowDiv();
		//Test
	...
	function actb_insertword(a,hiddenVal,hiddenVal2){
		if (actb_self.actb_delimiter.length > 0){
			str = '';
			l=0;
	...
	function actb_penter(){
		...
		actb_insertword(word,hiddVal,hiddVal2);
