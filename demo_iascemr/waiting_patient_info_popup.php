...
$patient_dob='';
if($patient_in_waiting_id) {
	$stubTableDetails = $objManageData->getRowRecord('patient_in_waiting_tbl', 'patient_in_waiting_id', $patient_in_waiting_id);
	...
	$patient_prim_proc = stripslashes(trim($stubTableDetails->patient_primary_procedure));
	$patient_home_phone = $stubTableDetails->patient_home_phone;
	$patient_work_phone = $stubTableDetails->patient_work_phone;
	$comment = $stubTableDetails->comment;
	$patient_id = $stubTableDetails->patient_id;
}	
//END VIEW RECORD OF WAITING PATIENT
?>

<style>
	.text_10 { font-family:"verdana"; font-size:9px; color:#000000; font-weight:normal;}
	.text_10b { font-family:"verdana"; font-size:9px; color:#000000; font-weight:bold;  }
	.text_10b1 { font-family:"verdana"; font-size:10px; color:#000000; font-weight:bold;  }
	.pad_top_bottom{padding-bottom:0px;padding-top:0px;}
	input.checkbox, input.radio{ width:23px;height:23px;margin:0px 0 0 0px; white-space:nowrap;   }
	form li div,form li span{ margin:0 0 0 0;padding:0 0 0 0; }
</style>
...
function  redirect_page(pagename) {
	var ask = confirm("Are you sure to cancel.")
	if(ask==true){
		location.href='home.php?cancelConfirm=true';
	}
}
...
<div id="WaitingPatientSubIdDiv" style="position:static; display:<?php echo $WaitingPatientIdSubDivDisplay;?> width:100%;overflow:hidden; vertical-align:top; ">
 -->
 <table align="left"  bgcolor="#ECF1EA" onDblClick="closePreDefineDiv()" onMouseOver="closePreDefineDiv();"  width="455" height="270"  border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td valign="top">
			<table cellpadding="0" cellspacing="0" align="left" width="100%">
				<form name="frm_waiting_patient" class="wufoo topLabel" enctype="multipart/form-data" method="post" style="margin:0px; " action="" onSubmit="return validtion_pt_confirm();">
				<input type="hidden" name="patient_in_waiting_id" value="<?php echo $_REQUEST['patient_in_waiting_id']; ?>">
				<input type="hidden" name="pt_wait_submit" value="Save">
				<tr>
					<td><img src="images/tpixel.gif" width="1" height="2"></td>
				</tr>
				
				<tr>
					<td class="text_10b" width="100%">
								...
								<td>
									<table border="0"  width="99%" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="all_border ">
										<tr>
											...
											<li class="" id="fo65li7">
												<label class="text_10b" id="title7" style="background:background-color:#F1F4F0;">Name</label>
												...
												<span class="text_10" style=" vertical-align:top;padding-left:8;margin:0px 0 0 0px;  white-space:nowrap;">
													<i class="text_10" style="font-size:9px; vertical-align:top; ">First Name</i>
													<img src="images/tpixel.gif" width="2" height="1">
													<i class="text_10" style="font-size:9px;vertical-align:top; ">MI</i>
													<img src="images/tpixel.gif" width="9" height="1">
													<i class="text_10" style="font-size:9px;vertical-align:top; ">Last Name</i>
												</span>
											</li>
											
											
											<li class="" id="fo65li7" >
												<label class="text_10b" id="title7"  style="background:background-color:#F1F4F0; white-space:nowrap;">Primary Procedure</label>
												<span class="text_10" style="background:background-color:#F1F4F0; height:20px;padding-left:8;">
													<select name="prim_proc" class="field text_10"  style="width:130px;border:1px solid #cccccc;">
											...
											<li class="" id="fo65li7" style="margin:0 4px 0 8px;padding:0 0 8px 0; ">
												<label class="text_10b" id="title7"  >Address</label>
												<span class="text_10" style="margin:0 4px 0 8px;padding:0 0 8px 0; " >
													<textarea id="address1_id" name="address1" class="field textarea large text_10" style="font-family:verdana; border:1px solid #cccccc; width:120px; height:15; " rows="1" cols="50" tabindex="6"  ><?php echo stripslashes($patient_address1);?></textarea>
													<i class="text_10" style="font-size:9px;vertical-align:top; ">Address1</i> </span> <span class="text_10" style="margin:0 4px 0 8px;padding:0 0 8px 0; ">
													<textarea id="address2_id" name="address2" class="field textarea large text_10" style="font-family:verdana; border:1px solid #cccccc; width:120px; height:15; " rows="1" cols="50" tabindex="6"  ><?php echo stripslashes($patient_address2);?></textarea>
													<i class="text_10" style="font-size:9px;vertical-align:top; ">Address2</i> </span> <span class="text_10" style="padding-left:8; margin:0 0 0 0; vertical-align:top;  white-space:nowrap; ">
												...
												<span class="text_10" style=" vertical-align:top;padding-left:8;  white-space:nowrap;">
												<i class="text_10" style="font-size:9px;vertical-align:top;">City</i>
												<img src="images/tpixel.gif" width="30" height="1">
												<i class="text_10" style="font-size:9px;vertical-align:top;">State</i>
												<img src="images/tpixel.gif" width="2" height="1">
												<i class="text_10" style="font-size:9px;vertical-align:top;">Zip</i>
												</span>
											</li></ul>
											</td>
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													<tr>
														...
														<ul>
															...
															<li class="" id="fo65li7">
																<label class="text_10b" id="title7" style="background:background-color:#F1F4F0;white-space:nowrap;">Surgery Time</label>
																<span class="text_10" style="background:background-color:#F1F4F0;padding-left:8;height:15px;white-space:nowrap;">
																...
																<span class="text_10" style=" vertical-align:top;padding-left:8;margin:0px 0 0 0px;  white-space:nowrap;">
																	<i class="text_10" style="font-size:9px; vertical-align:top; ">HH:MM AM/PM</i>
																	<img src="images/tpixel.gif" width="40" height="1">
																	<i class="text_10" style="font-size:9px;vertical-align:top; "></i>
																	<img src="images/tpixel.gif" width="30" height="1">
																	<i class="text_10" style="font-size:9px;vertical-align:top; "></i>
																</span>
															</li>
															<li class="" id="fo65li7">
																<label class="text_10b" id="title7" style="background:background-color:#F1F4F0;white-space:nowrap;">Surgeon Name</label>
																<span class="text_10" style="background:background-color:#F1F4F0;padding-left:8;margin:0px 0 0 0px; white-space:nowrap;height:15px;">
																	<select name="surgeon_name_id" class="field text_10"  style="width:100px;border:1px solid #cccccc;">
															...
															<li class="" id="fo65li7" >
																<label class="text_10b" id="title7" style="background:background-color:#F1F4F0; ">DOS</label>
																<span class="text_10" style="background:background-color:#F1F4F0;padding-left:8; height:15px;white-space:nowrap;">
																...
																<span class="text_10" style=" vertical-align:top;padding-left:8;margin:0px 0 0 0px;  white-space:nowrap;">
																	<i class="text_10" style="font-size:9px; vertical-align:top; ">MM-DD-YYYY</i>
																</span>
															</li>
																<li class="" id="fo65li7">
																	<label class="text_10b" id="title7" style="background:background-color:#F1F4F0;white-space:nowrap; ">Home Phone</label>
																	<span class="text_10" style="background:background-color:#F1F4F0;height:15px;padding-left:8;">
																...
																<li class="" id="fo65li7" >
																	<label class="text_10b" id="title7" style="background:background-color:#F1F4F0; ">Comments</label>
																	<span class="text_10" style="background:background-color:#F1F4F0;padding-left:8;height:15px;">
																		<textarea id="iOLinkCommentId" name="comment" class="field textarea large text_10" style="font-family:verdana; border:1px solid #cccccc; width:120px; height:15; " rows="1" cols="50" tabindex="6"  ><?php echo stripslashes($comment);?></textarea>
																	</span>
																</li>
															</ul>
														</td>
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													<tr>
														<td valign="top" bgcolor="#F1F4F0">
															...
															<ul>
																<li class="" id="fo65li7">
																	<label class="text_10b" id="title7" style="background:background-color:#F1F4F0; ">DOB</label><label class="text_10">&nbsp;<?php if($patient_ageNew) { echo '('.$patient_ageNew.')';}?></label>
																	<span class="text_10" style="background:background-color:#F1F4F0;padding-left:8; height:19px;white-space:nowrap;">
																...
																<li class="" id="fo65li7">
																<label class="text_10b" id="title7" style="background:background-color:#F1F4F0; white-space:nowrap; ">Sex </label>
																<span class="text_10" style="background:background-color:#F1F4F0;padding-left:8; height:18px; white-space:nowrap;">
																	<select name="sex_list" id="sex_list_id" class="field text_10" style="width:70px; font-size:9px; border:1px solid #cccccc;">
							...
							<!-- <tr>
								<td colspan="5">
									<table border="0" align="center" width="100%" cellpadding="0" cellspacing="0">
										<tr height="5">
											<td width="766" ><img src="images/tpixel.gif" width="1" height="5"></td>
										</tr>
										<tr>
											<td valign="top">
												<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
													<tr>
														<td align="center" valign="top" ><img src="images/tpixel.gif" width="20" height="5">
															
															<input type="hidden" name="pt_wait_submit" value="Save">
															<a href="#"  onClick="MM_swapImage('saveBtnPt','','images/save_onclick1.jpg',1);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('saveBtnPt','','images/save_hover1.jpg',1)"><img src="images/save.jpg" name="saveBtnPt" border="0" id="saveBtnPt" alt="save" onClick="javascript:return validtion_pt_confirm();"/></a>
															<img src="images/tpixel.gif" width="1" height="5">
															<a href="#" onClick="MM_swapImage('CancelBtnPt','','images/cancel_onclick1.gif',1);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('CancelBtnPt','','images/cancel_hover1.jpg',1)"><img src="images/cancel.jpg" name="CancelBtnPt" width="70" height="25" border="0" id="CancelBtnPt" alt="Cancel" onClick="javascript:window.close();" /></a>
