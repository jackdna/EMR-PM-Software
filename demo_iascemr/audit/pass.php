...
function passpop(path){
	var flag=0;
	msg = "Please fill following\n";
	var u=document.password_form.patient_name.value;
	var logindate = document.password_form.date1.value;
	var logoutdate = document.password_form.date2.value;
	var audit=document.password_form.type.value;
	...
	if(flag > 0){
		...
		window.open('passpop.php?user='+u+'&login='+logindate+'&logout='+logoutdate+'&atype='+audit+'&get_http_path='+path,'','width=650,height=600,top=70,left=200,scrollbars=1,resizable=1');
	}
}
...
<body onLoad="MM_preloadImages('../images/reset_click.jpg','../images/reset_hover.jpg')">
				...
				<div class="wrap_inside_admin">
					<div class=" subtracting-head">
						<div class="head_scheduler new_head_slider padding_head_adjust_admin">
							<span>
								Password Change/Reset/Lockouts 
							</span>
						</div>
					</div>   
					<Div class="wrap_inside_admin ">
						...
						<div class="col-md-8 col-sm-12 col-xs-12 col-lg-4">
							<div class="audit_wrap">
								<h5 class="ans_pro_h">
									<span>Password Audit Report</span>
								</h5>
									...
									<Div class="row">
										<div class="col-md-6 col-sm-12 col-lg-6 col-xs-12">
											<div class="form_reg">
												...
												<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
													<Select class="form-control selectpicker" name="patient_name" id="patient_name" data-size="10">
										...
										<div class="col-md-6 col-sm-12 col-lg-6 col-xs-12">
											<div class="form_reg">
												...
												<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
													<Select class="form-control selectpicker" name="type" id="audit_type" data-size="10">
											...
											<div class="form_reg">
												...
												<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
													<Div class="input-group"  id='datetimepicker1'>
														<input autocomplete="off" class="form-control" type="text" name="date1" id="date1" tabindex="1" value="<?php //echo $_REQUEST['date1'];?>" />
											...
											<div class="form_reg">
												...
												<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
													<Div class="input-group" id="datetimepicker2">
														<input autocomplete="off" class="form-control" type="text" id="date2" name="date2" tabindex="1" value="<?php //echo $_REQUEST['date2'];?>" />
														<div class="input-group-addon datepicker">
															<a href="javascript:void(0)"><span class="glyphicon glyphicon-calendar"></span></a>
														</div>
													</Div>
							...
							<div class="btn-footer-slider">
								<a id="auditBtn" onClick="return passpop('<?php echo $get_http_path; ?>');" class="btn btn-info" href="javascript:void(0)">
									Audit 
								</a>
...
<script type="text/javascript">
function submitfn(){
	document.password_form.patient_name.value='';
	document.password_form.date1.value='';
	document.password_form.date2.value='';
	document.password_form.type.value='';
