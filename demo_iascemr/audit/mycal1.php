...
<html>
<head>
<title>iMedic: Add/Edit Appointment</title>
	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr height="23px">
					<td width="6px" align="right" valign="bottom"><img src="../images/left.gif"></td>
					<td width="2%" bgcolor="#BCD2B0" valign="bottom" ></td>
					<td valign="middle" align="left" bgcolor="#BCD2B0">
						<font size="1px" face="Verdana, Arial, Helvetica, sans-serif">
						<b>Select Date</b>											 
						</font>
					</td>
					<td width="6px" valign="bottom"><img src="../images/right.gif"></td>
				</tr>
			</table>	
		</td>
	</tr>
