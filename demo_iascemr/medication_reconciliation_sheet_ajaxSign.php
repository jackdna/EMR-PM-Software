...
$ajaxSignFile		=	'medication_reconciliation_sheet_ajaxSign.php';
...
else
{
	...
	if($userTitle === 'Nurse' || $userTitle === 'Surgeon')
	{
			$faSurgClass = "";
			if($sigTitle == 'Surgeon') {
				$faSurgClass = "fa-editsurg";	
			}
			$html	 .=	'<span class="dynamic_sig_dt" data-field-name="sign'.$userIdentity.'DateTime" data-table-name="'.$tblName.'" data-id-value="'.$idFieldValue.'" data-id-name="'.$idFieldName.'"> '.$signDateTimeFormatNew.' <span class="fa fa-edit '.$faSurgClass.'"></span></span></span>';
	}
	else
	{
