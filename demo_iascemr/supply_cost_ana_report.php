...
if($_REQUEST['proc_save']=='yes') {
	...
	$qry = "SELECT pc.labor_cost, pc.supply_cost, pc.cost_procedure_id as proc_id, pc.patientConfirmationId, 
								 pc.cost_procedure_name as proc_name,
	...
	{
		$fileNameSubmit = "supply_cost_ana_reportpop.php";	
		$windName = 'supply_cost_ana_report_win';
		if($_REQUEST["report_typechkbx"]=="detail") {
			$fileNameSubmit = "supply_cost_ana_reportpop_detail.php";
			$windName = 'supply_cost_ana_report_win_detail';	
		}
		//redirect on pop up window	
?>
		<form name="supply_cost_ana_report_sub" id="supply_cost_ana_report_sub" method="post" action="<?php echo $fileNameSubmit;?>" target="<?php echo $windName;?>" >
	...
	<script>
			...
			var win=window.open('<?php echo $fileNameSubmit;?>','<?php echo $windName;?>','width='+parWidth+',height='+parHeight+' top=10,left=10,resizable=yes,scrollbars=1');
			win.focus();
			document.getElementById('supply_cost_ana_report_sub').submit();
		</script>
<?php
	}
...
function reportpop(path,action){
	...
	document.proc_phy_report.action.value = action;
                            ...
                            <Div class="wrap_inside_admin">
                                ...
                                <div class="col-md-8 col-sm-12 col-xs-12 col-lg-6">
                                                 ...
                                                 <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                     <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 text-center">
                                                         <div class="label_inline_adj">
                                                             ...
                                                             <div class="wrapped_inner_ans_pro" style="float:none;">
                                                                 <label for="detail">
                                                                    <input type="checkbox" name="report_typechkbx" id="detail" value="detail" tabindex="7" <?php if($_REQUEST["report_typechkbx"]=="detail") { echo "checked"; }?>  /> Details
                                                                 </label>
                                                             </div>
                                                         </div>
                                                     </div>	 	
                                    ...
                                    <div class="btn-footer-slider">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-info" id="generate_report" onclick="return reportpop('http','pdf');">
