...
if($fromFile == "operative_recordPdf"){	
	...
	$head_table.='<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%" >
					<tr>
						...
						<td height="15" align="left" width="17%"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1">'.$patientHeaderName.'</font></td>
						<td height="15" width="18%"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"><strong>ASC</strong>&nbsp;&nbsp;&nbsp;'.$Confirm_patientHeaderAscID.'</font></td>
						...
						<td height="15" width="27%"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"><strong>Surgery Date&nbsp; </strong>&nbsp;&nbsp;&nbsp;'.$Confirm_patientHeaderDos.'</font></td>
					</tr>
					<tr>
						<td height="'.$tdheight.'" ><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"><strong>Address:</strong>&nbsp;&nbsp;&nbsp;</font></td>
						<td rowspan="2" >'.$patientHeaderstreet1.'<br>'.$Ptcompleteaddress.'</td>
					...
					<tr>
						<td  colspan="3" height="15"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"><strong>Anesthesiologist&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$Confirm_patientHeaderAnesthesiologist_name_print.'</font></td>
						<td height="15"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>A/D</strong>&nbsp;&nbsp;&nbsp;'.$Confirm_patientHeaderAdvanceDirective.'</font></td>
						<td height="15"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"><strong>Assist. by Translator&nbsp;&nbsp;&nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;'.$Confirm_patientHeaderAssist_by_translator.'</font></td>
					</tr>
					<tr>
						<td  colspan="3"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"><strong>Primary Proc.&nbsp;&nbsp;&nbsp;</strong> &nbsp;&nbsp;'.$Confirm_patientHeaderPrimProc.'</font></td>
						<td  colspan="2"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"><strong>Secondary Proc.&nbsp;&nbsp;&nbsp;</strong> &nbsp;&nbsp;'.$Confirm_patientHeaderSecProc.'</font></td>
					</tr>
					<tr >
	...
	$head_table.='<table cellpadding="0" cellspacing="0" align="center" width="100%" border="1">
					...
					<tr>
						...
						<td  height="15"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1">O<sub>2</sub>SAT&nbsp;&nbsp;&nbsp;'.$vitalSignO2SAT_NursingHeader.'</font></td>
						<td  height="15"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1">Temp&nbsp;&nbsp;&nbsp;'.$vitalSignTemp_NursingHeader.'</font></td>
						<td  height="15"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1">Height&nbsp;&nbsp;&nbsp;'.$vitalSignHeight_NursingHeader.'</font></td>
						<td  height="15"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1">Weight&nbsp;&nbsp;&nbsp;'.$vitalSignWeight_NursingHeader.'</font></td>
					</tr>
				 </table>';
?>