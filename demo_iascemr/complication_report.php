...
if($_REQUEST['proc_save']=='yes') {
	...
	else
	{
		...
		?>
		<form name="complication_report_sub" id="complication_report_sub" method="post" action="complication_reportpop.php" target="complication_report_win" >
        ...
        <script>
			...
			var win=window.open('complication_reportpop.php','complication_report_win','width='+parWidth+',height='+parHeight+' top=10,left=10,resizable=yes,scrollbars=1');
			win.focus();
			document.getElementById('complication_report_sub').submit();
		</script>
        <?php
	}
}
