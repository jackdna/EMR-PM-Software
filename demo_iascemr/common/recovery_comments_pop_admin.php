...
function getInnerHTMLrecovery(obj){
	...
	var obj2 = document.getElementById('recoveryComments');
	if(obj2.value==''){
		obj2.value = val;
	}else{
		obj2.value += '\n'+val;
...
<div id="AdminRecoveryDiv" onMouseOver="stopCloseAdminPopup();" onMouseOut="closeAdminPopup(this.id);" style="position:absolute; background:#FFF; display:none;overflow:auto; padding:0px; margin:0px;border:1px solid #CCC;border-radius:2px;z-index:999;" class="col-md-3 col-lg-2 col-xs-8 col-sm-5">
<div  class="col-md-12 col-lg-12 col-xs-12 col-sm-12" style="height:30px; width:100%;  background:#d9534f;  padding-top:5px"><span onClick="document.getElementById('AdminRecoveryDiv').style.display='none';" style="float:right; color:#FFF; cursor:pointer; font-family:Verdana;">X</span>
</div>
