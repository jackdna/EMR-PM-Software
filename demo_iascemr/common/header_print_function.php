...
function headerInfo($pConfId){
	...
	$patientHeadersex='';
	if($patientHeadersexTemp=="m") { $patientHeadersex = "Male";}
	else if($patientHeadersexTemp=="f") { $patientHeadersex = "Female";  }	
	$patientHeaderhomePhone = $patientHeaderInfo->homePhone;	
	$patientHeaderworkPhone = $patientHeaderInfo->workPhone;
	if($patientHeaderhomePhone<>"") { $patientHeaderPhone =  $patientHeaderhomePhone;}
	else { $patientHeaderPhone = $patientHeaderworkPhone; }
	...
	$Confirm_patientHeaderAssist_by_translator = ucfirst($Confirm_patientHeaderInfo->assist_by_translator);
...
$address=$dataFac->fac_address1.' '.$dataFac->fac_address2.' '.$dataFac->fac_city.' '.$dataFac->fac_state;
	...
	if(!trim($bckBottom)) { $bckBottom = "1mm"; }
	$head_table.='<page backtop="5mm" backbottom="'.$bckBottom.'">			
			<page_footer>
	...
	else
	{
		...
		$head_table.='
			<table style="width:700px; font-size:14px;" cellpadding="0" cellspacing="0">
				<tr>
					<td style="width:140px; font-weight:bold;text-align:right; padding-top:2px;">Patient Name:&nbsp;</td>
					<td style="width:200px; padding-top:2px; ">'.$patientHeaderName.'</td>
					<td style="width:80px;  padding-top:2px;font-weight:bold;text-align:right; ">ASC:&nbsp;</td>
					<td style="width:90px; padding-top:2px;">'.$Confirm_patientHeaderAscID.'</td>
					<td style="width:100px;  padding-top:2px;font-weight:bold;text-align:right; ">Surgeon:&nbsp;</td>
					<td style="width:190px;  padding-top:2px;">'.$Confirm_patientHeaderSurgeon_name.'</td>
				</tr>
		<tr>
			<td style="width:140px;  padding-top:2px;font-weight:bold;text-align:right;">Address:&nbsp;</td>
			<td style="width:200px; padding-top:2px;vertical-align:top; " rowspan="2">';
		...
		<tr>
		 ...
		 <tr>
			...
			<td colspan="2" style="width:180px;vertical-align:top;padding-top:2px;"><b>Assist. by Translator:</b>&nbsp;'.$Confirm_patientHeaderAssist_by_translator.'</td>
		</tr>
		<tr>
			...
			<td colspan="2" style="width:180px;vertical-align:top;padding-top:2px;"></td>
		</tr>';
...
function headerInfo4old($pConfId){
