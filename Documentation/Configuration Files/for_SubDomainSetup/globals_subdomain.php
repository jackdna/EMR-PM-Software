...
$RootDirectoryName = "imwemrR8";
$web_RootDirectoryName = '';//"imwemrR8-Dev"; //imwemr 
...
//SESSION SETTINGS
define('GLOBAL_IMW_IDOC_SESSION_NAME',"imwemrR8".$web_RootDirectoryName);
...
define('PRODUCT_VERSION', 'IEMR'); //SP4 P3
define('PRODUCT_VERSION_DATE', '09/01/17 - V1'); //Nov 16, 2018
?>