...
$myInternalIP = "10.11.x.x";
$myExternalIP = "sample.yourdoamin.com";

$RootDirectoryName = "imwemr";
$web_RootDirectoryName = PRACTICE_PATH;//"imwemr-Dev"; 
$webServerRootDirectoryName = "/var/www/html/";// ::C:/zProject2/XAMP/xampp1.5.1/xampp/htdocs/
$phpServerIP = "sample.domain.com"; //288.288.288.12 //127.0.0.1
$phpServerPort = "";
...
//SESSION SETTINGS
define('GLOBAL_IMW_IDOC_SESSION_NAME',"imwemr".$web_RootDirectoryName);
...
define('PRODUCT_VERSION', 'R8'); //SP4 P3
define('PRODUCT_VERSION_DATE', '09/01/17 - V8'); //Nov 30, 2018
?>