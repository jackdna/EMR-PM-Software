...
//include_once("common/conDb.php");
	...
	function drawOnImageLaser($pixls,$imgName,$img_name_tmp)
	{		
		$imgDefault = "html2pdfnew/laser_image.jpg";	
		...
		imagejpeg($imgcr,"html2pdfnew/".$img_name_tmp,100);
	...
	if(!empty($_GET["id"]))
	{
		...
		drawOnImageLaser($pixels,$imgName,$tmp_imgname); 								
	}
	//Get Image	
