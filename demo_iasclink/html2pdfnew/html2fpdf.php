...
//! @return An object (a class instance)
	...
	//$this->SetFont('Arial','',13); // Changeable?(not yet...)
	//$this->lineheight = 6.7; // Related to FontSizePt == 11
        ...
        switch(strtoupper($specialcontent['type']))
        {
          case 'IMAGE':
					  ...
					  if($spacesize > 0)
					  	...
					  	$spacenum = (integer)ceil($width_used);
