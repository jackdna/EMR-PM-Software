...
function showPreDefineSuppliesUsedFn(name1, name2, c, posLeft, posTop){	
	...
	document.getElementById("evaluationPreDefineSuppliesUsedDiv").style.display = 'block';
	document.getElementById("evaluationPreDefineSuppliesUsedDiv").style.left = posLeft;
	document.getElementById("evaluationPreDefineSuppliesUsedDiv").style.top = posTop;
	document.getElementById("divId").value = name1;
	document.getElementById("counter").value = c;
	document.getElementById("secondaryValues").value = name2;	
	//CODE TO SET HIDDEN VALUE TO YES (FOR CLOSING PREDIFINE BY CLICKING OUTSIDE)
...
//FUNCTION TO CLOSE PREDEFINE POPUP
	...
	function closeEkg(objEkgClose){
		...
		}else if(objEkgClose=='iolinkPreDefineAllergyAdminDiv') {  //iolink HealthQuestAllergry
			tEkgOut = setTimeout("closeEkg2('iolinkPreDefineAllergyAdminDiv')",500);
		}else if(objEkgClose=='iolinkPreDefineMedAdminDiv') {  //iolink HealthQuestMedication
			tEkgOut = setTimeout("closeEkg2('iolinkPreDefineMedAdminDiv')",500);
		}
...
function changeTxtGroupColor(grpCount,Txt1,Txt2,Txt3,Txt4,Txt5,Txt6,Txt7,Txt8,Txt9,Txt10,Txt11,Txt12,Txt13,Txt14,Txt15,Txt16){
...
function OnSignIpadPhy(patient_id,ptWaitingId,sigFor,idInnerHTML,signSeqNum,consentTemplateID){
	...
	var url = "chartNoteSignatureIPad.php?patient_id="+patient_id+"&ptWaitingId="+ptWaitingId+"&sigFor="+sigFor+"&idInnerHTML="+idInnerHTML+"&signSeqNum="+signSeqNum;
	if( typeof consentTemplateID !== 'undefined' && consentTemplateID != '' && consentTemplateID > 0 )
	{
		url += "&consentTemplateID="+consentTemplateID; 		
	}
	window.open(url,"SignaturePad",features);
}
