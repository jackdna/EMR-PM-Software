	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="10px" align="right"><img src="images/left.gif"></td>
					<td bgcolor= "#BCD2B0"><font size="1px" face="Verdana, Arial, Helvetica, sans-serif">
						<b>Select Date</b>											 
						</font>
					</td>
					<td width="6px"><img src="images/right.gif"></td>
				</tr>
			</table>	
		</td>
	</tr>
					...
					<TABLE width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
						<TR>
							<TD align="center">
								<script>
									var rf = '<?php echo $rf;?>';
									var opMnth = opener.month;
									var opYear = opener.year;
									if(rf=='yes') {
										opMnth = to_mn;
										opYear = to_yr;
									}
									document.write(Calendar(opMnth,opYear));
								</script>
							</TD>
						</TR>
						<TR>
